...
func NewArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems(condition string, tag string) *ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems {
...
// NewArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItemsWithDefaults instantiates a new ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItemsWithDefaults() *ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems {
	this := ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems{}
	return &this
}
...
func (o *ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems) GetConditionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems) SetCondition(v string) {
	o.Condition = v
}
...
// and a boolean to check if the value has been set.
func (o *ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems) GetTagOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Tag, true
...
// and a boolean to check if the value has been set.
func (o *ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems) GetValueOk() (*string, bool) {
	if o == nil || o.Value == nil {
		return nil, false
	}
	return o.Value, true
...
func (o *ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems) HasValue() bool {
	return o != nil && o.Value != nil
}

// SetValue gets a reference to the given string and assigns it to the Value field.
func (o *ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems) SetValue(v string) {
	o.Value = &v
}
...
func (o *ArbitraryRuleResponseDataAttributesStrategyEvaluateGroupedByFiltersItems) HasValues() bool {
