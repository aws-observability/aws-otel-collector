...
// CreateAppsDatastoreRequestDataAttributes Configuration and metadata to create a new datastore.
type CreateAppsDatastoreRequestDataAttributes struct {
	...
	OrgAccess *CreateAppsDatastoreRequestDataAttributesOrgAccess `json:"org_access,omitempty"`
...
func (o *CreateAppsDatastoreRequestDataAttributes) GetOrgAccess() CreateAppsDatastoreRequestDataAttributesOrgAccess {
	if o == nil || o.OrgAccess == nil {
		var ret CreateAppsDatastoreRequestDataAttributesOrgAccess
		return ret
	}
	return *o.OrgAccess
}
...
// and a boolean to check if the value has been set.
func (o *CreateAppsDatastoreRequestDataAttributes) GetOrgAccessOk() (*CreateAppsDatastoreRequestDataAttributesOrgAccess, bool) {
	if o == nil || o.OrgAccess == nil {
		return nil, false
	}
...
// SetOrgAccess gets a reference to the given CreateAppsDatastoreRequestDataAttributesOrgAccess and assigns it to the OrgAccess field.
func (o *CreateAppsDatastoreRequestDataAttributes) SetOrgAccess(v CreateAppsDatastoreRequestDataAttributesOrgAccess) {
	o.OrgAccess = &v
}
...
func (o *CreateAppsDatastoreRequestDataAttributes) GetPrimaryKeyGenerationStrategy() DatastorePrimaryKeyGenerationStrategy {
...
// and a boolean to check if the value has been set.
func (o *CreateAppsDatastoreRequestDataAttributes) GetPrimaryKeyGenerationStrategyOk() (*DatastorePrimaryKeyGenerationStrategy, bool) {
	if o == nil || o.PrimaryKeyGenerationStrategy == nil {
		return nil, false
	}
...
func (o *CreateAppsDatastoreRequestDataAttributes) SetPrimaryKeyGenerationStrategy(v DatastorePrimaryKeyGenerationStrategy) {
...
func (o *CreateAppsDatastoreRequestDataAttributes) UnmarshalJSON(bytes []byte) (err error) {
	...
	o.Name = *all.Name
	if all.OrgAccess != nil && !all.OrgAccess.IsValid() {
