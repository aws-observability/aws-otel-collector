...
type AWSEventBridgeCreateRequest struct {
	...
	Data AWSEventBridgeCreateRequestData `json:"data"`
...
func NewAWSEventBridgeCreateRequest(data AWSEventBridgeCreateRequestData) *AWSEventBridgeCreateRequest {
...
func (o *AWSEventBridgeCreateRequest) GetData() AWSEventBridgeCreateRequestData {
	if o == nil {
		var ret AWSEventBridgeCreateRequestData
		return ret
	}
	return o.Data
}
...
func (o *AWSEventBridgeCreateRequest) GetDataOk() (*AWSEventBridgeCreateRequestData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *AWSEventBridgeCreateRequest) SetData(v AWSEventBridgeCreateRequestData) {
	o.Data = v
}
