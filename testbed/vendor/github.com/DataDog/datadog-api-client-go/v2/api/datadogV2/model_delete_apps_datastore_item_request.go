...
func NewDeleteAppsDatastoreItemRequest() *DeleteAppsDatastoreItemRequest {
	this := DeleteAppsDatastoreItemRequest{}
	return &this
}

// NewDeleteAppsDatastoreItemRequestWithDefaults instantiates a new DeleteAppsDatastoreItemRequest object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewDeleteAppsDatastoreItemRequestWithDefaults() *DeleteAppsDatastoreItemRequest {
	this := DeleteAppsDatastoreItemRequest{}
	return &this
}
...
func (o *DeleteAppsDatastoreItemRequest) GetData() DeleteAppsDatastoreItemRequestData {
	if o == nil || o.Data == nil {
		var ret DeleteAppsDatastoreItemRequestData
		return ret
	}
	return *o.Data
}
...
func (o *DeleteAppsDatastoreItemRequest) GetDataOk() (*DeleteAppsDatastoreItemRequestData, bool) {
	if o == nil || o.Data == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *DeleteAppsDatastoreItemRequest) HasData() bool {
	return o != nil && o.Data != nil
}

// SetData gets a reference to the given DeleteAppsDatastoreItemRequestData and assigns it to the Data field.
...
func (o *DeleteAppsDatastoreItemRequest) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *DeleteAppsDatastoreItemRequestData `json:"data,omitempty"`
	}{}
