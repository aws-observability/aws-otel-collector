...
func NewArbitraryRuleResponseDataAttributesStrategyAllocatedByItems(allocatedTags []ArbitraryRuleResponseDataAttributesStrategyAllocatedByItemsAllocatedTagsItems, percentage float64) *ArbitraryRuleResponseDataAttributesStrategyAllocatedByItems {
...
// NewArbitraryRuleResponseDataAttributesStrategyAllocatedByItemsWithDefaults instantiates a new ArbitraryRuleResponseDataAttributesStrategyAllocatedByItems object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewArbitraryRuleResponseDataAttributesStrategyAllocatedByItemsWithDefaults() *ArbitraryRuleResponseDataAttributesStrategyAllocatedByItems {
	this := ArbitraryRuleResponseDataAttributesStrategyAllocatedByItems{}
	return &this
}
...
func (o *ArbitraryRuleResponseDataAttributesStrategyAllocatedByItems) GetAllocatedTags() []ArbitraryRuleResponseDataAttributesStrategyAllocatedByItemsAllocatedTagsItems {
	if o == nil {
		var ret []ArbitraryRuleResponseDataAttributesStrategyAllocatedByItemsAllocatedTagsItems
		return ret
	}
...
func (o *ArbitraryRuleResponseDataAttributesStrategyAllocatedByItems) GetAllocatedTagsOk() (*[]ArbitraryRuleResponseDataAttributesStrategyAllocatedByItemsAllocatedTagsItems, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *ArbitraryRuleResponseDataAttributesStrategyAllocatedByItems) GetPercentageOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ArbitraryRuleResponseDataAttributesStrategyAllocatedByItems) SetPercentage(v float64) {
	o.Percentage = v
}
