...
var allowedCustomDestinationResponseHttpDestinationAuthCustomHeaderTypeEnumValues = []CustomDestinationResponseHttpDestinationAuthCustomHeaderType{
	CUSTOMDESTINATIONRESPONSEHTTPDESTINATIONAUTHCUSTOMHEADERTYPE_CUSTOM_HEADER,
}
...
func (v *CustomDestinationResponseHttpDestinationAuthCustomHeaderType) UnmarshalJSON(src []byte) error {
	...
	*v = CustomDestinationResponseHttpDestinationAuthCustomHeaderType(value)
	return nil
}

// NewCustomDestinationResponseHttpDestinationAuthCustomHeaderTypeFromValue returns a pointer to a valid CustomDestinationResponseHttpDestinationAuthCustomHeaderType
...
func NewCustomDestinationResponseHttpDestinationAuthCustomHeaderTypeFromValue(v string) (*CustomDestinationResponseHttpDestinationAuthCustomHeaderType, error) {
	ev := CustomDestinationResponseHttpDestinationAuthCustomHeaderType(v)
	if ev.IsValid() {
		return &ev, nil
	}
	return nil, fmt.Errorf("invalid value '%v' for CustomDestinationResponseHttpDestinationAuthCustomHeaderType: valid values are %v", v, allowedCustomDestinationResponseHttpDestinationAuthCustomHeaderTypeEnumValues)
}

// IsValid return true if the value is valid for the enum, false otherwise.
func (v CustomDestinationResponseHttpDestinationAuthCustomHeaderType) IsValid() bool {
	for _, existing := range allowedCustomDestinationResponseHttpDestinationAuthCustomHeaderTypeEnumValues {
		if existing == v {
			return true
		}
	}
