...
// NewSensitiveDataScannerGroupItem instantiates a new SensitiveDataScannerGroupItem object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewSensitiveDataScannerGroupItem() *SensitiveDataScannerGroupItem {
	this := SensitiveDataScannerGroupItem{}
	var typeVar SensitiveDataScannerGroupType = SENSITIVEDATASCANNERGROUPTYPE_SENSITIVE_DATA_SCANNER_GROUP
	this.Type = &typeVar
	return &this
}

// NewSensitiveDataScannerGroupItemWithDefaults instantiates a new SensitiveDataScannerGroupItem object.
