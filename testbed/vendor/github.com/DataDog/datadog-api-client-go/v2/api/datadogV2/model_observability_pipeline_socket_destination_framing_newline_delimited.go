...
func NewObservabilityPipelineSocketDestinationFramingNewlineDelimited(method ObservabilityPipelineSocketDestinationFramingNewlineDelimitedMethod) *ObservabilityPipelineSocketDestinationFramingNewlineDelimited {
	this := ObservabilityPipelineSocketDestinationFramingNewlineDelimited{}
	this.Method = method
	return &this
}

// NewObservabilityPipelineSocketDestinationFramingNewlineDelimitedWithDefaults instantiates a new ObservabilityPipelineSocketDestinationFramingNewlineDelimited object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewObservabilityPipelineSocketDestinationFramingNewlineDelimitedWithDefaults() *ObservabilityPipelineSocketDestinationFramingNewlineDelimited {
	this := ObservabilityPipelineSocketDestinationFramingNewlineDelimited{}
	return &this
}
...
func (o *ObservabilityPipelineSocketDestinationFramingNewlineDelimited) GetMethod() ObservabilityPipelineSocketDestinationFramingNewlineDelimitedMethod {
	if o == nil {
		var ret ObservabilityPipelineSocketDestinationFramingNewlineDelimitedMethod
		return ret
	}
	return o.Method
}
...
func (o *ObservabilityPipelineSocketDestinationFramingNewlineDelimited) GetMethodOk() (*ObservabilityPipelineSocketDestinationFramingNewlineDelimitedMethod, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ObservabilityPipelineSocketDestinationFramingNewlineDelimited) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Method *ObservabilityPipelineSocketDestinationFramingNewlineDelimitedMethod `json:"method"`
	}{}
