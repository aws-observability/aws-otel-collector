...
func NewLaunchDarklyAPIKeyUpdate(typeVar LaunchDarklyAPIKeyType) *LaunchDarklyAPIKeyUpdate {
	this := LaunchDarklyAPIKeyUpdate{}
	this.Type = typeVar
	return &this
}

// NewLaunchDarklyAPIKeyUpdateWithDefaults instantiates a new LaunchDarklyAPIKeyUpdate object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewLaunchDarklyAPIKeyUpdateWithDefaults() *LaunchDarklyAPIKeyUpdate {
	this := LaunchDarklyAPIKeyUpdate{}
	return &this
}
...
func (o *LaunchDarklyAPIKeyUpdate) GetApiTokenOk() (*string, bool) {
	if o == nil || o.ApiToken == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *LaunchDarklyAPIKeyUpdate) GetTypeOk() (*LaunchDarklyAPIKeyType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *LaunchDarklyAPIKeyUpdate) SetType(v LaunchDarklyAPIKeyType) {
	o.Type = v
}
