...
// CreateAppsDatastoreResponseData The newly created datastore's data.
...
func NewCreateAppsDatastoreResponseData(typeVar DatastoreDataType) *CreateAppsDatastoreResponseData {
...
func (o *CreateAppsDatastoreResponseData) GetType() DatastoreDataType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CreateAppsDatastoreResponseData) GetTypeOk() (*DatastoreDataType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *CreateAppsDatastoreResponseData) SetType(v DatastoreDataType) {
	o.Type = v
}
