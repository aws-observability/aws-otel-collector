...
// AWSEventBridgeDeleteRequest Amazon EventBridge delete request body.
type AWSEventBridgeDeleteRequest struct {
	// Amazon EventBridge delete request data.
	Data AWSEventBridgeDeleteRequestData `json:"data"`
...
func NewAWSEventBridgeDeleteRequest(data AWSEventBridgeDeleteRequestData) *AWSEventBridgeDeleteRequest {
...
func (o *AWSEventBridgeDeleteRequest) GetData() AWSEventBridgeDeleteRequestData {
	if o == nil {
		var ret AWSEventBridgeDeleteRequestData
		return ret
	}
	return o.Data
}
...
func (o *AWSEventBridgeDeleteRequest) GetDataOk() (*AWSEventBridgeDeleteRequestData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *AWSEventBridgeDeleteRequest) SetData(v AWSEventBridgeDeleteRequestData) {
	o.Data = v
}
