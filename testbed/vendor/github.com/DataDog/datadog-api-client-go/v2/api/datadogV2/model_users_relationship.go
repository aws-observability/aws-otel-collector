...
// NewUsersRelationship instantiates a new UsersRelationship object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewUsersRelationship(data []UserRelationshipData) *UsersRelationship {
	this := UsersRelationship{}
	this.Data = data
	return &this
}

// NewUsersRelationshipWithDefaults instantiates a new UsersRelationship object.
