...
// NewOrgConfigWriteRequest instantiates a new OrgConfigWriteRequest object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewOrgConfigWriteRequest(data OrgConfigWrite) *OrgConfigWriteRequest {
	this := OrgConfigWriteRequest{}
	this.Data = data
	return &this
}

// NewOrgConfigWriteRequestWithDefaults instantiates a new OrgConfigWriteRequest object.
