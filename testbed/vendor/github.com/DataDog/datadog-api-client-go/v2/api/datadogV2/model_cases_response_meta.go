...
// NewCasesResponseMeta instantiates a new CasesResponseMeta object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewCasesResponseMeta() *CasesResponseMeta {
	this := CasesResponseMeta{}
	return &this
}

// NewCasesResponseMetaWithDefaults instantiates a new CasesResponseMeta object.
...
func (o *CasesResponseMeta) GetPage() CasesResponseMetaPagination {
	if o == nil || o.Page == nil {
		var ret CasesResponseMetaPagination
		return ret
	}
	return *o.Page
}
