...
func NewAnthropicAPIKey(apiToken string, typeVar AnthropicAPIKeyType) *AnthropicAPIKey {
...
// NewAnthropicAPIKeyWithDefaults instantiates a new AnthropicAPIKey object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewAnthropicAPIKeyWithDefaults() *AnthropicAPIKey {
	this := AnthropicAPIKey{}
	return &this
}
...
func (o *AnthropicAPIKey) GetApiTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *AnthropicAPIKey) GetTypeOk() (*AnthropicAPIKeyType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *AnthropicAPIKey) SetType(v AnthropicAPIKeyType) {
	o.Type = v
}
