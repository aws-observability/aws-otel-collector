...
func NewObservabilityPipelineSocketSourceFramingNewlineDelimited(method ObservabilityPipelineSocketSourceFramingNewlineDelimitedMethod) *ObservabilityPipelineSocketSourceFramingNewlineDelimited {
	this := ObservabilityPipelineSocketSourceFramingNewlineDelimited{}
	this.Method = method
	return &this
}

// NewObservabilityPipelineSocketSourceFramingNewlineDelimitedWithDefaults instantiates a new ObservabilityPipelineSocketSourceFramingNewlineDelimited object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewObservabilityPipelineSocketSourceFramingNewlineDelimitedWithDefaults() *ObservabilityPipelineSocketSourceFramingNewlineDelimited {
	this := ObservabilityPipelineSocketSourceFramingNewlineDelimited{}
	return &this
}
...
func (o *ObservabilityPipelineSocketSourceFramingNewlineDelimited) GetMethod() ObservabilityPipelineSocketSourceFramingNewlineDelimitedMethod {
	if o == nil {
		var ret ObservabilityPipelineSocketSourceFramingNewlineDelimitedMethod
		return ret
	}
	return o.Method
}
...
func (o *ObservabilityPipelineSocketSourceFramingNewlineDelimited) GetMethodOk() (*ObservabilityPipelineSocketSourceFramingNewlineDelimitedMethod, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ObservabilityPipelineSocketSourceFramingNewlineDelimited) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Method *ObservabilityPipelineSocketSourceFramingNewlineDelimitedMethod `json:"method"`
	}{}
