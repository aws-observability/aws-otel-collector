...
func NewScannedAssetsMetadata(data []ScannedAssetMetadata) *ScannedAssetsMetadata {
	this := ScannedAssetsMetadata{}
	this.Data = data
	return &this
}

// NewScannedAssetsMetadataWithDefaults instantiates a new ScannedAssetsMetadata object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewScannedAssetsMetadataWithDefaults() *ScannedAssetsMetadata {
	this := ScannedAssetsMetadata{}
	return &this
}
...
func (o *ScannedAssetsMetadata) GetDataOk() (*[]ScannedAssetMetadata, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
// and a boolean to check if the value has been set.
func (o *ScannedAssetsMetadata) GetLinksOk() (*Links, bool) {
	if o == nil || o.Links == nil {
		return nil, false
	}
	return o.Links, true
...
func (o *ScannedAssetsMetadata) HasLinks() bool {
	return o != nil && o.Links != nil
}

// SetLinks gets a reference to the given Links and assigns it to the Links field.
func (o *ScannedAssetsMetadata) SetLinks(v Links) {
	o.Links = &v
}
...
// and a boolean to check if the value has been set.
func (o *ScannedAssetsMetadata) GetMetaOk() (*Metadata, bool) {
	if o == nil || o.Meta == nil {
		return nil, false
	}
	return o.Meta, true
...
func (o *ScannedAssetsMetadata) HasMeta() bool {
	return o != nil && o.Meta != nil
}

// SetMeta gets a reference to the given Metadata and assigns it to the Meta field.
func (o *ScannedAssetsMetadata) SetMeta(v Metadata) {
	o.Meta = &v
}
