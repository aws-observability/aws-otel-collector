...
func NewRecommendationDocument(data RecommendationData) *RecommendationDocument {
	this := RecommendationDocument{}
	this.Data = data
	return &this
}

// NewRecommendationDocumentWithDefaults instantiates a new RecommendationDocument object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewRecommendationDocumentWithDefaults() *RecommendationDocument {
	this := RecommendationDocument{}
	return &this
}
...
func (o *RecommendationDocument) GetDataOk() (*RecommendationData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *RecommendationDocument) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *RecommendationData `json:"data"`
	}{}
