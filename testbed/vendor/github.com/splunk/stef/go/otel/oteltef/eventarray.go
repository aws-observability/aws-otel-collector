...
func (e *EventArray) fixParent(parentModifiedFields *modifiedFields) {
	e.parentModifiedFields = parentModifiedFields
}
...
func (e *EventArray) setModifiedRecursively() {
...
func (e *EventArray) setUnmodifiedRecursively() {
	for i := 0; i < len(e.elems); i++ {
...
func (e *EventArray) computeDiff(val *EventArray) (ret bool) {
