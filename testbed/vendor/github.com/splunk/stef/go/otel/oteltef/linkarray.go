...
func (e *LinkArray) setModifiedRecursively() {
...
func (e *LinkArray) setUnmodifiedRecursively() {
	for i := 0; i < len(e.elems); i++ {
...
func (e *LinkArray) computeDiff(val *LinkArray) (ret bool) {
