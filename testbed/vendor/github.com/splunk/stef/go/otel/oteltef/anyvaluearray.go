...
func (e *AnyValueArray) fixParent(parentModifiedFields *modifiedFields) {
	e.parentModifiedFields = parentModifiedFields
}

func (e *AnyValueArray) canBeShared() bool {
...
func (e *AnyValueArray) setModifiedRecursively() {
...
func (e *AnyValueArray) setUnmodifiedRecursively() {
	for i := 0; i < len(e.elems); i++ {
...
func (e *AnyValueArray) computeDiff(val *AnyValueArray) (ret bool) {
