...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/testbed/mockdatasenders/mockdatadogagentexporter v0.93.0 // indirect
	...
	go.opentelemetry.io/collector/extension/ballastextension v0.93.0 // indirect
