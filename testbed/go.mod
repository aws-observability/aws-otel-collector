...
require (
	github.com/aws-observability/aws-otel-collector v0.39.1
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/testbed/mockdatasenders/mockdatadogagentexporter v0.102.0 // indirect
