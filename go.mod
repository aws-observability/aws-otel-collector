...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/observer/ecsobserver v0.51.0
...
replace (
	...
	k8s.io/kube-openapi v0.0.0-20220328201542-3ee0da9b0b42 => k8s.io/kube-openapi v0.0.0-20211115234752-e816edb12b65
)
