...
type ReadUserGroupPolicyRequest struct {
...
func NewReadUserGroupPolicyRequest(policyName string, userGroupName string) *ReadUserGroupPolicyRequest {
	this := ReadUserGroupPolicyRequest{}
...
func (o ReadUserGroupPolicyRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadUserGroupPolicyRequest struct {
	value *ReadUserGroupPolicyRequest
	isSet bool
}

func (v NullableReadUserGroupPolicyRequest) Get() *ReadUserGroupPolicyRequest {
	return v.value
}

func (v *NullableReadUserGroupPolicyRequest) Set(val *ReadUserGroupPolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadUserGroupPolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadUserGroupPolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadUserGroupPolicyRequest(val *ReadUserGroupPolicyRequest) *NullableReadUserGroupPolicyRequest {
	return &NullableReadUserGroupPolicyRequest{value: val, isSet: true}
}

func (v NullableReadUserGroupPolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadUserGroupPolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
