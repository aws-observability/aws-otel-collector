...
type ScaleDownVmGroupResponse struct {
...
func (o ScaleDownVmGroupResponse) MarshalJSON() ([]byte, error) {
...
type NullableScaleDownVmGroupResponse struct {
	value *ScaleDownVmGroupResponse
	isSet bool
}

func (v NullableScaleDownVmGroupResponse) Get() *ScaleDownVmGroupResponse {
	return v.value
}

func (v *NullableScaleDownVmGroupResponse) Set(val *ScaleDownVmGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableScaleDownVmGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableScaleDownVmGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScaleDownVmGroupResponse(val *ScaleDownVmGroupResponse) *NullableScaleDownVmGroupResponse {
	return &NullableScaleDownVmGroupResponse{value: val, isSet: true}
}

func (v NullableScaleDownVmGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScaleDownVmGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
