...
func (o LinkedPolicy) MarshalJSON() ([]byte, error) {
...
type NullableLinkedPolicy struct {
	value *LinkedPolicy
	isSet bool
}

func (v NullableLinkedPolicy) Get() *LinkedPolicy {
	return v.value
}

func (v *NullableLinkedPolicy) Set(val *LinkedPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkedPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkedPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkedPolicy(val *LinkedPolicy) *NullableLinkedPolicy {
	return &NullableLinkedPolicy{value: val, isSet: true}
}

func (v NullableLinkedPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkedPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
