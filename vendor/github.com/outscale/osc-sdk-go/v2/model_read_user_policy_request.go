...
// ReadUserPolicyRequest struct for ReadUserPolicyRequest
type ReadUserPolicyRequest struct {
...
func (o ReadUserPolicyRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadUserPolicyRequest struct {
	value *ReadUserPolicyRequest
	isSet bool
}

func (v NullableReadUserPolicyRequest) Get() *ReadUserPolicyRequest {
	return v.value
}

func (v *NullableReadUserPolicyRequest) Set(val *ReadUserPolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadUserPolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadUserPolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadUserPolicyRequest(val *ReadUserPolicyRequest) *NullableReadUserPolicyRequest {
	return &NullableReadUserPolicyRequest{value: val, isSet: true}
}

func (v NullableReadUserPolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadUserPolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
