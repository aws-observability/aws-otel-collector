...
type ReadCatalogsRequest struct {
	// If true, checks whether you have the required permissions to perform the action.
	DryRun  *bool            `json:"DryRun,omitempty"`
	Filters *FiltersCatalogs `json:"Filters,omitempty"`
}
...
// SetFilters gets a reference to the given FiltersCatalogs and assigns it to the Filters field.
func (o *ReadCatalogsRequest) SetFilters(v FiltersCatalogs) {
	o.Filters = &v
}

func (o ReadCatalogsRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadCatalogsRequest struct {
	value *ReadCatalogsRequest
	isSet bool
}

func (v NullableReadCatalogsRequest) Get() *ReadCatalogsRequest {
	return v.value
}

func (v *NullableReadCatalogsRequest) Set(val *ReadCatalogsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadCatalogsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadCatalogsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadCatalogsRequest(val *ReadCatalogsRequest) *NullableReadCatalogsRequest {
	return &NullableReadCatalogsRequest{value: val, isSet: true}
}

func (v NullableReadCatalogsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadCatalogsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
