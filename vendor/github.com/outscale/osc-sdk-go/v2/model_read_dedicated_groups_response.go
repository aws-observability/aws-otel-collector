...
type ReadDedicatedGroupsResponse struct {
...
func NewReadDedicatedGroupsResponse() *ReadDedicatedGroupsResponse {
	this := ReadDedicatedGroupsResponse{}
	return &this
}
...
// GetDedicatedGroups returns the DedicatedGroups field value if set, zero value otherwise.
func (o *ReadDedicatedGroupsResponse) GetDedicatedGroups() []DedicatedGroup {
	if o == nil || o.DedicatedGroups == nil {
		var ret []DedicatedGroup
		return ret
	}
	return *o.DedicatedGroups
}

// GetDedicatedGroupsOk returns a tuple with the DedicatedGroups field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReadDedicatedGroupsResponse) GetDedicatedGroupsOk() (*[]DedicatedGroup, bool) {
	if o == nil || o.DedicatedGroups == nil {
		return nil, false
	}
	return o.DedicatedGroups, true
}
...
// SetDedicatedGroups gets a reference to the given []DedicatedGroup and assigns it to the DedicatedGroups field.
func (o *ReadDedicatedGroupsResponse) SetDedicatedGroups(v []DedicatedGroup) {
	o.DedicatedGroups = &v
}

// GetNextPageToken returns the NextPageToken field value if set, zero value otherwise.
func (o *ReadDedicatedGroupsResponse) GetNextPageToken() string {
...
// and a boolean to check if the value has been set.
func (o *ReadDedicatedGroupsResponse) GetNextPageTokenOk() (*string, bool) {
	if o == nil || o.NextPageToken == nil {
		return nil, false
	}
...
func (o *ReadDedicatedGroupsResponse) HasNextPageToken() bool {
	if o != nil && o.NextPageToken != nil {
		return true
	}
...
func (o *ReadDedicatedGroupsResponse) SetNextPageToken(v string) {
	o.NextPageToken = &v
}
...
func (o ReadDedicatedGroupsResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.DedicatedGroups != nil {
		toSerialize["DedicatedGroups"] = o.DedicatedGroups
	}
...
type NullableReadDedicatedGroupsResponse struct {
	value *ReadDedicatedGroupsResponse
	isSet bool
}

func (v NullableReadDedicatedGroupsResponse) Get() *ReadDedicatedGroupsResponse {
	return v.value
}

func (v *NullableReadDedicatedGroupsResponse) Set(val *ReadDedicatedGroupsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReadDedicatedGroupsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReadDedicatedGroupsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadDedicatedGroupsResponse(val *ReadDedicatedGroupsResponse) *NullableReadDedicatedGroupsResponse {
	return &NullableReadDedicatedGroupsResponse{value: val, isSet: true}
}

func (v NullableReadDedicatedGroupsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadDedicatedGroupsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
