...
func (o *ReadNetAccessPointServicesRequest) GetNextPageToken() string {
...
// and a boolean to check if the value has been set.
func (o *ReadNetAccessPointServicesRequest) GetNextPageTokenOk() (*string, bool) {
	if o == nil || o.NextPageToken == nil {
		return nil, false
	}
...
func (o *ReadNetAccessPointServicesRequest) HasNextPageToken() bool {
	if o != nil && o.NextPageToken != nil {
		return true
	}
...
func (o *ReadNetAccessPointServicesRequest) SetNextPageToken(v string) {
	o.NextPageToken = &v
}

// GetResultsPerPage returns the ResultsPerPage field value if set, zero value otherwise.
func (o *ReadNetAccessPointServicesRequest) GetResultsPerPage() int32 {
...
// and a boolean to check if the value has been set.
func (o *ReadNetAccessPointServicesRequest) GetResultsPerPageOk() (*int32, bool) {
	if o == nil || o.ResultsPerPage == nil {
		return nil, false
	}
...
func (o *ReadNetAccessPointServicesRequest) HasResultsPerPage() bool {
	if o != nil && o.ResultsPerPage != nil {
		return true
	}
...
func (o *ReadNetAccessPointServicesRequest) SetResultsPerPage(v int32) {
	o.ResultsPerPage = &v
}
