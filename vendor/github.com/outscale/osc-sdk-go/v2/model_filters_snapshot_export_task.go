...
// NewFiltersSnapshotExportTask instantiates a new FiltersSnapshotExportTask object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewFiltersSnapshotExportTask() *FiltersSnapshotExportTask {
	this := FiltersSnapshotExportTask{}
	return &this
}

// NewFiltersSnapshotExportTaskWithDefaults instantiates a new FiltersSnapshotExportTask object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewFiltersSnapshotExportTaskWithDefaults() *FiltersSnapshotExportTask {
	this := FiltersSnapshotExportTask{}
	return &this
}

// GetSnapshotIds returns the SnapshotIds field value if set, zero value otherwise.
func (o *FiltersSnapshotExportTask) GetSnapshotIds() []string {
...
func (o *FiltersSnapshotExportTask) GetSnapshotIdsOk() (*[]string, bool) {
	if o == nil || o.SnapshotIds == nil {
		return nil, false
	}
...
func (o *FiltersSnapshotExportTask) HasSnapshotIds() bool {
	if o != nil && o.SnapshotIds != nil {
		return true
	}
...
func (o *FiltersSnapshotExportTask) SetSnapshotIds(v []string) {
	o.SnapshotIds = &v
}

// GetTaskIds returns the TaskIds field value if set, zero value otherwise.
func (o *FiltersSnapshotExportTask) GetTaskIds() []string {
...
// and a boolean to check if the value has been set.
func (o *FiltersSnapshotExportTask) GetTaskIdsOk() (*[]string, bool) {
	if o == nil || o.TaskIds == nil {
		return nil, false
	}
...
func (o *FiltersSnapshotExportTask) HasTaskIds() bool {
	if o != nil && o.TaskIds != nil {
		return true
	}
...
func (o *FiltersSnapshotExportTask) SetTaskIds(v []string) {
	o.TaskIds = &v
}

func (o FiltersSnapshotExportTask) MarshalJSON() ([]byte, error) {
...
type NullableFiltersSnapshotExportTask struct {
	value *FiltersSnapshotExportTask
	isSet bool
}

func (v NullableFiltersSnapshotExportTask) Get() *FiltersSnapshotExportTask {
	return v.value
}

func (v *NullableFiltersSnapshotExportTask) Set(val *FiltersSnapshotExportTask) {
	v.value = val
	v.isSet = true
}

func (v NullableFiltersSnapshotExportTask) IsSet() bool {
	return v.isSet
}

func (v *NullableFiltersSnapshotExportTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFiltersSnapshotExportTask(val *FiltersSnapshotExportTask) *NullableFiltersSnapshotExportTask {
	return &NullableFiltersSnapshotExportTask{value: val, isSet: true}
}

func (v NullableFiltersSnapshotExportTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFiltersSnapshotExportTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
