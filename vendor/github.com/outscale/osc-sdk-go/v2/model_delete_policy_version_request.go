...
func NewDeletePolicyVersionRequest(policyOrn string, versionId string) *DeletePolicyVersionRequest {
	this := DeletePolicyVersionRequest{}
...
func (o DeletePolicyVersionRequest) MarshalJSON() ([]byte, error) {
...
type NullableDeletePolicyVersionRequest struct {
	value *DeletePolicyVersionRequest
	isSet bool
}

func (v NullableDeletePolicyVersionRequest) Get() *DeletePolicyVersionRequest {
	return v.value
}

func (v *NullableDeletePolicyVersionRequest) Set(val *DeletePolicyVersionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeletePolicyVersionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeletePolicyVersionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeletePolicyVersionRequest(val *DeletePolicyVersionRequest) *NullableDeletePolicyVersionRequest {
	return &NullableDeletePolicyVersionRequest{value: val, isSet: true}
}

func (v NullableDeletePolicyVersionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeletePolicyVersionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
