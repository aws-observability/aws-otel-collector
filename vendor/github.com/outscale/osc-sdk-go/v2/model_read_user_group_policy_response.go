...
type ReadUserGroupPolicyResponse struct {
	Policy          *InlinePolicy    `json:"Policy,omitempty"`
...
func NewReadUserGroupPolicyResponse() *ReadUserGroupPolicyResponse {
	this := ReadUserGroupPolicyResponse{}
	return &this
}
...
// SetPolicy gets a reference to the given InlinePolicy and assigns it to the Policy field.
...
func (o ReadUserGroupPolicyResponse) MarshalJSON() ([]byte, error) {
...
type NullableReadUserGroupPolicyResponse struct {
	value *ReadUserGroupPolicyResponse
	isSet bool
}

func (v NullableReadUserGroupPolicyResponse) Get() *ReadUserGroupPolicyResponse {
	return v.value
}

func (v *NullableReadUserGroupPolicyResponse) Set(val *ReadUserGroupPolicyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReadUserGroupPolicyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReadUserGroupPolicyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadUserGroupPolicyResponse(val *ReadUserGroupPolicyResponse) *NullableReadUserGroupPolicyResponse {
	return &NullableReadUserGroupPolicyResponse{value: val, isSet: true}
}

func (v NullableReadUserGroupPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadUserGroupPolicyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
