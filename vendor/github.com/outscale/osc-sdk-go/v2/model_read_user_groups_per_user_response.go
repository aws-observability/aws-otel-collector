...
type ReadUserGroupsPerUserResponse struct {
...
func NewReadUserGroupsPerUserResponse() *ReadUserGroupsPerUserResponse {
	this := ReadUserGroupsPerUserResponse{}
	return &this
}
...
func (o ReadUserGroupsPerUserResponse) MarshalJSON() ([]byte, error) {
...
type NullableReadUserGroupsPerUserResponse struct {
	value *ReadUserGroupsPerUserResponse
	isSet bool
}

func (v NullableReadUserGroupsPerUserResponse) Get() *ReadUserGroupsPerUserResponse {
	return v.value
}

func (v *NullableReadUserGroupsPerUserResponse) Set(val *ReadUserGroupsPerUserResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReadUserGroupsPerUserResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReadUserGroupsPerUserResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadUserGroupsPerUserResponse(val *ReadUserGroupsPerUserResponse) *NullableReadUserGroupsPerUserResponse {
	return &NullableReadUserGroupsPerUserResponse{value: val, isSet: true}
}

func (v NullableReadUserGroupsPerUserResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadUserGroupsPerUserResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
