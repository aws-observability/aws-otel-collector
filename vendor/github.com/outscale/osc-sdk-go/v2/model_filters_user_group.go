...
func (o FiltersUserGroup) MarshalJSON() ([]byte, error) {
...
type NullableFiltersUserGroup struct {
	value *FiltersUserGroup
	isSet bool
}

func (v NullableFiltersUserGroup) Get() *FiltersUserGroup {
	return v.value
}

func (v *NullableFiltersUserGroup) Set(val *FiltersUserGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableFiltersUserGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableFiltersUserGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFiltersUserGroup(val *FiltersUserGroup) *NullableFiltersUserGroup {
	return &NullableFiltersUserGroup{value: val, isSet: true}
}

func (v NullableFiltersUserGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFiltersUserGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
