...
type ReadConsumptionAccountResponse struct {
	...
	// The currency of your account for the `UnitPrice` and `Price` parameters, in the ISO-4217 format (for example, `EUR`).
...
func (o *ReadConsumptionAccountResponse) SetCurrencyNil() {
	o.Currency.Set(nil)
}
