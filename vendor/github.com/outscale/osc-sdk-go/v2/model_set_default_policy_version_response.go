...
func NewSetDefaultPolicyVersionResponse() *SetDefaultPolicyVersionResponse {
	this := SetDefaultPolicyVersionResponse{}
	return &this
}
...
func (o SetDefaultPolicyVersionResponse) MarshalJSON() ([]byte, error) {
...
type NullableSetDefaultPolicyVersionResponse struct {
	value *SetDefaultPolicyVersionResponse
	isSet bool
}

func (v NullableSetDefaultPolicyVersionResponse) Get() *SetDefaultPolicyVersionResponse {
	return v.value
}

func (v *NullableSetDefaultPolicyVersionResponse) Set(val *SetDefaultPolicyVersionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSetDefaultPolicyVersionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSetDefaultPolicyVersionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetDefaultPolicyVersionResponse(val *SetDefaultPolicyVersionResponse) *NullableSetDefaultPolicyVersionResponse {
	return &NullableSetDefaultPolicyVersionResponse{value: val, isSet: true}
}

func (v NullableSetDefaultPolicyVersionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetDefaultPolicyVersionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
