...
func NewReadPolicyVersionResponse() *ReadPolicyVersionResponse {
	this := ReadPolicyVersionResponse{}
	return &this
}
...
func (o ReadPolicyVersionResponse) MarshalJSON() ([]byte, error) {
...
type NullableReadPolicyVersionResponse struct {
	value *ReadPolicyVersionResponse
	isSet bool
}

func (v NullableReadPolicyVersionResponse) Get() *ReadPolicyVersionResponse {
	return v.value
}

func (v *NullableReadPolicyVersionResponse) Set(val *ReadPolicyVersionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReadPolicyVersionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReadPolicyVersionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadPolicyVersionResponse(val *ReadPolicyVersionResponse) *NullableReadPolicyVersionResponse {
	return &NullableReadPolicyVersionResponse{value: val, isSet: true}
}

func (v NullableReadPolicyVersionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadPolicyVersionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
