...
func (o ReadUserGroupsResponse) MarshalJSON() ([]byte, error) {
...
type NullableReadUserGroupsResponse struct {
	value *ReadUserGroupsResponse
	isSet bool
}

func (v NullableReadUserGroupsResponse) Get() *ReadUserGroupsResponse {
	return v.value
}

func (v *NullableReadUserGroupsResponse) Set(val *ReadUserGroupsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReadUserGroupsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReadUserGroupsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadUserGroupsResponse(val *ReadUserGroupsResponse) *NullableReadUserGroupsResponse {
	return &NullableReadUserGroupsResponse{value: val, isSet: true}
}

func (v NullableReadUserGroupsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadUserGroupsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
