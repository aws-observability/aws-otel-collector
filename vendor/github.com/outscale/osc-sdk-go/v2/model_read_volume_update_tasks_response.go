...
// ReadVolumeUpdateTasksResponse struct for ReadVolumeUpdateTasksResponse
...
func NewReadVolumeUpdateTasksResponse() *ReadVolumeUpdateTasksResponse {
	this := ReadVolumeUpdateTasksResponse{}
	return &this
}
...
// GetVolumeUpdateTasks returns the VolumeUpdateTasks field value if set, zero value otherwise.
func (o *ReadVolumeUpdateTasksResponse) GetVolumeUpdateTasks() []VolumeUpdateTask {
	if o == nil || o.VolumeUpdateTasks == nil {
		var ret []VolumeUpdateTask
		return ret
	}
	return *o.VolumeUpdateTasks
}

// GetVolumeUpdateTasksOk returns a tuple with the VolumeUpdateTasks field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReadVolumeUpdateTasksResponse) GetVolumeUpdateTasksOk() (*[]VolumeUpdateTask, bool) {
	if o == nil || o.VolumeUpdateTasks == nil {
		return nil, false
	}
	return o.VolumeUpdateTasks, true
}
...
// SetVolumeUpdateTasks gets a reference to the given []VolumeUpdateTask and assigns it to the VolumeUpdateTasks field.
func (o *ReadVolumeUpdateTasksResponse) SetVolumeUpdateTasks(v []VolumeUpdateTask) {
	o.VolumeUpdateTasks = &v
}

func (o ReadVolumeUpdateTasksResponse) MarshalJSON() ([]byte, error) {
	...
	if o.VolumeUpdateTasks != nil {
		toSerialize["VolumeUpdateTasks"] = o.VolumeUpdateTasks
	}
	return json.Marshal(toSerialize)
}

type NullableReadVolumeUpdateTasksResponse struct {
	value *ReadVolumeUpdateTasksResponse
	isSet bool
}

func (v NullableReadVolumeUpdateTasksResponse) Get() *ReadVolumeUpdateTasksResponse {
	return v.value
}

func (v *NullableReadVolumeUpdateTasksResponse) Set(val *ReadVolumeUpdateTasksResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReadVolumeUpdateTasksResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReadVolumeUpdateTasksResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadVolumeUpdateTasksResponse(val *ReadVolumeUpdateTasksResponse) *NullableReadVolumeUpdateTasksResponse {
	return &NullableReadVolumeUpdateTasksResponse{value: val, isSet: true}
}

func (v NullableReadVolumeUpdateTasksResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadVolumeUpdateTasksResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
