...
func (o *ReadProductTypesRequest) GetNextPageToken() string {
...
// and a boolean to check if the value has been set.
func (o *ReadProductTypesRequest) GetNextPageTokenOk() (*string, bool) {
	if o == nil || o.NextPageToken == nil {
		return nil, false
	}
...
func (o *ReadProductTypesRequest) HasNextPageToken() bool {
	if o != nil && o.NextPageToken != nil {
		return true
	}
...
func (o *ReadProductTypesRequest) SetNextPageToken(v string) {
	o.NextPageToken = &v
}

// GetResultsPerPage returns the ResultsPerPage field value if set, zero value otherwise.
func (o *ReadProductTypesRequest) GetResultsPerPage() int32 {
...
// and a boolean to check if the value has been set.
func (o *ReadProductTypesRequest) GetResultsPerPageOk() (*int32, bool) {
	if o == nil || o.ResultsPerPage == nil {
		return nil, false
	}
...
func (o *ReadProductTypesRequest) HasResultsPerPage() bool {
	if o != nil && o.ResultsPerPage != nil {
		return true
	}
...
func (o *ReadProductTypesRequest) SetResultsPerPage(v int32) {
	o.ResultsPerPage = &v
}
