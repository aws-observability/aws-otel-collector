...
type ReadPolicyVersionsRequest struct {
...
func NewReadPolicyVersionsRequest(policyOrn string) *ReadPolicyVersionsRequest {
	this := ReadPolicyVersionsRequest{}
...
func (o ReadPolicyVersionsRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadPolicyVersionsRequest struct {
	value *ReadPolicyVersionsRequest
	isSet bool
}

func (v NullableReadPolicyVersionsRequest) Get() *ReadPolicyVersionsRequest {
	return v.value
}

func (v *NullableReadPolicyVersionsRequest) Set(val *ReadPolicyVersionsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadPolicyVersionsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadPolicyVersionsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadPolicyVersionsRequest(val *ReadPolicyVersionsRequest) *NullableReadPolicyVersionsRequest {
	return &NullableReadPolicyVersionsRequest{value: val, isSet: true}
}

func (v NullableReadPolicyVersionsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadPolicyVersionsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
