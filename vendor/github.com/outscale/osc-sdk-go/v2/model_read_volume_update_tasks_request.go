...
// ReadVolumeUpdateTasksRequest struct for ReadVolumeUpdateTasksRequest
...
func NewReadVolumeUpdateTasksRequest() *ReadVolumeUpdateTasksRequest {
	this := ReadVolumeUpdateTasksRequest{}
	return &this
}
...
func (o *ReadVolumeUpdateTasksRequest) GetFilters() FiltersReadVolumeUpdateTask {
	if o == nil || o.Filters == nil {
		var ret FiltersReadVolumeUpdateTask
		return ret
	}
	return *o.Filters
}
...
// SetFilters gets a reference to the given FiltersReadVolumeUpdateTask and assigns it to the Filters field.
...
func (o ReadVolumeUpdateTasksRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadVolumeUpdateTasksRequest struct {
	value *ReadVolumeUpdateTasksRequest
	isSet bool
}

func (v NullableReadVolumeUpdateTasksRequest) Get() *ReadVolumeUpdateTasksRequest {
	return v.value
}

func (v *NullableReadVolumeUpdateTasksRequest) Set(val *ReadVolumeUpdateTasksRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadVolumeUpdateTasksRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadVolumeUpdateTasksRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadVolumeUpdateTasksRequest(val *ReadVolumeUpdateTasksRequest) *NullableReadVolumeUpdateTasksRequest {
	return &NullableReadVolumeUpdateTasksRequest{value: val, isSet: true}
}

func (v NullableReadVolumeUpdateTasksRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadVolumeUpdateTasksRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
