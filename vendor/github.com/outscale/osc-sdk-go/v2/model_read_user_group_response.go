...
type ReadUserGroupResponse struct {
...
func (o ReadUserGroupResponse) MarshalJSON() ([]byte, error) {
...
type NullableReadUserGroupResponse struct {
	value *ReadUserGroupResponse
	isSet bool
}

func (v NullableReadUserGroupResponse) Get() *ReadUserGroupResponse {
	return v.value
}

func (v *NullableReadUserGroupResponse) Set(val *ReadUserGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReadUserGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReadUserGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadUserGroupResponse(val *ReadUserGroupResponse) *NullableReadUserGroupResponse {
	return &NullableReadUserGroupResponse{value: val, isSet: true}
}

func (v NullableReadUserGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadUserGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
