...
type DeleteVmTemplateResponse struct {
...
func (o DeleteVmTemplateResponse) MarshalJSON() ([]byte, error) {
...
type NullableDeleteVmTemplateResponse struct {
	value *DeleteVmTemplateResponse
	isSet bool
}

func (v NullableDeleteVmTemplateResponse) Get() *DeleteVmTemplateResponse {
	return v.value
}

func (v *NullableDeleteVmTemplateResponse) Set(val *DeleteVmTemplateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteVmTemplateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteVmTemplateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteVmTemplateResponse(val *DeleteVmTemplateResponse) *NullableDeleteVmTemplateResponse {
	return &NullableDeleteVmTemplateResponse{value: val, isSet: true}
}

func (v NullableDeleteVmTemplateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteVmTemplateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
