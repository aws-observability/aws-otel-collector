...
type ReadPoliciesRequest struct {
	...
	Filters *ReadPoliciesFilters `json:"Filters,omitempty"`
...
// SetFilters gets a reference to the given ReadPoliciesFilters and assigns it to the Filters field.
...
func (o ReadPoliciesRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadPoliciesRequest struct {
	value *ReadPoliciesRequest
	isSet bool
}

func (v NullableReadPoliciesRequest) Get() *ReadPoliciesRequest {
	return v.value
}

func (v *NullableReadPoliciesRequest) Set(val *ReadPoliciesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadPoliciesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadPoliciesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadPoliciesRequest(val *ReadPoliciesRequest) *NullableReadPoliciesRequest {
	return &NullableReadPoliciesRequest{value: val, isSet: true}
}

func (v NullableReadPoliciesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadPoliciesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
