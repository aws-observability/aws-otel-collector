...
type ReadDedicatedGroupsRequest struct {
...
func NewReadDedicatedGroupsRequest() *ReadDedicatedGroupsRequest {
	this := ReadDedicatedGroupsRequest{}
	return &this
}
...
// SetFilters gets a reference to the given FiltersDedicatedGroup and assigns it to the Filters field.
...
func (o ReadDedicatedGroupsRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadDedicatedGroupsRequest struct {
	value *ReadDedicatedGroupsRequest
	isSet bool
}

func (v NullableReadDedicatedGroupsRequest) Get() *ReadDedicatedGroupsRequest {
	return v.value
}

func (v *NullableReadDedicatedGroupsRequest) Set(val *ReadDedicatedGroupsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadDedicatedGroupsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadDedicatedGroupsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadDedicatedGroupsRequest(val *ReadDedicatedGroupsRequest) *NullableReadDedicatedGroupsRequest {
	return &NullableReadDedicatedGroupsRequest{value: val, isSet: true}
}

func (v NullableReadDedicatedGroupsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadDedicatedGroupsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
