...
func (o UpdateVmGroupResponse) MarshalJSON() ([]byte, error) {
...
type NullableUpdateVmGroupResponse struct {
	value *UpdateVmGroupResponse
	isSet bool
}

func (v NullableUpdateVmGroupResponse) Get() *UpdateVmGroupResponse {
	return v.value
}

func (v *NullableUpdateVmGroupResponse) Set(val *UpdateVmGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateVmGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateVmGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateVmGroupResponse(val *UpdateVmGroupResponse) *NullableUpdateVmGroupResponse {
	return &NullableUpdateVmGroupResponse{value: val, isSet: true}
}

func (v NullableUpdateVmGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateVmGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
