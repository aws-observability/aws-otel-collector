...
func (o UpdateUserGroupResponse) MarshalJSON() ([]byte, error) {
...
type NullableUpdateUserGroupResponse struct {
	value *UpdateUserGroupResponse
	isSet bool
}

func (v NullableUpdateUserGroupResponse) Get() *UpdateUserGroupResponse {
	return v.value
}

func (v *NullableUpdateUserGroupResponse) Set(val *UpdateUserGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateUserGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateUserGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateUserGroupResponse(val *UpdateUserGroupResponse) *NullableUpdateUserGroupResponse {
	return &NullableUpdateUserGroupResponse{value: val, isSet: true}
}

func (v NullableUpdateUserGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateUserGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
