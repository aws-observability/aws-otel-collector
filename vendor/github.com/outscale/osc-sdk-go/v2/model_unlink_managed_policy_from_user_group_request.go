...
type UnlinkManagedPolicyFromUserGroupRequest struct {
...
func NewUnlinkManagedPolicyFromUserGroupRequest(policyOrn string, userGroupName string) *UnlinkManagedPolicyFromUserGroupRequest {
	this := UnlinkManagedPolicyFromUserGroupRequest{}
...
func (o UnlinkManagedPolicyFromUserGroupRequest) MarshalJSON() ([]byte, error) {
...
type NullableUnlinkManagedPolicyFromUserGroupRequest struct {
	value *UnlinkManagedPolicyFromUserGroupRequest
	isSet bool
}

func (v NullableUnlinkManagedPolicyFromUserGroupRequest) Get() *UnlinkManagedPolicyFromUserGroupRequest {
	return v.value
}

func (v *NullableUnlinkManagedPolicyFromUserGroupRequest) Set(val *UnlinkManagedPolicyFromUserGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUnlinkManagedPolicyFromUserGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUnlinkManagedPolicyFromUserGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnlinkManagedPolicyFromUserGroupRequest(val *UnlinkManagedPolicyFromUserGroupRequest) *NullableUnlinkManagedPolicyFromUserGroupRequest {
	return &NullableUnlinkManagedPolicyFromUserGroupRequest{value: val, isSet: true}
}

func (v NullableUnlinkManagedPolicyFromUserGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnlinkManagedPolicyFromUserGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
