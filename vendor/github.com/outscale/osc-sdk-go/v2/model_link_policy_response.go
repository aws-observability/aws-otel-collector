...
func (o LinkPolicyResponse) MarshalJSON() ([]byte, error) {
...
type NullableLinkPolicyResponse struct {
	value *LinkPolicyResponse
	isSet bool
}

func (v NullableLinkPolicyResponse) Get() *LinkPolicyResponse {
	return v.value
}

func (v *NullableLinkPolicyResponse) Set(val *LinkPolicyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkPolicyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkPolicyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkPolicyResponse(val *LinkPolicyResponse) *NullableLinkPolicyResponse {
	return &NullableLinkPolicyResponse{value: val, isSet: true}
}

func (v NullableLinkPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkPolicyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
