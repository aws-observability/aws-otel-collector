...
func (o ReadUserGroupRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadUserGroupRequest struct {
	value *ReadUserGroupRequest
	isSet bool
}

func (v NullableReadUserGroupRequest) Get() *ReadUserGroupRequest {
	return v.value
}

func (v *NullableReadUserGroupRequest) Set(val *ReadUserGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadUserGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadUserGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadUserGroupRequest(val *ReadUserGroupRequest) *NullableReadUserGroupRequest {
	return &NullableReadUserGroupRequest{value: val, isSet: true}
}

func (v NullableReadUserGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadUserGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
