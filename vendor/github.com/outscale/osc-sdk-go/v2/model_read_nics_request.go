...
func (o *ReadNicsRequest) GetNextPageToken() string {
...
// and a boolean to check if the value has been set.
func (o *ReadNicsRequest) GetNextPageTokenOk() (*string, bool) {
	if o == nil || o.NextPageToken == nil {
		return nil, false
	}
...
func (o *ReadNicsRequest) HasNextPageToken() bool {
	if o != nil && o.NextPageToken != nil {
		return true
	}
...
func (o *ReadNicsRequest) SetNextPageToken(v string) {
	o.NextPageToken = &v
}

// GetResultsPerPage returns the ResultsPerPage field value if set, zero value otherwise.
func (o *ReadNicsRequest) GetResultsPerPage() int32 {
...
// and a boolean to check if the value has been set.
func (o *ReadNicsRequest) GetResultsPerPageOk() (*int32, bool) {
	if o == nil || o.ResultsPerPage == nil {
		return nil, false
	}
...
func (o *ReadNicsRequest) HasResultsPerPage() bool {
	if o != nil && o.ResultsPerPage != nil {
		return true
	}
...
func (o *ReadNicsRequest) SetResultsPerPage(v int32) {
	o.ResultsPerPage = &v
}
