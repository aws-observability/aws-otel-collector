...
type ApiCreateProductTypeRequest struct {
	ctx                      _context.Context
	ApiService               *ProductTypeApiService
	createProductTypeRequest *CreateProductTypeRequest
}

func (r ApiCreateProductTypeRequest) CreateProductTypeRequest(createProductTypeRequest CreateProductTypeRequest) ApiCreateProductTypeRequest {
	r.createProductTypeRequest = &createProductTypeRequest
	return r
}

func (r ApiCreateProductTypeRequest) Execute() (CreateProductTypeResponse, *_nethttp.Response, error) {
	return r.ApiService.CreateProductTypeExecute(r)
}

/*
 * CreateProductType Method for CreateProductType
 ...
 * @return ApiCreateProductTypeRequest
 */
func (a *ProductTypeApiService) CreateProductType(ctx _context.Context) ApiCreateProductTypeRequest {
	return ApiCreateProductTypeRequest{
		ApiService: a,
		ctx:        ctx,
	}
 ...
 */
func (a *ProductTypeApiService) CreateProductTypeExecute(r ApiCreateProductTypeRequest) (CreateProductTypeResponse, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  CreateProductTypeResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProductTypeApiService.CreateProductType")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/CreateProductType"
	...
	// body params
	localVarPostBody = r.createProductTypeRequest
	if r.ctx != nil {
...
type ApiDeleteProductTypeRequest struct {
	ctx                      _context.Context
	ApiService               *ProductTypeApiService
	deleteProductTypeRequest *DeleteProductTypeRequest
}

func (r ApiDeleteProductTypeRequest) DeleteProductTypeRequest(deleteProductTypeRequest DeleteProductTypeRequest) ApiDeleteProductTypeRequest {
	r.deleteProductTypeRequest = &deleteProductTypeRequest
	return r
}

func (r ApiDeleteProductTypeRequest) Execute() (DeleteProductTypeResponse, *_nethttp.Response, error) {
	return r.ApiService.DeleteProductTypeExecute(r)
}

/*
  - DeleteProductType Method for DeleteProductType
...
If you force the deletion, the product type is deleted and remains associated with the OMIs.<br />
  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @return ApiDeleteProductTypeRequest
*/
func (a *ProductTypeApiService) DeleteProductType(ctx _context.Context) ApiDeleteProductTypeRequest {
	return ApiDeleteProductTypeRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
/*
 * Execute executes the request
 * @return DeleteProductTypeResponse
 */
func (a *ProductTypeApiService) DeleteProductTypeExecute(r ApiDeleteProductTypeRequest) (DeleteProductTypeResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  DeleteProductTypeResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProductTypeApiService.DeleteProductType")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/DeleteProductType"
	...
	// body params
	localVarPostBody = r.deleteProductTypeRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
