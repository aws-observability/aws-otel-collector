...
func (o DeleteVmGroupResponse) MarshalJSON() ([]byte, error) {
...
type NullableDeleteVmGroupResponse struct {
	value *DeleteVmGroupResponse
	isSet bool
}

func (v NullableDeleteVmGroupResponse) Get() *DeleteVmGroupResponse {
	return v.value
}

func (v *NullableDeleteVmGroupResponse) Set(val *DeleteVmGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteVmGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteVmGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteVmGroupResponse(val *DeleteVmGroupResponse) *NullableDeleteVmGroupResponse {
	return &NullableDeleteVmGroupResponse{value: val, isSet: true}
}

func (v NullableDeleteVmGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteVmGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
