...
func (o CO2CategoryDistribution) MarshalJSON() ([]byte, error) {
...
type NullableCO2CategoryDistribution struct {
	value *CO2CategoryDistribution
	isSet bool
}

func (v NullableCO2CategoryDistribution) Get() *CO2CategoryDistribution {
	return v.value
}

func (v *NullableCO2CategoryDistribution) Set(val *CO2CategoryDistribution) {
	v.value = val
	v.isSet = true
}

func (v NullableCO2CategoryDistribution) IsSet() bool {
	return v.isSet
}

func (v *NullableCO2CategoryDistribution) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCO2CategoryDistribution(val *CO2CategoryDistribution) *NullableCO2CategoryDistribution {
	return &NullableCO2CategoryDistribution{value: val, isSet: true}
}

func (v NullableCO2CategoryDistribution) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCO2CategoryDistribution) UnmarshalJSON(src []byte) error {
	v.isSet = true
