...
func NewCreateProductTypeResponse() *CreateProductTypeResponse {
	this := CreateProductTypeResponse{}
	return &this
}
...
func (o CreateProductTypeResponse) MarshalJSON() ([]byte, error) {
...
type NullableCreateProductTypeResponse struct {
	value *CreateProductTypeResponse
	isSet bool
}

func (v NullableCreateProductTypeResponse) Get() *CreateProductTypeResponse {
	return v.value
}

func (v *NullableCreateProductTypeResponse) Set(val *CreateProductTypeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateProductTypeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateProductTypeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateProductTypeResponse(val *CreateProductTypeResponse) *NullableCreateProductTypeResponse {
	return &NullableCreateProductTypeResponse{value: val, isSet: true}
}

func (v NullableCreateProductTypeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateProductTypeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
