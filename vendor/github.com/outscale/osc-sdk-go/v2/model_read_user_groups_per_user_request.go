...
type ReadUserGroupsPerUserRequest struct {
...
func NewReadUserGroupsPerUserRequest(userName string) *ReadUserGroupsPerUserRequest {
	this := ReadUserGroupsPerUserRequest{}
...
func (o ReadUserGroupsPerUserRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadUserGroupsPerUserRequest struct {
	value *ReadUserGroupsPerUserRequest
	isSet bool
}

func (v NullableReadUserGroupsPerUserRequest) Get() *ReadUserGroupsPerUserRequest {
	return v.value
}

func (v *NullableReadUserGroupsPerUserRequest) Set(val *ReadUserGroupsPerUserRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadUserGroupsPerUserRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadUserGroupsPerUserRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadUserGroupsPerUserRequest(val *ReadUserGroupsPerUserRequest) *NullableReadUserGroupsPerUserRequest {
	return &NullableReadUserGroupsPerUserRequest{value: val, isSet: true}
}

func (v NullableReadUserGroupsPerUserRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadUserGroupsPerUserRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
