...
type DeleteDedicatedGroupRequest struct {
	// The ID of the dedicated group you want to delete.
	DedicatedGroupId string `json:"DedicatedGroupId"`
...
func NewDeleteDedicatedGroupRequest(dedicatedGroupId string) *DeleteDedicatedGroupRequest {
	this := DeleteDedicatedGroupRequest{}
...
// GetDedicatedGroupId returns the DedicatedGroupId field value
...
// GetDedicatedGroupIdOk returns a tuple with the DedicatedGroupId field value
...
// SetDedicatedGroupId sets field value
...
func (o DeleteDedicatedGroupRequest) MarshalJSON() ([]byte, error) {
...
type NullableDeleteDedicatedGroupRequest struct {
	value *DeleteDedicatedGroupRequest
	isSet bool
}

func (v NullableDeleteDedicatedGroupRequest) Get() *DeleteDedicatedGroupRequest {
	return v.value
}

func (v *NullableDeleteDedicatedGroupRequest) Set(val *DeleteDedicatedGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteDedicatedGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteDedicatedGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteDedicatedGroupRequest(val *DeleteDedicatedGroupRequest) *NullableDeleteDedicatedGroupRequest {
	return &NullableDeleteDedicatedGroupRequest{value: val, isSet: true}
}

func (v NullableDeleteDedicatedGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteDedicatedGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
