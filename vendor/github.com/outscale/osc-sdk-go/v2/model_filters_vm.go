...
type FiltersVm struct {
	...
	// The OUTSCALE account IDs of the owners of the VMs the NICs are attached to.
	...
	// The OUTSCALE account IDs of the owners of the public IPs associated with the NICs.
	...
	// The OUTSCALE account IDs of the owner of the public IPs associated with the private IPs.
