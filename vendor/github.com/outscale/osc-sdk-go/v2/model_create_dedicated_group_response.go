...
type CreateDedicatedGroupResponse struct {
	DedicatedGroup  *DedicatedGroup  `json:"DedicatedGroup,omitempty"`
...
func NewCreateDedicatedGroupResponse() *CreateDedicatedGroupResponse {
	this := CreateDedicatedGroupResponse{}
	return &this
}
...
// GetDedicatedGroup returns the DedicatedGroup field value if set, zero value otherwise.
func (o *CreateDedicatedGroupResponse) GetDedicatedGroup() DedicatedGroup {
	if o == nil || o.DedicatedGroup == nil {
		var ret DedicatedGroup
		return ret
	}
	return *o.DedicatedGroup
}

// GetDedicatedGroupOk returns a tuple with the DedicatedGroup field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateDedicatedGroupResponse) GetDedicatedGroupOk() (*DedicatedGroup, bool) {
	if o == nil || o.DedicatedGroup == nil {
		return nil, false
	}
	return o.DedicatedGroup, true
}
...
// SetDedicatedGroup gets a reference to the given DedicatedGroup and assigns it to the DedicatedGroup field.
...
func (o CreateDedicatedGroupResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.DedicatedGroup != nil {
		toSerialize["DedicatedGroup"] = o.DedicatedGroup
	}
...
type NullableCreateDedicatedGroupResponse struct {
	value *CreateDedicatedGroupResponse
	isSet bool
}

func (v NullableCreateDedicatedGroupResponse) Get() *CreateDedicatedGroupResponse {
	return v.value
}

func (v *NullableCreateDedicatedGroupResponse) Set(val *CreateDedicatedGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDedicatedGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDedicatedGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDedicatedGroupResponse(val *CreateDedicatedGroupResponse) *NullableCreateDedicatedGroupResponse {
	return &NullableCreateDedicatedGroupResponse{value: val, isSet: true}
}

func (v NullableCreateDedicatedGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDedicatedGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
