...
func (o LinkPolicyRequest) MarshalJSON() ([]byte, error) {
...
type NullableLinkPolicyRequest struct {
	value *LinkPolicyRequest
	isSet bool
}

func (v NullableLinkPolicyRequest) Get() *LinkPolicyRequest {
	return v.value
}

func (v *NullableLinkPolicyRequest) Set(val *LinkPolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkPolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkPolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkPolicyRequest(val *LinkPolicyRequest) *NullableLinkPolicyRequest {
	return &NullableLinkPolicyRequest{value: val, isSet: true}
}

func (v NullableLinkPolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkPolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
