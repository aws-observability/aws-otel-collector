...
// EnableOutscaleLoginPerUsersRequest struct for EnableOutscaleLoginPerUsersRequest
...
func NewEnableOutscaleLoginPerUsersRequest(userNames []string) *EnableOutscaleLoginPerUsersRequest {
	this := EnableOutscaleLoginPerUsersRequest{}
...
func (o EnableOutscaleLoginPerUsersRequest) MarshalJSON() ([]byte, error) {
...
type NullableEnableOutscaleLoginPerUsersRequest struct {
	value *EnableOutscaleLoginPerUsersRequest
	isSet bool
}

func (v NullableEnableOutscaleLoginPerUsersRequest) Get() *EnableOutscaleLoginPerUsersRequest {
	return v.value
}

func (v *NullableEnableOutscaleLoginPerUsersRequest) Set(val *EnableOutscaleLoginPerUsersRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEnableOutscaleLoginPerUsersRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEnableOutscaleLoginPerUsersRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnableOutscaleLoginPerUsersRequest(val *EnableOutscaleLoginPerUsersRequest) *NullableEnableOutscaleLoginPerUsersRequest {
	return &NullableEnableOutscaleLoginPerUsersRequest{value: val, isSet: true}
}

func (v NullableEnableOutscaleLoginPerUsersRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnableOutscaleLoginPerUsersRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
