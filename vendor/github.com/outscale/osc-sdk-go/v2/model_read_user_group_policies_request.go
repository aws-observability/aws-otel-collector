...
type ReadUserGroupPoliciesRequest struct {
...
func NewReadUserGroupPoliciesRequest(userGroupName string) *ReadUserGroupPoliciesRequest {
	this := ReadUserGroupPoliciesRequest{}
...
func (o ReadUserGroupPoliciesRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadUserGroupPoliciesRequest struct {
	value *ReadUserGroupPoliciesRequest
	isSet bool
}

func (v NullableReadUserGroupPoliciesRequest) Get() *ReadUserGroupPoliciesRequest {
	return v.value
}

func (v *NullableReadUserGroupPoliciesRequest) Set(val *ReadUserGroupPoliciesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadUserGroupPoliciesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadUserGroupPoliciesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadUserGroupPoliciesRequest(val *ReadUserGroupPoliciesRequest) *NullableReadUserGroupPoliciesRequest {
	return &NullableReadUserGroupPoliciesRequest{value: val, isSet: true}
}

func (v NullableReadUserGroupPoliciesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadUserGroupPoliciesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
