...
func NewCreatePolicyVersionResponse() *CreatePolicyVersionResponse {
	this := CreatePolicyVersionResponse{}
	return &this
}
...
func (o CreatePolicyVersionResponse) MarshalJSON() ([]byte, error) {
...
type NullableCreatePolicyVersionResponse struct {
	value *CreatePolicyVersionResponse
	isSet bool
}

func (v NullableCreatePolicyVersionResponse) Get() *CreatePolicyVersionResponse {
	return v.value
}

func (v *NullableCreatePolicyVersionResponse) Set(val *CreatePolicyVersionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePolicyVersionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePolicyVersionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePolicyVersionResponse(val *CreatePolicyVersionResponse) *NullableCreatePolicyVersionResponse {
	return &NullableCreatePolicyVersionResponse{value: val, isSet: true}
}

func (v NullableCreatePolicyVersionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePolicyVersionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
