...
func (o CO2FactorDistribution) MarshalJSON() ([]byte, error) {
...
type NullableCO2FactorDistribution struct {
	value *CO2FactorDistribution
	isSet bool
}

func (v NullableCO2FactorDistribution) Get() *CO2FactorDistribution {
	return v.value
}

func (v *NullableCO2FactorDistribution) Set(val *CO2FactorDistribution) {
	v.value = val
	v.isSet = true
}

func (v NullableCO2FactorDistribution) IsSet() bool {
	return v.isSet
}

func (v *NullableCO2FactorDistribution) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCO2FactorDistribution(val *CO2FactorDistribution) *NullableCO2FactorDistribution {
	return &NullableCO2FactorDistribution{value: val, isSet: true}
}

func (v NullableCO2FactorDistribution) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCO2FactorDistribution) UnmarshalJSON(src []byte) error {
	v.isSet = true
