...
func (o UpdateRouteTableLinkResponse) MarshalJSON() ([]byte, error) {
...
type NullableUpdateRouteTableLinkResponse struct {
	value *UpdateRouteTableLinkResponse
	isSet bool
}

func (v NullableUpdateRouteTableLinkResponse) Get() *UpdateRouteTableLinkResponse {
	return v.value
}

func (v *NullableUpdateRouteTableLinkResponse) Set(val *UpdateRouteTableLinkResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateRouteTableLinkResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateRouteTableLinkResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateRouteTableLinkResponse(val *UpdateRouteTableLinkResponse) *NullableUpdateRouteTableLinkResponse {
	return &NullableUpdateRouteTableLinkResponse{value: val, isSet: true}
}

func (v NullableUpdateRouteTableLinkResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateRouteTableLinkResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
