...
func (o ReadPoliciesResponse) MarshalJSON() ([]byte, error) {
...
type NullableReadPoliciesResponse struct {
	value *ReadPoliciesResponse
	isSet bool
}

func (v NullableReadPoliciesResponse) Get() *ReadPoliciesResponse {
	return v.value
}

func (v *NullableReadPoliciesResponse) Set(val *ReadPoliciesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReadPoliciesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReadPoliciesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadPoliciesResponse(val *ReadPoliciesResponse) *NullableReadPoliciesResponse {
	return &NullableReadPoliciesResponse{value: val, isSet: true}
}

func (v NullableReadPoliciesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadPoliciesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
