...
// DeleteUserPolicyRequest struct for DeleteUserPolicyRequest
...
func (o DeleteUserPolicyRequest) MarshalJSON() ([]byte, error) {
...
type NullableDeleteUserPolicyRequest struct {
	value *DeleteUserPolicyRequest
	isSet bool
}

func (v NullableDeleteUserPolicyRequest) Get() *DeleteUserPolicyRequest {
	return v.value
}

func (v *NullableDeleteUserPolicyRequest) Set(val *DeleteUserPolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteUserPolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteUserPolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteUserPolicyRequest(val *DeleteUserPolicyRequest) *NullableDeleteUserPolicyRequest {
	return &NullableDeleteUserPolicyRequest{value: val, isSet: true}
}

func (v NullableDeleteUserPolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteUserPolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
