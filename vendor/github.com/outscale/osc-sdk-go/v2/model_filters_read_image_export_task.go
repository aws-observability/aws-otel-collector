...
// NewFiltersReadImageExportTask instantiates a new FiltersReadImageExportTask object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewFiltersReadImageExportTask() *FiltersReadImageExportTask {
	this := FiltersReadImageExportTask{}
	return &this
}

// NewFiltersReadImageExportTaskWithDefaults instantiates a new FiltersReadImageExportTask object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewFiltersReadImageExportTaskWithDefaults() *FiltersReadImageExportTask {
	this := FiltersReadImageExportTask{}
	return &this
}

// GetImageIds returns the ImageIds field value if set, zero value otherwise.
func (o *FiltersReadImageExportTask) GetImageIds() []string {
...
func (o *FiltersReadImageExportTask) GetImageIdsOk() (*[]string, bool) {
	if o == nil || o.ImageIds == nil {
		return nil, false
	}
...
func (o *FiltersReadImageExportTask) HasImageIds() bool {
	if o != nil && o.ImageIds != nil {
		return true
	}
...
func (o *FiltersReadImageExportTask) SetImageIds(v []string) {
	o.ImageIds = &v
}

// GetTaskIds returns the TaskIds field value if set, zero value otherwise.
func (o *FiltersReadImageExportTask) GetTaskIds() []string {
...
// and a boolean to check if the value has been set.
func (o *FiltersReadImageExportTask) GetTaskIdsOk() (*[]string, bool) {
	if o == nil || o.TaskIds == nil {
		return nil, false
	}
...
func (o *FiltersReadImageExportTask) HasTaskIds() bool {
	if o != nil && o.TaskIds != nil {
		return true
	}
...
func (o *FiltersReadImageExportTask) SetTaskIds(v []string) {
	o.TaskIds = &v
}

func (o FiltersReadImageExportTask) MarshalJSON() ([]byte, error) {
...
type NullableFiltersReadImageExportTask struct {
	value *FiltersReadImageExportTask
	isSet bool
}

func (v NullableFiltersReadImageExportTask) Get() *FiltersReadImageExportTask {
	return v.value
}

func (v *NullableFiltersReadImageExportTask) Set(val *FiltersReadImageExportTask) {
	v.value = val
	v.isSet = true
}

func (v NullableFiltersReadImageExportTask) IsSet() bool {
	return v.isSet
}

func (v *NullableFiltersReadImageExportTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFiltersReadImageExportTask(val *FiltersReadImageExportTask) *NullableFiltersReadImageExportTask {
	return &NullableFiltersReadImageExportTask{value: val, isSet: true}
}

func (v NullableFiltersReadImageExportTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFiltersReadImageExportTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
