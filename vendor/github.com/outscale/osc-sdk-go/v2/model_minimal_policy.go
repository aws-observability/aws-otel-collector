...
func (o MinimalPolicy) MarshalJSON() ([]byte, error) {
...
type NullableMinimalPolicy struct {
	value *MinimalPolicy
	isSet bool
}

func (v NullableMinimalPolicy) Get() *MinimalPolicy {
	return v.value
}

func (v *NullableMinimalPolicy) Set(val *MinimalPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableMinimalPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableMinimalPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMinimalPolicy(val *MinimalPolicy) *NullableMinimalPolicy {
	return &NullableMinimalPolicy{value: val, isSet: true}
}

func (v NullableMinimalPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMinimalPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
