...
func (o UnlinkPolicyResponse) MarshalJSON() ([]byte, error) {
...
type NullableUnlinkPolicyResponse struct {
	value *UnlinkPolicyResponse
	isSet bool
}

func (v NullableUnlinkPolicyResponse) Get() *UnlinkPolicyResponse {
	return v.value
}

func (v *NullableUnlinkPolicyResponse) Set(val *UnlinkPolicyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUnlinkPolicyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUnlinkPolicyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnlinkPolicyResponse(val *UnlinkPolicyResponse) *NullableUnlinkPolicyResponse {
	return &NullableUnlinkPolicyResponse{value: val, isSet: true}
}

func (v NullableUnlinkPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnlinkPolicyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
