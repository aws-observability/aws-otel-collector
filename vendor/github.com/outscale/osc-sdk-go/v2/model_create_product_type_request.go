...
func (o CreateProductTypeRequest) MarshalJSON() ([]byte, error) {
...
type NullableCreateProductTypeRequest struct {
	value *CreateProductTypeRequest
	isSet bool
}

func (v NullableCreateProductTypeRequest) Get() *CreateProductTypeRequest {
	return v.value
}

func (v *NullableCreateProductTypeRequest) Set(val *CreateProductTypeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateProductTypeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateProductTypeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateProductTypeRequest(val *CreateProductTypeRequest) *NullableCreateProductTypeRequest {
	return &NullableCreateProductTypeRequest{value: val, isSet: true}
}

func (v NullableCreateProductTypeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateProductTypeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
