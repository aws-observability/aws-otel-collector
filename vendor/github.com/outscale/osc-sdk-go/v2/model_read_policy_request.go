...
func (o ReadPolicyRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadPolicyRequest struct {
	value *ReadPolicyRequest
	isSet bool
}

func (v NullableReadPolicyRequest) Get() *ReadPolicyRequest {
	return v.value
}

func (v *NullableReadPolicyRequest) Set(val *ReadPolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadPolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadPolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadPolicyRequest(val *ReadPolicyRequest) *NullableReadPolicyRequest {
	return &NullableReadPolicyRequest{value: val, isSet: true}
}

func (v NullableReadPolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadPolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
