...
func (o DeletePolicyRequest) MarshalJSON() ([]byte, error) {
...
type NullableDeletePolicyRequest struct {
	value *DeletePolicyRequest
	isSet bool
}

func (v NullableDeletePolicyRequest) Get() *DeletePolicyRequest {
	return v.value
}

func (v *NullableDeletePolicyRequest) Set(val *DeletePolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeletePolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeletePolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeletePolicyRequest(val *DeletePolicyRequest) *NullableDeletePolicyRequest {
	return &NullableDeletePolicyRequest{value: val, isSet: true}
}

func (v NullableDeletePolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeletePolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
