...
type LinkManagedPolicyToUserGroupRequest struct {
...
func NewLinkManagedPolicyToUserGroupRequest(policyOrn string, userGroupName string) *LinkManagedPolicyToUserGroupRequest {
	this := LinkManagedPolicyToUserGroupRequest{}
...
func (o LinkManagedPolicyToUserGroupRequest) MarshalJSON() ([]byte, error) {
...
type NullableLinkManagedPolicyToUserGroupRequest struct {
	value *LinkManagedPolicyToUserGroupRequest
	isSet bool
}

func (v NullableLinkManagedPolicyToUserGroupRequest) Get() *LinkManagedPolicyToUserGroupRequest {
	return v.value
}

func (v *NullableLinkManagedPolicyToUserGroupRequest) Set(val *LinkManagedPolicyToUserGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkManagedPolicyToUserGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkManagedPolicyToUserGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkManagedPolicyToUserGroupRequest(val *LinkManagedPolicyToUserGroupRequest) *NullableLinkManagedPolicyToUserGroupRequest {
	return &NullableLinkManagedPolicyToUserGroupRequest{value: val, isSet: true}
}

func (v NullableLinkManagedPolicyToUserGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkManagedPolicyToUserGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
