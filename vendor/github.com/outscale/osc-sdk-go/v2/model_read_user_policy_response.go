...
// ReadUserPolicyResponse struct for ReadUserPolicyResponse
type ReadUserPolicyResponse struct {
...
func (o ReadUserPolicyResponse) MarshalJSON() ([]byte, error) {
...
type NullableReadUserPolicyResponse struct {
	value *ReadUserPolicyResponse
	isSet bool
}

func (v NullableReadUserPolicyResponse) Get() *ReadUserPolicyResponse {
	return v.value
}

func (v *NullableReadUserPolicyResponse) Set(val *ReadUserPolicyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReadUserPolicyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReadUserPolicyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadUserPolicyResponse(val *ReadUserPolicyResponse) *NullableReadUserPolicyResponse {
	return &NullableReadUserPolicyResponse{value: val, isSet: true}
}

func (v NullableReadUserPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadUserPolicyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
