...
type ScaleUpVmGroupResponse struct {
...
func (o ScaleUpVmGroupResponse) MarshalJSON() ([]byte, error) {
...
type NullableScaleUpVmGroupResponse struct {
	value *ScaleUpVmGroupResponse
	isSet bool
}

func (v NullableScaleUpVmGroupResponse) Get() *ScaleUpVmGroupResponse {
	return v.value
}

func (v *NullableScaleUpVmGroupResponse) Set(val *ScaleUpVmGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableScaleUpVmGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableScaleUpVmGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScaleUpVmGroupResponse(val *ScaleUpVmGroupResponse) *NullableScaleUpVmGroupResponse {
	return &NullableScaleUpVmGroupResponse{value: val, isSet: true}
}

func (v NullableScaleUpVmGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScaleUpVmGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
