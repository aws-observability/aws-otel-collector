...
type CreateVmTemplateResponse struct {
...
func (o CreateVmTemplateResponse) MarshalJSON() ([]byte, error) {
...
type NullableCreateVmTemplateResponse struct {
	value *CreateVmTemplateResponse
	isSet bool
}

func (v NullableCreateVmTemplateResponse) Get() *CreateVmTemplateResponse {
	return v.value
}

func (v *NullableCreateVmTemplateResponse) Set(val *CreateVmTemplateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateVmTemplateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateVmTemplateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateVmTemplateResponse(val *CreateVmTemplateResponse) *NullableCreateVmTemplateResponse {
	return &NullableCreateVmTemplateResponse{value: val, isSet: true}
}

func (v NullableCreateVmTemplateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateVmTemplateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
