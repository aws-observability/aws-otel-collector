...
func (o UnlinkPolicyRequest) MarshalJSON() ([]byte, error) {
...
type NullableUnlinkPolicyRequest struct {
	value *UnlinkPolicyRequest
	isSet bool
}

func (v NullableUnlinkPolicyRequest) Get() *UnlinkPolicyRequest {
	return v.value
}

func (v *NullableUnlinkPolicyRequest) Set(val *UnlinkPolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUnlinkPolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUnlinkPolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnlinkPolicyRequest(val *UnlinkPolicyRequest) *NullableUnlinkPolicyRequest {
	return &NullableUnlinkPolicyRequest{value: val, isSet: true}
}

func (v NullableUnlinkPolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnlinkPolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
