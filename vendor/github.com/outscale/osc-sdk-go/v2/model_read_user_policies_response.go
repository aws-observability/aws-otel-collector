...
// ReadUserPoliciesResponse struct for ReadUserPoliciesResponse
type ReadUserPoliciesResponse struct {
...
func (o ReadUserPoliciesResponse) MarshalJSON() ([]byte, error) {
...
type NullableReadUserPoliciesResponse struct {
	value *ReadUserPoliciesResponse
	isSet bool
}

func (v NullableReadUserPoliciesResponse) Get() *ReadUserPoliciesResponse {
	return v.value
}

func (v *NullableReadUserPoliciesResponse) Set(val *ReadUserPoliciesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReadUserPoliciesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReadUserPoliciesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadUserPoliciesResponse(val *ReadUserPoliciesResponse) *NullableReadUserPoliciesResponse {
	return &NullableReadUserPoliciesResponse{value: val, isSet: true}
}

func (v NullableReadUserPoliciesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadUserPoliciesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
