...
type ReadUnitPriceRequest struct {
...
func (o ReadUnitPriceRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadUnitPriceRequest struct {
	value *ReadUnitPriceRequest
	isSet bool
}

func (v NullableReadUnitPriceRequest) Get() *ReadUnitPriceRequest {
	return v.value
}

func (v *NullableReadUnitPriceRequest) Set(val *ReadUnitPriceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadUnitPriceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadUnitPriceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadUnitPriceRequest(val *ReadUnitPriceRequest) *NullableReadUnitPriceRequest {
	return &NullableReadUnitPriceRequest{value: val, isSet: true}
}

func (v NullableReadUnitPriceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadUnitPriceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
