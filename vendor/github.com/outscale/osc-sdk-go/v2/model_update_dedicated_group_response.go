...
type UpdateDedicatedGroupResponse struct {
...
func NewUpdateDedicatedGroupResponse() *UpdateDedicatedGroupResponse {
	this := UpdateDedicatedGroupResponse{}
	return &this
}
...
func (o UpdateDedicatedGroupResponse) MarshalJSON() ([]byte, error) {
...
type NullableUpdateDedicatedGroupResponse struct {
	value *UpdateDedicatedGroupResponse
	isSet bool
}

func (v NullableUpdateDedicatedGroupResponse) Get() *UpdateDedicatedGroupResponse {
	return v.value
}

func (v *NullableUpdateDedicatedGroupResponse) Set(val *UpdateDedicatedGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateDedicatedGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateDedicatedGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateDedicatedGroupResponse(val *UpdateDedicatedGroupResponse) *NullableUpdateDedicatedGroupResponse {
	return &NullableUpdateDedicatedGroupResponse{value: val, isSet: true}
}

func (v NullableUpdateDedicatedGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateDedicatedGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
