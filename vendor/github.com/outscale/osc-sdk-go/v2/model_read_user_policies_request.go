...
// ReadUserPoliciesRequest struct for ReadUserPoliciesRequest
type ReadUserPoliciesRequest struct {
...
func (o ReadUserPoliciesRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadUserPoliciesRequest struct {
	value *ReadUserPoliciesRequest
	isSet bool
}

func (v NullableReadUserPoliciesRequest) Get() *ReadUserPoliciesRequest {
	return v.value
}

func (v *NullableReadUserPoliciesRequest) Set(val *ReadUserPoliciesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadUserPoliciesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadUserPoliciesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadUserPoliciesRequest(val *ReadUserPoliciesRequest) *NullableReadUserPoliciesRequest {
	return &NullableReadUserPoliciesRequest{value: val, isSet: true}
}

func (v NullableReadUserPoliciesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadUserPoliciesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
