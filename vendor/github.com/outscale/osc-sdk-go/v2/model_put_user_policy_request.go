...
// PutUserPolicyRequest struct for PutUserPolicyRequest
...
func (o PutUserPolicyRequest) MarshalJSON() ([]byte, error) {
...
type NullablePutUserPolicyRequest struct {
	value *PutUserPolicyRequest
	isSet bool
}

func (v NullablePutUserPolicyRequest) Get() *PutUserPolicyRequest {
	return v.value
}

func (v *NullablePutUserPolicyRequest) Set(val *PutUserPolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutUserPolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutUserPolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutUserPolicyRequest(val *PutUserPolicyRequest) *NullablePutUserPolicyRequest {
	return &NullablePutUserPolicyRequest{value: val, isSet: true}
}

func (v NullablePutUserPolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutUserPolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
