...
func (o ReadUserGroupsRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadUserGroupsRequest struct {
	value *ReadUserGroupsRequest
	isSet bool
}

func (v NullableReadUserGroupsRequest) Get() *ReadUserGroupsRequest {
	return v.value
}

func (v *NullableReadUserGroupsRequest) Set(val *ReadUserGroupsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadUserGroupsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadUserGroupsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadUserGroupsRequest(val *ReadUserGroupsRequest) *NullableReadUserGroupsRequest {
	return &NullableReadUserGroupsRequest{value: val, isSet: true}
}

func (v NullableReadUserGroupsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadUserGroupsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
