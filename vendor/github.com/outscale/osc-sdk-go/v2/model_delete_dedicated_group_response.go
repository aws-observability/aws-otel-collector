...
type DeleteDedicatedGroupResponse struct {
...
func NewDeleteDedicatedGroupResponse() *DeleteDedicatedGroupResponse {
	this := DeleteDedicatedGroupResponse{}
	return &this
}
...
func (o DeleteDedicatedGroupResponse) MarshalJSON() ([]byte, error) {
...
type NullableDeleteDedicatedGroupResponse struct {
	value *DeleteDedicatedGroupResponse
	isSet bool
}

func (v NullableDeleteDedicatedGroupResponse) Get() *DeleteDedicatedGroupResponse {
	return v.value
}

func (v *NullableDeleteDedicatedGroupResponse) Set(val *DeleteDedicatedGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteDedicatedGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteDedicatedGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteDedicatedGroupResponse(val *DeleteDedicatedGroupResponse) *NullableDeleteDedicatedGroupResponse {
	return &NullableDeleteDedicatedGroupResponse{value: val, isSet: true}
}

func (v NullableDeleteDedicatedGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteDedicatedGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
