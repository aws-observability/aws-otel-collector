...
func NewUpdateRouteTableLinkRequest(linkRouteTableId string, routeTableId string) *UpdateRouteTableLinkRequest {
	this := UpdateRouteTableLinkRequest{}
...
func (o UpdateRouteTableLinkRequest) MarshalJSON() ([]byte, error) {
...
type NullableUpdateRouteTableLinkRequest struct {
	value *UpdateRouteTableLinkRequest
	isSet bool
}

func (v NullableUpdateRouteTableLinkRequest) Get() *UpdateRouteTableLinkRequest {
	return v.value
}

func (v *NullableUpdateRouteTableLinkRequest) Set(val *UpdateRouteTableLinkRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateRouteTableLinkRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateRouteTableLinkRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateRouteTableLinkRequest(val *UpdateRouteTableLinkRequest) *NullableUpdateRouteTableLinkRequest {
	return &NullableUpdateRouteTableLinkRequest{value: val, isSet: true}
}

func (v NullableUpdateRouteTableLinkRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateRouteTableLinkRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
