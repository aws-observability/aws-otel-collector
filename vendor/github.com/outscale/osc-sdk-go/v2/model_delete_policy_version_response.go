...
func NewDeletePolicyVersionResponse() *DeletePolicyVersionResponse {
	this := DeletePolicyVersionResponse{}
	return &this
}
...
func (o DeletePolicyVersionResponse) MarshalJSON() ([]byte, error) {
...
type NullableDeletePolicyVersionResponse struct {
	value *DeletePolicyVersionResponse
	isSet bool
}

func (v NullableDeletePolicyVersionResponse) Get() *DeletePolicyVersionResponse {
	return v.value
}

func (v *NullableDeletePolicyVersionResponse) Set(val *DeletePolicyVersionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDeletePolicyVersionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDeletePolicyVersionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeletePolicyVersionResponse(val *DeletePolicyVersionResponse) *NullableDeletePolicyVersionResponse {
	return &NullableDeletePolicyVersionResponse{value: val, isSet: true}
}

func (v NullableDeletePolicyVersionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeletePolicyVersionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
