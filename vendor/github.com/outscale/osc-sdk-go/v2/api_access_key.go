...
/*
  ...
  - Creates an access key for either the root user or an EIM user. The new key is automatically set to `ACTIVE`.<br /><br />
...
/*
  ...
  - Deletes the specified access key of either the root user or an EIM user.<br /><br />
...
/*
  ...
  - Modifies the attributes of the specified access key of either the root user or an EIM user.<br /><br />
