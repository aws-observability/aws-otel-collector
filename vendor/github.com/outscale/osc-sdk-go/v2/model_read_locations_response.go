...
func (o *ReadLocationsResponse) GetNextPageToken() string {
...
// and a boolean to check if the value has been set.
func (o *ReadLocationsResponse) GetNextPageTokenOk() (*string, bool) {
	if o == nil || o.NextPageToken == nil {
		return nil, false
	}
...
func (o *ReadLocationsResponse) HasNextPageToken() bool {
	if o != nil && o.NextPageToken != nil {
		return true
	}
...
func (o *ReadLocationsResponse) SetNextPageToken(v string) {
	o.NextPageToken = &v
}
