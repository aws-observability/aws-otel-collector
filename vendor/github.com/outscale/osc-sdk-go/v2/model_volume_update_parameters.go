...
type VolumeUpdateParameters struct {
	// The new number of I/O operations per second (IOPS):<br /> - For `io1` volumes, the number of provisioned IOPS.<br /> - For `gp2` volumes, the baseline performance of the volume.
	Iops NullableInt32 `json:"Iops"`
...
func (o VolumeUpdateParameters) MarshalJSON() ([]byte, error) {
...
type NullableVolumeUpdateParameters struct {
	value *VolumeUpdateParameters
	isSet bool
}

func (v NullableVolumeUpdateParameters) Get() *VolumeUpdateParameters {
	return v.value
}

func (v *NullableVolumeUpdateParameters) Set(val *VolumeUpdateParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeUpdateParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeUpdateParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeUpdateParameters(val *VolumeUpdateParameters) *NullableVolumeUpdateParameters {
	return &NullableVolumeUpdateParameters{value: val, isSet: true}
}

func (v NullableVolumeUpdateParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeUpdateParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
