...
type PutUserGroupPolicyRequest struct {
...
func NewPutUserGroupPolicyRequest(policyDocument string, policyName string, userGroupName string) *PutUserGroupPolicyRequest {
	this := PutUserGroupPolicyRequest{}
...
func (o PutUserGroupPolicyRequest) MarshalJSON() ([]byte, error) {
...
type NullablePutUserGroupPolicyRequest struct {
	value *PutUserGroupPolicyRequest
	isSet bool
}

func (v NullablePutUserGroupPolicyRequest) Get() *PutUserGroupPolicyRequest {
	return v.value
}

func (v *NullablePutUserGroupPolicyRequest) Set(val *PutUserGroupPolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutUserGroupPolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutUserGroupPolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutUserGroupPolicyRequest(val *PutUserGroupPolicyRequest) *NullablePutUserGroupPolicyRequest {
	return &NullablePutUserGroupPolicyRequest{value: val, isSet: true}
}

func (v NullablePutUserGroupPolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutUserGroupPolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
