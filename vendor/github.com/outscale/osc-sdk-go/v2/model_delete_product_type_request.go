...
func (o DeleteProductTypeRequest) MarshalJSON() ([]byte, error) {
...
type NullableDeleteProductTypeRequest struct {
	value *DeleteProductTypeRequest
	isSet bool
}

func (v NullableDeleteProductTypeRequest) Get() *DeleteProductTypeRequest {
	return v.value
}

func (v *NullableDeleteProductTypeRequest) Set(val *DeleteProductTypeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteProductTypeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteProductTypeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteProductTypeRequest(val *DeleteProductTypeRequest) *NullableDeleteProductTypeRequest {
	return &NullableDeleteProductTypeRequest{value: val, isSet: true}
}

func (v NullableDeleteProductTypeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteProductTypeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
