...
type DeleteUserGroupPolicyRequest struct {
...
func NewDeleteUserGroupPolicyRequest(policyName string, userGroupName string) *DeleteUserGroupPolicyRequest {
	this := DeleteUserGroupPolicyRequest{}
...
func (o DeleteUserGroupPolicyRequest) MarshalJSON() ([]byte, error) {
...
type NullableDeleteUserGroupPolicyRequest struct {
	value *DeleteUserGroupPolicyRequest
	isSet bool
}

func (v NullableDeleteUserGroupPolicyRequest) Get() *DeleteUserGroupPolicyRequest {
	return v.value
}

func (v *NullableDeleteUserGroupPolicyRequest) Set(val *DeleteUserGroupPolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteUserGroupPolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteUserGroupPolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteUserGroupPolicyRequest(val *DeleteUserGroupPolicyRequest) *NullableDeleteUserGroupPolicyRequest {
	return &NullableDeleteUserGroupPolicyRequest{value: val, isSet: true}
}

func (v NullableDeleteUserGroupPolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteUserGroupPolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
