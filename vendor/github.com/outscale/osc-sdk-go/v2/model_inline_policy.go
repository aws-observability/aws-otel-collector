...
func (o InlinePolicy) MarshalJSON() ([]byte, error) {
...
type NullableInlinePolicy struct {
	value *InlinePolicy
	isSet bool
}

func (v NullableInlinePolicy) Get() *InlinePolicy {
	return v.value
}

func (v *NullableInlinePolicy) Set(val *InlinePolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableInlinePolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableInlinePolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlinePolicy(val *InlinePolicy) *NullableInlinePolicy {
	return &NullableInlinePolicy{value: val, isSet: true}
}

func (v NullableInlinePolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlinePolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
