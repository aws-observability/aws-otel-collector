...
type ReadManagedPoliciesLinkedToUserGroupRequest struct {
...
func NewReadManagedPoliciesLinkedToUserGroupRequest(userGroupName string) *ReadManagedPoliciesLinkedToUserGroupRequest {
	this := ReadManagedPoliciesLinkedToUserGroupRequest{}
...
// SetFilters gets a reference to the given FiltersUserGroup and assigns it to the Filters field.
...
func (o ReadManagedPoliciesLinkedToUserGroupRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadManagedPoliciesLinkedToUserGroupRequest struct {
	value *ReadManagedPoliciesLinkedToUserGroupRequest
	isSet bool
}

func (v NullableReadManagedPoliciesLinkedToUserGroupRequest) Get() *ReadManagedPoliciesLinkedToUserGroupRequest {
	return v.value
}

func (v *NullableReadManagedPoliciesLinkedToUserGroupRequest) Set(val *ReadManagedPoliciesLinkedToUserGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadManagedPoliciesLinkedToUserGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadManagedPoliciesLinkedToUserGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadManagedPoliciesLinkedToUserGroupRequest(val *ReadManagedPoliciesLinkedToUserGroupRequest) *NullableReadManagedPoliciesLinkedToUserGroupRequest {
	return &NullableReadManagedPoliciesLinkedToUserGroupRequest{value: val, isSet: true}
}

func (v NullableReadManagedPoliciesLinkedToUserGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadManagedPoliciesLinkedToUserGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
