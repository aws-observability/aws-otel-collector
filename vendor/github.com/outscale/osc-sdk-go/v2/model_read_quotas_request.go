...
func (o *ReadQuotasRequest) GetNextPageToken() string {
...
// and a boolean to check if the value has been set.
func (o *ReadQuotasRequest) GetNextPageTokenOk() (*string, bool) {
	if o == nil || o.NextPageToken == nil {
		return nil, false
	}
...
func (o *ReadQuotasRequest) HasNextPageToken() bool {
	if o != nil && o.NextPageToken != nil {
		return true
	}
...
func (o *ReadQuotasRequest) SetNextPageToken(v string) {
	o.NextPageToken = &v
}

// GetResultsPerPage returns the ResultsPerPage field value if set, zero value otherwise.
func (o *ReadQuotasRequest) GetResultsPerPage() int32 {
...
// and a boolean to check if the value has been set.
func (o *ReadQuotasRequest) GetResultsPerPageOk() (*int32, bool) {
	if o == nil || o.ResultsPerPage == nil {
		return nil, false
	}
...
func (o *ReadQuotasRequest) HasResultsPerPage() bool {
	if o != nil && o.ResultsPerPage != nil {
		return true
	}
...
func (o *ReadQuotasRequest) SetResultsPerPage(v int32) {
	o.ResultsPerPage = &v
}
