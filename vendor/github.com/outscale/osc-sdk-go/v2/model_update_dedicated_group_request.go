...
type UpdateDedicatedGroupRequest struct {
...
func NewUpdateDedicatedGroupRequest(dedicatedGroupId string, name string) *UpdateDedicatedGroupRequest {
	this := UpdateDedicatedGroupRequest{}
...
func (o UpdateDedicatedGroupRequest) MarshalJSON() ([]byte, error) {
...
type NullableUpdateDedicatedGroupRequest struct {
	value *UpdateDedicatedGroupRequest
	isSet bool
}

func (v NullableUpdateDedicatedGroupRequest) Get() *UpdateDedicatedGroupRequest {
	return v.value
}

func (v *NullableUpdateDedicatedGroupRequest) Set(val *UpdateDedicatedGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateDedicatedGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateDedicatedGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateDedicatedGroupRequest(val *UpdateDedicatedGroupRequest) *NullableUpdateDedicatedGroupRequest {
	return &NullableUpdateDedicatedGroupRequest{value: val, isSet: true}
}

func (v NullableUpdateDedicatedGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateDedicatedGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
