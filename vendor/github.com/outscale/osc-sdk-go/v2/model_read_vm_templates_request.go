...
type ReadVmTemplatesRequest struct {
	// If true, checks whether you have the required permissions to perform the action.
	DryRun  *bool              `json:"DryRun,omitempty"`
	Filters *FiltersVmTemplate `json:"Filters,omitempty"`
}
...
// SetFilters gets a reference to the given FiltersVmTemplate and assigns it to the Filters field.
func (o *ReadVmTemplatesRequest) SetFilters(v FiltersVmTemplate) {
	o.Filters = &v
}

func (o ReadVmTemplatesRequest) MarshalJSON() ([]byte, error) {
...
type NullableReadVmTemplatesRequest struct {
	value *ReadVmTemplatesRequest
	isSet bool
}

func (v NullableReadVmTemplatesRequest) Get() *ReadVmTemplatesRequest {
	return v.value
}

func (v *NullableReadVmTemplatesRequest) Set(val *ReadVmTemplatesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReadVmTemplatesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReadVmTemplatesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadVmTemplatesRequest(val *ReadVmTemplatesRequest) *NullableReadVmTemplatesRequest {
	return &NullableReadVmTemplatesRequest{value: val, isSet: true}
}

func (v NullableReadVmTemplatesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadVmTemplatesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
