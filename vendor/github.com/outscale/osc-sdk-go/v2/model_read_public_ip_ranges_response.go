...
func (o *ReadPublicIpRangesResponse) GetNextPageToken() string {
...
func (o *ReadPublicIpRangesResponse) GetNextPageTokenOk() (*string, bool) {
	if o == nil || o.NextPageToken == nil {
		return nil, false
	}
...
func (o *ReadPublicIpRangesResponse) HasNextPageToken() bool {
	if o != nil && o.NextPageToken != nil {
		return true
	}
...
func (o *ReadPublicIpRangesResponse) SetNextPageToken(v string) {
	o.NextPageToken = &v
}
