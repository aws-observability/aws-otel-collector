...
func (o *ReadSecurityGroupsRequest) GetNextPageToken() string {
...
// and a boolean to check if the value has been set.
func (o *ReadSecurityGroupsRequest) GetNextPageTokenOk() (*string, bool) {
	if o == nil || o.NextPageToken == nil {
		return nil, false
	}
...
func (o *ReadSecurityGroupsRequest) HasNextPageToken() bool {
	if o != nil && o.NextPageToken != nil {
		return true
	}
...
func (o *ReadSecurityGroupsRequest) SetNextPageToken(v string) {
	o.NextPageToken = &v
}

// GetResultsPerPage returns the ResultsPerPage field value if set, zero value otherwise.
func (o *ReadSecurityGroupsRequest) GetResultsPerPage() int32 {
...
// and a boolean to check if the value has been set.
func (o *ReadSecurityGroupsRequest) GetResultsPerPageOk() (*int32, bool) {
	if o == nil || o.ResultsPerPage == nil {
		return nil, false
	}
...
func (o *ReadSecurityGroupsRequest) HasResultsPerPage() bool {
	if o != nil && o.ResultsPerPage != nil {
		return true
	}
...
func (o *ReadSecurityGroupsRequest) SetResultsPerPage(v int32) {
	o.ResultsPerPage = &v
}
