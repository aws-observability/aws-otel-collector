...
func NewSetDefaultPolicyVersionRequest(policyOrn string, versionId string) *SetDefaultPolicyVersionRequest {
	this := SetDefaultPolicyVersionRequest{}
...
func (o SetDefaultPolicyVersionRequest) MarshalJSON() ([]byte, error) {
...
type NullableSetDefaultPolicyVersionRequest struct {
	value *SetDefaultPolicyVersionRequest
	isSet bool
}

func (v NullableSetDefaultPolicyVersionRequest) Get() *SetDefaultPolicyVersionRequest {
	return v.value
}

func (v *NullableSetDefaultPolicyVersionRequest) Set(val *SetDefaultPolicyVersionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSetDefaultPolicyVersionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSetDefaultPolicyVersionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetDefaultPolicyVersionRequest(val *SetDefaultPolicyVersionRequest) *NullableSetDefaultPolicyVersionRequest {
	return &NullableSetDefaultPolicyVersionRequest{value: val, isSet: true}
}

func (v NullableSetDefaultPolicyVersionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetDefaultPolicyVersionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
