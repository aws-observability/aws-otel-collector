...
// StatusPageAsIncludedAttributesComponentsItems A component displayed on an included status page.
...
func (o *StatusPageAsIncludedAttributesComponentsItems) GetId() uuid.UUID {
	if o == nil || o.Id == nil {
		var ret uuid.UUID
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *StatusPageAsIncludedAttributesComponentsItems) GetIdOk() (*uuid.UUID, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return o.Id, true
...
func (o *StatusPageAsIncludedAttributesComponentsItems) SetId(v uuid.UUID) {
	o.Id = &v
}
