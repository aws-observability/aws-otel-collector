...
// NewLLMObsPatternsConfigItem instantiates a new LLMObsPatternsConfigItem object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewLLMObsPatternsConfigItem(createdAt time.Time, evpQuery string, hierarchyDepth int32, id string, name string, numRecords int32, samplingRatio float64, scope string, updatedAt time.Time) *LLMObsPatternsConfigItem {
	this := LLMObsPatternsConfigItem{}
...
// NewLLMObsPatternsConfigItemWithDefaults instantiates a new LLMObsPatternsConfigItem object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewLLMObsPatternsConfigItemWithDefaults() *LLMObsPatternsConfigItem {
	this := LLMObsPatternsConfigItem{}
	return &this
}

// GetAccountId returns the AccountId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *LLMObsPatternsConfigItem) GetAccountId() string {
...
func (o *LLMObsPatternsConfigItem) GetAccountIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsConfigItem) HasAccountId() bool {
...
func (o *LLMObsPatternsConfigItem) SetAccountId(v string) {
	o.AccountId.Set(&v)
}

// SetAccountIdNil sets the value for AccountId to be an explicit nil.
func (o *LLMObsPatternsConfigItem) SetAccountIdNil() {
	o.AccountId.Set(nil)
}

// UnsetAccountId ensures that no value is present for AccountId, not even an explicit nil.
func (o *LLMObsPatternsConfigItem) UnsetAccountId() {
	o.AccountId.Unset()
}

// GetCreatedAt returns the CreatedAt field value.
func (o *LLMObsPatternsConfigItem) GetCreatedAt() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LLMObsPatternsConfigItem) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsConfigItem) GetEvpQuery() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LLMObsPatternsConfigItem) GetEvpQueryOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsConfigItem) SetEvpQuery(v string) {
	o.EvpQuery = v
}

// GetHierarchyDepth returns the HierarchyDepth field value.
func (o *LLMObsPatternsConfigItem) GetHierarchyDepth() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LLMObsPatternsConfigItem) GetHierarchyDepthOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsConfigItem) SetHierarchyDepth(v int32) {
	o.HierarchyDepth = v
}

// GetId returns the Id field value.
func (o *LLMObsPatternsConfigItem) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LLMObsPatternsConfigItem) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *LLMObsPatternsConfigItem) SetId(v string) {
	o.Id = v
}
...
func (o *LLMObsPatternsConfigItem) GetIntegrationProvider() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *LLMObsPatternsConfigItem) GetIntegrationProviderOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsConfigItem) HasIntegrationProvider() bool {
...
func (o *LLMObsPatternsConfigItem) SetIntegrationProvider(v string) {
	o.IntegrationProvider.Set(&v)
}

// SetIntegrationProviderNil sets the value for IntegrationProvider to be an explicit nil.
func (o *LLMObsPatternsConfigItem) SetIntegrationProviderNil() {
...
func (o *LLMObsPatternsConfigItem) UnsetIntegrationProvider() {
...
func (o *LLMObsPatternsConfigItem) GetModelName() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *LLMObsPatternsConfigItem) GetModelNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsConfigItem) HasModelName() bool {
...
func (o *LLMObsPatternsConfigItem) SetModelName(v string) {
	o.ModelName.Set(&v)
}

// SetModelNameNil sets the value for ModelName to be an explicit nil.
func (o *LLMObsPatternsConfigItem) SetModelNameNil() {
	o.ModelName.Set(nil)
}

// UnsetModelName ensures that no value is present for ModelName, not even an explicit nil.
func (o *LLMObsPatternsConfigItem) UnsetModelName() {
	o.ModelName.Unset()
}

// GetName returns the Name field value.
func (o *LLMObsPatternsConfigItem) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LLMObsPatternsConfigItem) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *LLMObsPatternsConfigItem) SetName(v string) {
	o.Name = v
}

// GetNumRecords returns the NumRecords field value.
func (o *LLMObsPatternsConfigItem) GetNumRecords() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LLMObsPatternsConfigItem) GetNumRecordsOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsConfigItem) SetNumRecords(v int32) {
	o.NumRecords = v
}

// GetSamplingRatio returns the SamplingRatio field value.
func (o *LLMObsPatternsConfigItem) GetSamplingRatio() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LLMObsPatternsConfigItem) GetSamplingRatioOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsConfigItem) SetSamplingRatio(v float64) {
	o.SamplingRatio = v
}

// GetScope returns the Scope field value.
func (o *LLMObsPatternsConfigItem) GetScope() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LLMObsPatternsConfigItem) GetScopeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Scope, true
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *LLMObsPatternsConfigItem) GetTemplateOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsConfigItem) HasTemplate() bool {
...
func (o *LLMObsPatternsConfigItem) SetTemplate(v string) {
	o.Template.Set(&v)
}

// SetTemplateNil sets the value for Template to be an explicit nil.
func (o *LLMObsPatternsConfigItem) SetTemplateNil() {
	o.Template.Set(nil)
}

// UnsetTemplate ensures that no value is present for Template, not even an explicit nil.
func (o *LLMObsPatternsConfigItem) UnsetTemplate() {
	o.Template.Unset()
}

// GetUpdatedAt returns the UpdatedAt field value.
func (o *LLMObsPatternsConfigItem) GetUpdatedAt() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LLMObsPatternsConfigItem) GetUpdatedAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsConfigItem) SetUpdatedAt(v time.Time) {
	o.UpdatedAt = v
}

// MarshalJSON serializes the struct using spec logic.
func (o LLMObsPatternsConfigItem) MarshalJSON() ([]byte, error) {
...
func (o *LLMObsPatternsConfigItem) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		AccountId           datadog.NullableString `json:"account_id,omitempty"`
		CreatedAt           *time.Time             `json:"created_at"`
		EvpQuery            *string                `json:"evp_query"`
