...
// AWSEventBridgeDeleteResponse Amazon EventBridge delete response body.
type AWSEventBridgeDeleteResponse struct {
	// Amazon EventBridge delete response data.
	Data AWSEventBridgeDeleteResponseData `json:"data"`
...
func NewAWSEventBridgeDeleteResponse(data AWSEventBridgeDeleteResponseData) *AWSEventBridgeDeleteResponse {
...
func (o *AWSEventBridgeDeleteResponse) GetData() AWSEventBridgeDeleteResponseData {
	if o == nil {
		var ret AWSEventBridgeDeleteResponseData
		return ret
	}
	return o.Data
}
...
func (o *AWSEventBridgeDeleteResponse) GetDataOk() (*AWSEventBridgeDeleteResponseData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *AWSEventBridgeDeleteResponse) SetData(v AWSEventBridgeDeleteResponseData) {
	o.Data = v
}
