...
type LLMObsPatternsTopicsResponseAttributes struct {
	...
	Topics []LLMObsPatternsTopic `json:"topics"`
	// UnparsedObject contains the raw value of the object if there was an error when deserializing into the struct
	UnparsedObject       map[string]interface{} `json:"-"`
	AdditionalProperties map[string]interface{} `json:"-"`
}

// NewLLMObsPatternsTopicsResponseAttributes instantiates a new LLMObsPatternsTopicsResponseAttributes object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewLLMObsPatternsTopicsResponseAttributes(configId string, createdAt time.Time, previousRunId string, runId string, topics []LLMObsPatternsTopic) *LLMObsPatternsTopicsResponseAttributes {
	this := LLMObsPatternsTopicsResponseAttributes{}
...
// NewLLMObsPatternsTopicsResponseAttributesWithDefaults instantiates a new LLMObsPatternsTopicsResponseAttributes object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewLLMObsPatternsTopicsResponseAttributesWithDefaults() *LLMObsPatternsTopicsResponseAttributes {
	this := LLMObsPatternsTopicsResponseAttributes{}
	return &this
}

// GetCompletedAt returns the CompletedAt field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *LLMObsPatternsTopicsResponseAttributes) GetCompletedAt() time.Time {
...
func (o *LLMObsPatternsTopicsResponseAttributes) GetCompletedAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsTopicsResponseAttributes) HasCompletedAt() bool {
...
func (o *LLMObsPatternsTopicsResponseAttributes) SetCompletedAt(v time.Time) {
	o.CompletedAt.Set(&v)
}

// SetCompletedAtNil sets the value for CompletedAt to be an explicit nil.
func (o *LLMObsPatternsTopicsResponseAttributes) SetCompletedAtNil() {
	o.CompletedAt.Set(nil)
}

// UnsetCompletedAt ensures that no value is present for CompletedAt, not even an explicit nil.
func (o *LLMObsPatternsTopicsResponseAttributes) UnsetCompletedAt() {
	o.CompletedAt.Unset()
}

// GetConfigId returns the ConfigId field value.
func (o *LLMObsPatternsTopicsResponseAttributes) GetConfigId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LLMObsPatternsTopicsResponseAttributes) GetConfigIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsTopicsResponseAttributes) SetConfigId(v string) {
	o.ConfigId = v
}

// GetConfigSnapshot returns the ConfigSnapshot field value if set, zero value otherwise.
func (o *LLMObsPatternsTopicsResponseAttributes) GetConfigSnapshot() LLMObsPatternsConfigSnapshot {
...
// and a boolean to check if the value has been set.
func (o *LLMObsPatternsTopicsResponseAttributes) GetConfigSnapshotOk() (*LLMObsPatternsConfigSnapshot, bool) {
	if o == nil || o.ConfigSnapshot == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsTopicsResponseAttributes) HasConfigSnapshot() bool {
...
func (o *LLMObsPatternsTopicsResponseAttributes) SetConfigSnapshot(v LLMObsPatternsConfigSnapshot) {
	o.ConfigSnapshot = &v
}

// GetCreatedAt returns the CreatedAt field value.
func (o *LLMObsPatternsTopicsResponseAttributes) GetCreatedAt() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LLMObsPatternsTopicsResponseAttributes) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsTopicsResponseAttributes) SetCreatedAt(v time.Time) {
	o.CreatedAt = v
}

// GetPreviousRunId returns the PreviousRunId field value.
func (o *LLMObsPatternsTopicsResponseAttributes) GetPreviousRunId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LLMObsPatternsTopicsResponseAttributes) GetPreviousRunIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsTopicsResponseAttributes) SetPreviousRunId(v string) {
	o.PreviousRunId = v
}

// GetRunId returns the RunId field value.
func (o *LLMObsPatternsTopicsResponseAttributes) GetRunId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LLMObsPatternsTopicsResponseAttributes) GetRunIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.RunId, true
...
func (o *LLMObsPatternsTopicsResponseAttributes) SetRunId(v string) {
	o.RunId = v
}

// GetTopics returns the Topics field value.
func (o *LLMObsPatternsTopicsResponseAttributes) GetTopics() []LLMObsPatternsTopic {
	if o == nil {
		var ret []LLMObsPatternsTopic
		return ret
	}
	return o.Topics
}
...
// and a boolean to check if the value has been set.
func (o *LLMObsPatternsTopicsResponseAttributes) GetTopicsOk() (*[]LLMObsPatternsTopic, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LLMObsPatternsTopicsResponseAttributes) SetTopics(v []LLMObsPatternsTopic) {
	o.Topics = v
}

// MarshalJSON serializes the struct using spec logic.
func (o LLMObsPatternsTopicsResponseAttributes) MarshalJSON() ([]byte, error) {
...
func (o *LLMObsPatternsTopicsResponseAttributes) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		CompletedAt    datadog.NullableTime          `json:"completed_at,omitempty"`
		ConfigId       *string                       `json:"config_id"`
		ConfigSnapshot *LLMObsPatternsConfigSnapshot `json:"config_snapshot,omitempty"`
