...
// NewGetFindingResponse instantiates a new GetFindingResponse object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewGetFindingResponse(data DetailedFinding) *GetFindingResponse {
	this := GetFindingResponse{}
	this.Data = data
	return &this
}

// NewGetFindingResponseWithDefaults instantiates a new GetFindingResponse object.
