...
func (o *MaintenanceWindowResponse) GetData() MaintenanceWindow {
	if o == nil {
...
func (o *MaintenanceWindowResponse) GetDataOk() (*MaintenanceWindow, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *MaintenanceWindowResponse) SetData(v MaintenanceWindow) {
	o.Data = v
}
...
func (o *MaintenanceWindowResponse) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *MaintenanceWindow `json:"data"`
	}{}
