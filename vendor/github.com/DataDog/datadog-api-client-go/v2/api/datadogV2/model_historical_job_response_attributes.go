...
// and a boolean to check if the value has been set.
func (o *HistoricalJobResponseAttributes) GetSignalOutputOk() (*bool, bool) {
	if o == nil || o.SignalOutput == nil {
		return nil, false
	}
...
func (o *HistoricalJobResponseAttributes) HasSignalOutput() bool {
...
func (o *HistoricalJobResponseAttributes) SetSignalOutput(v bool) {
	o.SignalOutput = &v
}
