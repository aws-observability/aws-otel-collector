...
var allowedObservabilityPipelineNewRelicDestinationTypeEnumValues = []ObservabilityPipelineNewRelicDestinationType{
	OBSERVABILITYPIPELINENEWRELICDESTINATIONTYPE_NEW_RELIC,
}
...
func (v *ObservabilityPipelineNewRelicDestinationType) GetAllowedValues() []ObservabilityPipelineNewRelicDestinationType {
	return allowedObservabilityPipelineNewRelicDestinationTypeEnumValues
}
...
func (v *ObservabilityPipelineNewRelicDestinationType) UnmarshalJSON(src []byte) error {
	...
	*v = ObservabilityPipelineNewRelicDestinationType(value)
	return nil
}

// NewObservabilityPipelineNewRelicDestinationTypeFromValue returns a pointer to a valid ObservabilityPipelineNewRelicDestinationType
...
func NewObservabilityPipelineNewRelicDestinationTypeFromValue(v string) (*ObservabilityPipelineNewRelicDestinationType, error) {
	ev := ObservabilityPipelineNewRelicDestinationType(v)
	if ev.IsValid() {
		return &ev, nil
	}
	return nil, fmt.Errorf("invalid value '%v' for ObservabilityPipelineNewRelicDestinationType: valid values are %v", v, allowedObservabilityPipelineNewRelicDestinationTypeEnumValues)
}

// IsValid return true if the value is valid for the enum, false otherwise.
func (v ObservabilityPipelineNewRelicDestinationType) IsValid() bool {
	for _, existing := range allowedObservabilityPipelineNewRelicDestinationTypeEnumValues {
		if existing == v {
			return true
		}
	}
