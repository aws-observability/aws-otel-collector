...
// UpdateLoginOrgConfigsMaxSessionDuration Update the maximum session duration.
// Update the maximum session duration for the current organization.
// The duration is specified in seconds.
func (a *OrganizationsApi) UpdateLoginOrgConfigsMaxSessionDuration(ctx _context.Context, body MaxSessionDurationUpdateRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPut
		localVarPostBody   interface{}
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.OrganizationsApi.UpdateLoginOrgConfigsMaxSessionDuration")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/login/org_configs/max_session_duration"
