...
// NewObservabilityPipelineRsyslogDestination instantiates a new ObservabilityPipelineRsyslogDestination object.
...
func NewObservabilityPipelineRsyslogDestination(id string, inputs []string, typeVar ObservabilityPipelineRsyslogDestinationType) *ObservabilityPipelineRsyslogDestination {
	this := ObservabilityPipelineRsyslogDestination{}
	this.Id = id
	this.Inputs = inputs
	this.Type = typeVar
	return &this
...
// NewObservabilityPipelineRsyslogDestinationWithDefaults instantiates a new ObservabilityPipelineRsyslogDestination object.
...
func NewObservabilityPipelineRsyslogDestinationWithDefaults() *ObservabilityPipelineRsyslogDestination {
	this := ObservabilityPipelineRsyslogDestination{}
	var typeVar ObservabilityPipelineRsyslogDestinationType = OBSERVABILITYPIPELINERSYSLOGDESTINATIONTYPE_RSYSLOG
	this.Type = typeVar
	return &this
}

// GetBuffer returns the Buffer field value if set, zero value otherwise.
func (o *ObservabilityPipelineRsyslogDestination) GetBuffer() ObservabilityPipelineBufferOptions {
...
func (o *ObservabilityPipelineRsyslogDestination) GetBufferOk() (*ObservabilityPipelineBufferOptions, bool) {
	if o == nil || o.Buffer == nil {
		return nil, false
	}
...
func (o *ObservabilityPipelineRsyslogDestination) HasBuffer() bool {
...
func (o *ObservabilityPipelineRsyslogDestination) SetBuffer(v ObservabilityPipelineBufferOptions) {
	o.Buffer = &v
}

// GetEndpointUrlKey returns the EndpointUrlKey field value if set, zero value otherwise.
func (o *ObservabilityPipelineRsyslogDestination) GetEndpointUrlKey() string {
...
// and a boolean to check if the value has been set.
func (o *ObservabilityPipelineRsyslogDestination) GetEndpointUrlKeyOk() (*string, bool) {
	if o == nil || o.EndpointUrlKey == nil {
		return nil, false
	}
...
func (o *ObservabilityPipelineRsyslogDestination) HasEndpointUrlKey() bool {
...
func (o *ObservabilityPipelineRsyslogDestination) SetEndpointUrlKey(v string) {
	o.EndpointUrlKey = &v
}
...
func (o *ObservabilityPipelineRsyslogDestination) GetType() ObservabilityPipelineRsyslogDestinationType {
	if o == nil {
		var ret ObservabilityPipelineRsyslogDestinationType
		return ret
	}
	return o.Type
}
