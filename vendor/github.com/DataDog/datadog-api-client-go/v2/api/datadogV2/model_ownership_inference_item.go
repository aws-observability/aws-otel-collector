...
// OwnershipInferenceItem A single ownership inference, scoped to a specific owner type.
type OwnershipInferenceItem struct {
...
// NewOwnershipInferenceItem instantiates a new OwnershipInferenceItem object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewOwnershipInferenceItem(checksum string, confidence string, createdAt time.Time, evidenceVersions datadog.NullableList[map[string]interface{}], explanation string, id string, ownerType OwnershipOwnerType, sources []map[string]interface{}, status OwnershipInferenceStatus, updatedAt time.Time) *OwnershipInferenceItem {
	this := OwnershipInferenceItem{}
...
// NewOwnershipInferenceItemWithDefaults instantiates a new OwnershipInferenceItem object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewOwnershipInferenceItemWithDefaults() *OwnershipInferenceItem {
	this := OwnershipInferenceItem{}
	return &this
}

// GetChecksum returns the Checksum field value.
func (o *OwnershipInferenceItem) GetChecksum() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *OwnershipInferenceItem) GetChecksumOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OwnershipInferenceItem) SetChecksum(v string) {
	o.Checksum = v
}

// GetConfidence returns the Confidence field value.
func (o *OwnershipInferenceItem) GetConfidence() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OwnershipInferenceItem) GetConfidenceOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OwnershipInferenceItem) SetConfidence(v string) {
	o.Confidence = v
}

// GetCreatedAt returns the CreatedAt field value.
func (o *OwnershipInferenceItem) GetCreatedAt() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OwnershipInferenceItem) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OwnershipInferenceItem) SetCreatedAt(v time.Time) {
	o.CreatedAt = v
}
...
func (o *OwnershipInferenceItem) GetEvidenceVersionsOk() (*[]map[string]interface{}, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OwnershipInferenceItem) SetEvidenceVersions(v []map[string]interface{}) {
	o.EvidenceVersions.Set(&v)
}

// GetExplanation returns the Explanation field value.
func (o *OwnershipInferenceItem) GetExplanation() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OwnershipInferenceItem) GetExplanationOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OwnershipInferenceItem) SetExplanation(v string) {
	o.Explanation = v
}

// GetId returns the Id field value.
func (o *OwnershipInferenceItem) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OwnershipInferenceItem) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *OwnershipInferenceItem) SetId(v string) {
	o.Id = v
}

// GetOwnerType returns the OwnerType field value.
func (o *OwnershipInferenceItem) GetOwnerType() OwnershipOwnerType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OwnershipInferenceItem) GetOwnerTypeOk() (*OwnershipOwnerType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OwnershipInferenceItem) SetOwnerType(v OwnershipOwnerType) {
	o.OwnerType = v
}
...
func (o *OwnershipInferenceItem) GetPrimaryContactRef() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *OwnershipInferenceItem) GetPrimaryContactRefOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OwnershipInferenceItem) HasPrimaryContactRef() bool {
...
func (o *OwnershipInferenceItem) SetPrimaryContactRef(v string) {
	o.PrimaryContactRef.Set(&v)
}

// SetPrimaryContactRefNil sets the value for PrimaryContactRef to be an explicit nil.
func (o *OwnershipInferenceItem) SetPrimaryContactRefNil() {
...
func (o *OwnershipInferenceItem) UnsetPrimaryContactRef() {
	o.PrimaryContactRef.Unset()
}

// GetSources returns the Sources field value.
func (o *OwnershipInferenceItem) GetSources() []map[string]interface{} {
	if o == nil {
		var ret []map[string]interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OwnershipInferenceItem) GetSourcesOk() (*[]map[string]interface{}, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OwnershipInferenceItem) SetSources(v []map[string]interface{}) {
	o.Sources = v
}

// GetStatus returns the Status field value.
func (o *OwnershipInferenceItem) GetStatus() OwnershipInferenceStatus {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *OwnershipInferenceItem) GetStatusOk() (*OwnershipInferenceStatus, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OwnershipInferenceItem) SetStatus(v OwnershipInferenceStatus) {
	o.Status = v
}

// GetUpdatedAt returns the UpdatedAt field value.
func (o *OwnershipInferenceItem) GetUpdatedAt() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OwnershipInferenceItem) GetUpdatedAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OwnershipInferenceItem) SetUpdatedAt(v time.Time) {
	o.UpdatedAt = v
}

// MarshalJSON serializes the struct using spec logic.
func (o OwnershipInferenceItem) MarshalJSON() ([]byte, error) {
...
func (o *OwnershipInferenceItem) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Checksum          *string                                      `json:"checksum"`
		Confidence        *string                                      `json:"confidence"`
		CreatedAt         *time.Time                                   `json:"created_at"`
	...
	if err = datadog.UnmarshalUseNumber(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"checksum", "confidence", "created_at", "evidence_versions", "explanation", "id", "owner_type", "primary_contact_ref", "sources", "status", "updated_at"})
	} else {
		return err
	}
