...
type ApplicationSecurityPolicyData struct {
	...
	Meta *ApplicationSecurityPolicyMetadata `json:"meta,omitempty"`
...
func (o *ApplicationSecurityPolicyData) GetMeta() ApplicationSecurityPolicyMetadata {
	if o == nil || o.Meta == nil {
...
// and a boolean to check if the value has been set.
func (o *ApplicationSecurityPolicyData) GetMetaOk() (*ApplicationSecurityPolicyMetadata, bool) {
	if o == nil || o.Meta == nil {
		return nil, false
	}
	return o.Meta, true
...
func (o *ApplicationSecurityPolicyData) HasMeta() bool {
	return o != nil && o.Meta != nil
}

// SetMeta gets a reference to the given ApplicationSecurityPolicyMetadata and assigns it to the Meta field.
func (o *ApplicationSecurityPolicyData) SetMeta(v ApplicationSecurityPolicyMetadata) {
	o.Meta = &v
}
