...
// NewRelationshipToRuleDataObject instantiates a new RelationshipToRuleDataObject object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewRelationshipToRuleDataObject() *RelationshipToRuleDataObject {
	this := RelationshipToRuleDataObject{}
	var typeVar ScorecardType = SCORECARDTYPE_SCORECARD
	this.Type = &typeVar
	return &this
}

// NewRelationshipToRuleDataObjectWithDefaults instantiates a new RelationshipToRuleDataObject object.
