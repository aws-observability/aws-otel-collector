...
// SecurityMonitoringSignalsBulkTriageEventAttributes Triage attributes of a security signal returned in a bulk update response.
type SecurityMonitoringSignalsBulkTriageEventAttributes struct {
...
// NewSecurityMonitoringSignalsBulkTriageEventAttributes instantiates a new SecurityMonitoringSignalsBulkTriageEventAttributes object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewSecurityMonitoringSignalsBulkTriageEventAttributes(assignee SecurityMonitoringTriageUser, id string, incidentIds []int64, state SecurityMonitoringSignalState) *SecurityMonitoringSignalsBulkTriageEventAttributes {
	this := SecurityMonitoringSignalsBulkTriageEventAttributes{}
...
// NewSecurityMonitoringSignalsBulkTriageEventAttributesWithDefaults instantiates a new SecurityMonitoringSignalsBulkTriageEventAttributes object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewSecurityMonitoringSignalsBulkTriageEventAttributesWithDefaults() *SecurityMonitoringSignalsBulkTriageEventAttributes {
	this := SecurityMonitoringSignalsBulkTriageEventAttributes{}
	return &this
}

// GetArchiveComment returns the ArchiveComment field value if set, zero value otherwise.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetArchiveComment() string {
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetArchiveCommentOk() (*string, bool) {
	if o == nil || o.ArchiveComment == nil {
		return nil, false
	}
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) HasArchiveComment() bool {
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) SetArchiveComment(v string) {
	o.ArchiveComment = &v
}

// GetArchiveCommentTimestamp returns the ArchiveCommentTimestamp field value if set, zero value otherwise.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetArchiveCommentTimestamp() int64 {
...
// and a boolean to check if the value has been set.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetArchiveCommentTimestampOk() (*int64, bool) {
	if o == nil || o.ArchiveCommentTimestamp == nil {
		return nil, false
	}
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) HasArchiveCommentTimestamp() bool {
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) SetArchiveCommentTimestamp(v int64) {
	o.ArchiveCommentTimestamp = &v
}

// GetArchiveCommentUser returns the ArchiveCommentUser field value if set, zero value otherwise.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetArchiveCommentUser() SecurityMonitoringTriageUser {
...
// and a boolean to check if the value has been set.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetArchiveCommentUserOk() (*SecurityMonitoringTriageUser, bool) {
	if o == nil || o.ArchiveCommentUser == nil {
		return nil, false
	}
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) HasArchiveCommentUser() bool {
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) SetArchiveCommentUser(v SecurityMonitoringTriageUser) {
	o.ArchiveCommentUser = &v
}

// GetArchiveReason returns the ArchiveReason field value if set, zero value otherwise.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetArchiveReason() SecurityMonitoringSignalArchiveReason {
...
// and a boolean to check if the value has been set.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetArchiveReasonOk() (*SecurityMonitoringSignalArchiveReason, bool) {
	if o == nil || o.ArchiveReason == nil {
		return nil, false
	}
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) HasArchiveReason() bool {
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) SetArchiveReason(v SecurityMonitoringSignalArchiveReason) {
	o.ArchiveReason = &v
}

// GetAssignee returns the Assignee field value.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetAssignee() SecurityMonitoringTriageUser {
	if o == nil {
		var ret SecurityMonitoringTriageUser
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetAssigneeOk() (*SecurityMonitoringTriageUser, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) SetAssignee(v SecurityMonitoringTriageUser) {
	o.Assignee = v
}

// GetId returns the Id field value.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) SetId(v string) {
	o.Id = v
}

// GetIncidentIds returns the IncidentIds field value.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetIncidentIds() []int64 {
	if o == nil {
		var ret []int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetIncidentIdsOk() (*[]int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) SetIncidentIds(v []int64) {
	o.IncidentIds = v
}

// GetState returns the State field value.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetState() SecurityMonitoringSignalState {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetStateOk() (*SecurityMonitoringSignalState, bool) {
	if o == nil {
		return nil, false
	}
	return &o.State, true
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) SetState(v SecurityMonitoringSignalState) {
	o.State = v
}

// GetStateUpdateTimestamp returns the StateUpdateTimestamp field value if set, zero value otherwise.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetStateUpdateTimestamp() int64 {
...
// and a boolean to check if the value has been set.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetStateUpdateTimestampOk() (*int64, bool) {
	if o == nil || o.StateUpdateTimestamp == nil {
		return nil, false
	}
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) HasStateUpdateTimestamp() bool {
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) SetStateUpdateTimestamp(v int64) {
	o.StateUpdateTimestamp = &v
}

// GetStateUpdateUser returns the StateUpdateUser field value if set, zero value otherwise.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetStateUpdateUser() SecurityMonitoringTriageUser {
...
// and a boolean to check if the value has been set.
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) GetStateUpdateUserOk() (*SecurityMonitoringTriageUser, bool) {
	if o == nil || o.StateUpdateUser == nil {
		return nil, false
	}
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) HasStateUpdateUser() bool {
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) SetStateUpdateUser(v SecurityMonitoringTriageUser) {
	o.StateUpdateUser = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o SecurityMonitoringSignalsBulkTriageEventAttributes) MarshalJSON() ([]byte, error) {
...
func (o *SecurityMonitoringSignalsBulkTriageEventAttributes) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		ArchiveComment          *string                                `json:"archive_comment,omitempty"`
		ArchiveCommentTimestamp *int64                                 `json:"archive_comment_timestamp,omitempty"`
		ArchiveCommentUser      *SecurityMonitoringTriageUser          `json:"archive_comment_user,omitempty"`
	...
	if err = datadog.Unmarshal(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"archive_comment", "archive_comment_timestamp", "archive_comment_user", "archive_reason", "assignee", "id", "incident_ids", "state", "state_update_timestamp", "state_update_user"})
	} else {
		return err
	}
