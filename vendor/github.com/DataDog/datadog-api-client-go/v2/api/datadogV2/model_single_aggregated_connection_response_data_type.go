...
var allowedSingleAggregatedConnectionResponseDataTypeEnumValues = []SingleAggregatedConnectionResponseDataType{
	SINGLEAGGREGATEDCONNECTIONRESPONSEDATATYPE_AGGREGATED_CONNECTION,
}

// GetAllowedValues reeturns the list of possible values.
func (v *SingleAggregatedConnectionResponseDataType) GetAllowedValues() []SingleAggregatedConnectionResponseDataType {
	return allowedSingleAggregatedConnectionResponseDataTypeEnumValues
}
...
func (v *SingleAggregatedConnectionResponseDataType) UnmarshalJSON(src []byte) error {
	...
	*v = SingleAggregatedConnectionResponseDataType(value)
	return nil
}

// NewSingleAggregatedConnectionResponseDataTypeFromValue returns a pointer to a valid SingleAggregatedConnectionResponseDataType
...
func NewSingleAggregatedConnectionResponseDataTypeFromValue(v string) (*SingleAggregatedConnectionResponseDataType, error) {
	ev := SingleAggregatedConnectionResponseDataType(v)
	if ev.IsValid() {
		return &ev, nil
	}
	return nil, fmt.Errorf("invalid value '%v' for SingleAggregatedConnectionResponseDataType: valid values are %v", v, allowedSingleAggregatedConnectionResponseDataTypeEnumValues)
}

// IsValid return true if the value is valid for the enum, false otherwise.
func (v SingleAggregatedConnectionResponseDataType) IsValid() bool {
	for _, existing := range allowedSingleAggregatedConnectionResponseDataTypeEnumValues {
		if existing == v {
			return true
		}
	}
