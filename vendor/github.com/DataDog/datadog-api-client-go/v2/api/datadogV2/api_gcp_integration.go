...
func (a *GCPIntegrationApi) CreateGCPSTSAccount(ctx _context.Context, body GCPSTSServiceAccountCreateRequest) (GCPSTSServiceAccountResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/integration/gcp/accounts"
...
// DeleteGCPSTSAccount Delete an STS enabled GCP Account.
...
// GetGCPSTSDelegate List delegate account.
...
func (a *GCPIntegrationApi) GetGCPSTSDelegate(ctx _context.Context) (GCPSTSDelegateAccountResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/integration/gcp/sts_delegate"
...
// ListGCPSTSAccounts List all GCP STS-enabled service accounts.
...
// MakeGCPSTSDelegate Create a Datadog GCP principal.
...
// UpdateGCPSTSAccount Update STS Service Account.
