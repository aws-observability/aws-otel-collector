...
// FeatureFlagListItemAttributes Attributes of a feature flag in list responses.
type FeatureFlagListItemAttributes struct {
...
// NewFeatureFlagListItemAttributes instantiates a new FeatureFlagListItemAttributes object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewFeatureFlagListItemAttributes(description string, key string, name string, valueType ValueType, variants []Variant) *FeatureFlagListItemAttributes {
	this := FeatureFlagListItemAttributes{}
...
// NewFeatureFlagListItemAttributesWithDefaults instantiates a new FeatureFlagListItemAttributes object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewFeatureFlagListItemAttributesWithDefaults() *FeatureFlagListItemAttributes {
	this := FeatureFlagListItemAttributes{}
	return &this
}

// GetArchivedAt returns the ArchivedAt field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *FeatureFlagListItemAttributes) GetArchivedAt() time.Time {
...
func (o *FeatureFlagListItemAttributes) GetArchivedAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FeatureFlagListItemAttributes) HasArchivedAt() bool {
...
func (o *FeatureFlagListItemAttributes) SetArchivedAt(v time.Time) {
	o.ArchivedAt.Set(&v)
}

// SetArchivedAtNil sets the value for ArchivedAt to be an explicit nil.
func (o *FeatureFlagListItemAttributes) SetArchivedAtNil() {
	o.ArchivedAt.Set(nil)
}

// UnsetArchivedAt ensures that no value is present for ArchivedAt, not even an explicit nil.
func (o *FeatureFlagListItemAttributes) UnsetArchivedAt() {
	o.ArchivedAt.Unset()
}

// GetCreatedAt returns the CreatedAt field value if set, zero value otherwise.
func (o *FeatureFlagListItemAttributes) GetCreatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *FeatureFlagListItemAttributes) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil || o.CreatedAt == nil {
		return nil, false
	}
...
func (o *FeatureFlagListItemAttributes) HasCreatedAt() bool {
	return o != nil && o.CreatedAt != nil
}

// SetCreatedAt gets a reference to the given time.Time and assigns it to the CreatedAt field.
func (o *FeatureFlagListItemAttributes) SetCreatedAt(v time.Time) {
	o.CreatedAt = &v
}

// GetCreatedBy returns the CreatedBy field value if set, zero value otherwise.
func (o *FeatureFlagListItemAttributes) GetCreatedBy() uuid.UUID {
...
// and a boolean to check if the value has been set.
func (o *FeatureFlagListItemAttributes) GetCreatedByOk() (*uuid.UUID, bool) {
	if o == nil || o.CreatedBy == nil {
		return nil, false
	}
...
func (o *FeatureFlagListItemAttributes) HasCreatedBy() bool {
	return o != nil && o.CreatedBy != nil
}

// SetCreatedBy gets a reference to the given uuid.UUID and assigns it to the CreatedBy field.
func (o *FeatureFlagListItemAttributes) SetCreatedBy(v uuid.UUID) {
	o.CreatedBy = &v
}

// GetDescription returns the Description field value.
func (o *FeatureFlagListItemAttributes) GetDescription() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FeatureFlagListItemAttributes) GetDescriptionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FeatureFlagListItemAttributes) SetDescription(v string) {
	o.Description = v
}

// GetDistributionChannel returns the DistributionChannel field value if set, zero value otherwise.
func (o *FeatureFlagListItemAttributes) GetDistributionChannel() string {
...
// and a boolean to check if the value has been set.
func (o *FeatureFlagListItemAttributes) GetDistributionChannelOk() (*string, bool) {
	if o == nil || o.DistributionChannel == nil {
		return nil, false
	}
...
func (o *FeatureFlagListItemAttributes) HasDistributionChannel() bool {
...
func (o *FeatureFlagListItemAttributes) SetDistributionChannel(v string) {
...
func (o *FeatureFlagListItemAttributes) GetFeatureFlagEnvironments() []FeatureFlagEnvironmentListItem {
	if o == nil || o.FeatureFlagEnvironments == nil {
		var ret []FeatureFlagEnvironmentListItem
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FeatureFlagListItemAttributes) GetFeatureFlagEnvironmentsOk() (*[]FeatureFlagEnvironmentListItem, bool) {
	if o == nil || o.FeatureFlagEnvironments == nil {
		return nil, false
	}
...
func (o *FeatureFlagListItemAttributes) HasFeatureFlagEnvironments() bool {
	return o != nil && o.FeatureFlagEnvironments != nil
}

// SetFeatureFlagEnvironments gets a reference to the given []FeatureFlagEnvironmentListItem and assigns it to the FeatureFlagEnvironments field.
func (o *FeatureFlagListItemAttributes) SetFeatureFlagEnvironments(v []FeatureFlagEnvironmentListItem) {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *FeatureFlagListItemAttributes) GetJsonSchemaOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FeatureFlagListItemAttributes) HasJsonSchema() bool {
...
func (o *FeatureFlagListItemAttributes) SetJsonSchema(v string) {
	o.JsonSchema.Set(&v)
}

// SetJsonSchemaNil sets the value for JsonSchema to be an explicit nil.
func (o *FeatureFlagListItemAttributes) SetJsonSchemaNil() {
	o.JsonSchema.Set(nil)
}

// UnsetJsonSchema ensures that no value is present for JsonSchema, not even an explicit nil.
func (o *FeatureFlagListItemAttributes) UnsetJsonSchema() {
	o.JsonSchema.Unset()
}

// GetKey returns the Key field value.
func (o *FeatureFlagListItemAttributes) GetKey() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FeatureFlagListItemAttributes) GetKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Key, true
...
func (o *FeatureFlagListItemAttributes) SetKey(v string) {
	o.Key = v
}

// GetLastUpdatedBy returns the LastUpdatedBy field value if set, zero value otherwise.
func (o *FeatureFlagListItemAttributes) GetLastUpdatedBy() uuid.UUID {
...
// and a boolean to check if the value has been set.
func (o *FeatureFlagListItemAttributes) GetLastUpdatedByOk() (*uuid.UUID, bool) {
	if o == nil || o.LastUpdatedBy == nil {
		return nil, false
	}
...
func (o *FeatureFlagListItemAttributes) HasLastUpdatedBy() bool {
...
func (o *FeatureFlagListItemAttributes) SetLastUpdatedBy(v uuid.UUID) {
	o.LastUpdatedBy = &v
}

// GetName returns the Name field value.
func (o *FeatureFlagListItemAttributes) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FeatureFlagListItemAttributes) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *FeatureFlagListItemAttributes) SetName(v string) {
	o.Name = v
}

// GetRequireApproval returns the RequireApproval field value if set, zero value otherwise.
func (o *FeatureFlagListItemAttributes) GetRequireApproval() bool {
...
// and a boolean to check if the value has been set.
func (o *FeatureFlagListItemAttributes) GetRequireApprovalOk() (*bool, bool) {
	if o == nil || o.RequireApproval == nil {
		return nil, false
	}
...
func (o *FeatureFlagListItemAttributes) HasRequireApproval() bool {
...
func (o *FeatureFlagListItemAttributes) GetStalenessStatus() string {
...
// and a boolean to check if the value has been set.
func (o *FeatureFlagListItemAttributes) GetStalenessStatusOk() (*string, bool) {
	if o == nil || o.StalenessStatus == nil {
		return nil, false
	}
...
func (o *FeatureFlagListItemAttributes) HasStalenessStatus() bool {
...
func (o *FeatureFlagListItemAttributes) SetStalenessStatus(v string) {
	o.StalenessStatus = &v
}

// GetTags returns the Tags field value if set, zero value otherwise.
func (o *FeatureFlagListItemAttributes) GetTags() []string {
	if o == nil || o.Tags == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FeatureFlagListItemAttributes) GetTagsOk() (*[]string, bool) {
	if o == nil || o.Tags == nil {
		return nil, false
	}
	return &o.Tags, true
...
func (o *FeatureFlagListItemAttributes) HasTags() bool {
	return o != nil && o.Tags != nil
}

// SetTags gets a reference to the given []string and assigns it to the Tags field.
func (o *FeatureFlagListItemAttributes) SetTags(v []string) {
	o.Tags = v
}

// GetUpdatedAt returns the UpdatedAt field value if set, zero value otherwise.
func (o *FeatureFlagListItemAttributes) GetUpdatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *FeatureFlagListItemAttributes) GetUpdatedAtOk() (*time.Time, bool) {
	if o == nil || o.UpdatedAt == nil {
		return nil, false
	}
...
func (o *FeatureFlagListItemAttributes) HasUpdatedAt() bool {
	return o != nil && o.UpdatedAt != nil
}

// SetUpdatedAt gets a reference to the given time.Time and assigns it to the UpdatedAt field.
func (o *FeatureFlagListItemAttributes) SetUpdatedAt(v time.Time) {
	o.UpdatedAt = &v
}

// GetValueType returns the ValueType field value.
func (o *FeatureFlagListItemAttributes) GetValueType() ValueType {
	if o == nil {
		var ret ValueType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FeatureFlagListItemAttributes) GetValueTypeOk() (*ValueType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FeatureFlagListItemAttributes) SetValueType(v ValueType) {
	o.ValueType = v
}

// GetVariants returns the Variants field value.
func (o *FeatureFlagListItemAttributes) GetVariants() []Variant {
	if o == nil {
		var ret []Variant
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FeatureFlagListItemAttributes) GetVariantsOk() (*[]Variant, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FeatureFlagListItemAttributes) SetVariants(v []Variant) {
	o.Variants = v
}

// MarshalJSON serializes the struct using spec logic.
func (o FeatureFlagListItemAttributes) MarshalJSON() ([]byte, error) {
...
func (o *FeatureFlagListItemAttributes) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		ArchivedAt              datadog.NullableTime             `json:"archived_at,omitempty"`
		CreatedAt               *time.Time                       `json:"created_at,omitempty"`
		CreatedBy               *uuid.UUID                       `json:"created_by,omitempty"`
