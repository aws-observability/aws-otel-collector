...
var allowedObservabilityPipelineOcsfMapperProcessorTypeEnumValues = []ObservabilityPipelineOcsfMapperProcessorType{
	OBSERVABILITYPIPELINEOCSFMAPPERPROCESSORTYPE_OCSF_MAPPER,
}
...
func (v *ObservabilityPipelineOcsfMapperProcessorType) GetAllowedValues() []ObservabilityPipelineOcsfMapperProcessorType {
	return allowedObservabilityPipelineOcsfMapperProcessorTypeEnumValues
}
...
func (v *ObservabilityPipelineOcsfMapperProcessorType) UnmarshalJSON(src []byte) error {
	...
	*v = ObservabilityPipelineOcsfMapperProcessorType(value)
	return nil
}

// NewObservabilityPipelineOcsfMapperProcessorTypeFromValue returns a pointer to a valid ObservabilityPipelineOcsfMapperProcessorType
...
func NewObservabilityPipelineOcsfMapperProcessorTypeFromValue(v string) (*ObservabilityPipelineOcsfMapperProcessorType, error) {
	ev := ObservabilityPipelineOcsfMapperProcessorType(v)
	if ev.IsValid() {
		return &ev, nil
	}
	return nil, fmt.Errorf("invalid value '%v' for ObservabilityPipelineOcsfMapperProcessorType: valid values are %v", v, allowedObservabilityPipelineOcsfMapperProcessorTypeEnumValues)
}

// IsValid return true if the value is valid for the enum, false otherwise.
func (v ObservabilityPipelineOcsfMapperProcessorType) IsValid() bool {
	for _, existing := range allowedObservabilityPipelineOcsfMapperProcessorTypeEnumValues {
		if existing == v {
			return true
		}
	}
