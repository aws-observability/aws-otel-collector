...
func (a *CloudAuthenticationApi) CreateAWSCloudAuthPersonaMapping(ctx _context.Context, body AWSCloudAuthPersonaMappingCreateRequest) (AWSCloudAuthPersonaMappingResponse, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue AWSCloudAuthPersonaMappingResponse
	)

	operationId := "v2.CreateAWSCloudAuthPersonaMapping"
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CloudAuthenticationApi.CreateAWSCloudAuthPersonaMapping")
	if err != nil {
...
func (a *CloudAuthenticationApi) DeleteAWSCloudAuthPersonaMapping(ctx _context.Context, personaMappingId string) (*_nethttp.Response, error) {
	...
	operationId := "v2.DeleteAWSCloudAuthPersonaMapping"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CloudAuthenticationApi.DeleteAWSCloudAuthPersonaMapping")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/cloud_auth/aws/persona_mapping/{persona_mapping_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{persona_mapping_id}", _neturl.PathEscape(datadog.ParameterToString(personaMappingId, "")))
...
func (a *CloudAuthenticationApi) GetAWSCloudAuthPersonaMapping(ctx _context.Context, personaMappingId string) (AWSCloudAuthPersonaMappingResponse, *_nethttp.Response, error) {
	...
	operationId := "v2.GetAWSCloudAuthPersonaMapping"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CloudAuthenticationApi.GetAWSCloudAuthPersonaMapping")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
