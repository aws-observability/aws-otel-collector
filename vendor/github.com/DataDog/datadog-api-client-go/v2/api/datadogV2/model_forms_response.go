...
// FormsResponse A response containing a list of forms.
...
func NewFormsResponse(data []FormData) *FormsResponse {
	this := FormsResponse{}
	this.Data = data
	return &this
}
...
func (o *FormsResponse) GetData() []FormData {
	if o == nil {
		var ret []FormData
		return ret
	}
...
func (o *FormsResponse) GetDataOk() (*[]FormData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *FormsResponse) SetData(v []FormData) {
	o.Data = v
}
...
func (o *FormsResponse) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *[]FormData `json:"data"`
	}{}
