...
func NewOpenAIAPIKey(apiToken string, typeVar OpenAIAPIKeyType) *OpenAIAPIKey {
	this := OpenAIAPIKey{}
...
// NewOpenAIAPIKeyWithDefaults instantiates a new OpenAIAPIKey object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewOpenAIAPIKeyWithDefaults() *OpenAIAPIKey {
	this := OpenAIAPIKey{}
	return &this
}
...
func (o *OpenAIAPIKey) GetApiTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *OpenAIAPIKey) GetTypeOk() (*OpenAIAPIKeyType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *OpenAIAPIKey) SetType(v OpenAIAPIKeyType) {
	o.Type = v
}
