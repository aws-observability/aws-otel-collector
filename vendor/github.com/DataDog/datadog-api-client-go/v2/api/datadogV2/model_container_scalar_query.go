...
type ContainerScalarQuery struct {
...
// NewContainerScalarQuery instantiates a new ContainerScalarQuery object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewContainerScalarQuery(dataSource ContainerDataSource, metric string, name string) *ContainerScalarQuery {
	this := ContainerScalarQuery{}
...
// NewContainerScalarQueryWithDefaults instantiates a new ContainerScalarQuery object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewContainerScalarQueryWithDefaults() *ContainerScalarQuery {
	this := ContainerScalarQuery{}
	var aggregator MetricsAggregator = METRICSAGGREGATOR_AVG
	this.Aggregator = &aggregator
...
func (o *ContainerScalarQuery) GetAggregator() MetricsAggregator {
...
func (o *ContainerScalarQuery) GetAggregatorOk() (*MetricsAggregator, bool) {
	if o == nil || o.Aggregator == nil {
		return nil, false
	}
...
func (o *ContainerScalarQuery) HasAggregator() bool {
...
func (o *ContainerScalarQuery) SetAggregator(v MetricsAggregator) {
	o.Aggregator = &v
}

// GetCrossOrgUuids returns the CrossOrgUuids field value if set, zero value otherwise.
func (o *ContainerScalarQuery) GetCrossOrgUuids() []string {
...
// and a boolean to check if the value has been set.
func (o *ContainerScalarQuery) GetCrossOrgUuidsOk() (*[]string, bool) {
	if o == nil || o.CrossOrgUuids == nil {
		return nil, false
	}
...
func (o *ContainerScalarQuery) HasCrossOrgUuids() bool {
...
func (o *ContainerScalarQuery) SetCrossOrgUuids(v []string) {
	o.CrossOrgUuids = v
}

// GetDataSource returns the DataSource field value.
func (o *ContainerScalarQuery) GetDataSource() ContainerDataSource {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ContainerScalarQuery) GetDataSourceOk() (*ContainerDataSource, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ContainerScalarQuery) SetDataSource(v ContainerDataSource) {
	o.DataSource = v
}

// GetIsNormalizedCpu returns the IsNormalizedCpu field value if set, zero value otherwise.
func (o *ContainerScalarQuery) GetIsNormalizedCpu() bool {
...
// and a boolean to check if the value has been set.
func (o *ContainerScalarQuery) GetIsNormalizedCpuOk() (*bool, bool) {
	if o == nil || o.IsNormalizedCpu == nil {
		return nil, false
	}
...
func (o *ContainerScalarQuery) HasIsNormalizedCpu() bool {
...
func (o *ContainerScalarQuery) SetIsNormalizedCpu(v bool) {
	o.IsNormalizedCpu = &v
}

// GetLimit returns the Limit field value if set, zero value otherwise.
func (o *ContainerScalarQuery) GetLimit() int64 {
...
// and a boolean to check if the value has been set.
func (o *ContainerScalarQuery) GetLimitOk() (*int64, bool) {
	if o == nil || o.Limit == nil {
		return nil, false
	}
	return o.Limit, true
...
func (o *ContainerScalarQuery) HasLimit() bool {
	return o != nil && o.Limit != nil
}

// SetLimit gets a reference to the given int64 and assigns it to the Limit field.
func (o *ContainerScalarQuery) SetLimit(v int64) {
	o.Limit = &v
}

// GetMetric returns the Metric field value.
func (o *ContainerScalarQuery) GetMetric() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ContainerScalarQuery) GetMetricOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ContainerScalarQuery) SetMetric(v string) {
	o.Metric = v
}

// GetName returns the Name field value.
func (o *ContainerScalarQuery) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ContainerScalarQuery) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *ContainerScalarQuery) SetName(v string) {
	o.Name = v
}

// GetSort returns the Sort field value if set, zero value otherwise.
func (o *ContainerScalarQuery) GetSort() QuerySortOrder {
	if o == nil || o.Sort == nil {
...
// and a boolean to check if the value has been set.
func (o *ContainerScalarQuery) GetSortOk() (*QuerySortOrder, bool) {
	if o == nil || o.Sort == nil {
		return nil, false
	}
	return o.Sort, true
...
// and a boolean to check if the value has been set.
func (o *ContainerScalarQuery) GetTagFiltersOk() (*[]string, bool) {
	if o == nil || o.TagFilters == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *ContainerScalarQuery) GetTextFilterOk() (*string, bool) {
	if o == nil || o.TextFilter == nil {
		return nil, false
	}
...
func (o *ContainerScalarQuery) HasTextFilter() bool {
	return o != nil && o.TextFilter != nil
}

// SetTextFilter gets a reference to the given string and assigns it to the TextFilter field.
func (o *ContainerScalarQuery) SetTextFilter(v string) {
	o.TextFilter = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o ContainerScalarQuery) MarshalJSON() ([]byte, error) {
...
func (o *ContainerScalarQuery) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Aggregator      *MetricsAggregator   `json:"aggregator,omitempty"`
		CrossOrgUuids   []string             `json:"cross_org_uuids,omitempty"`
		DataSource      *ContainerDataSource `json:"data_source"`
