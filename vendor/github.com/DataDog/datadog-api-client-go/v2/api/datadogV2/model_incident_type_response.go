...
// NewIncidentTypeResponse instantiates a new IncidentTypeResponse object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewIncidentTypeResponse(data IncidentTypeObject) *IncidentTypeResponse {
	this := IncidentTypeResponse{}
	this.Data = data
	return &this
}

// NewIncidentTypeResponseWithDefaults instantiates a new IncidentTypeResponse object.
