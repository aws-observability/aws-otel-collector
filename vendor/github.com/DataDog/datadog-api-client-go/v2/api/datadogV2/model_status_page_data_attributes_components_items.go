...
func (o *StatusPageDataAttributesComponentsItems) GetId() uuid.UUID {
	if o == nil || o.Id == nil {
		var ret uuid.UUID
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *StatusPageDataAttributesComponentsItems) GetIdOk() (*uuid.UUID, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return o.Id, true
...
func (o *StatusPageDataAttributesComponentsItems) SetId(v uuid.UUID) {
	o.Id = &v
}
