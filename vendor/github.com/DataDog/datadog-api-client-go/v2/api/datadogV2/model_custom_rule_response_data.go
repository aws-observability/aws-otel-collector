...
// NewCustomRuleResponseData instantiates a new CustomRuleResponseData object.
...
// NewCustomRuleResponseDataWithDefaults instantiates a new CustomRuleResponseData object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewCustomRuleResponseDataWithDefaults() *CustomRuleResponseData {
	this := CustomRuleResponseData{}
	return &this
}
...
func (o *CustomRuleResponseData) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CustomRuleResponseData) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *CustomRuleResponseData) SetId(v string) {
	o.Id = v
}

// GetType returns the Type field value.
func (o *CustomRuleResponseData) GetType() CustomRuleDataType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CustomRuleResponseData) GetTypeOk() (*CustomRuleDataType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *CustomRuleResponseData) SetType(v CustomRuleDataType) {
	o.Type = v
}

// MarshalJSON serializes the struct using spec logic.
func (o CustomRuleResponseData) MarshalJSON() ([]byte, error) {
