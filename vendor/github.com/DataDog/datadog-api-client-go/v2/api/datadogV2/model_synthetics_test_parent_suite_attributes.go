...
// SyntheticsTestParentSuiteAttributes Object containing details about a parent suite of a Synthetic test.
type SyntheticsTestParentSuiteAttributes struct {
...
// NewSyntheticsTestParentSuiteAttributes instantiates a new SyntheticsTestParentSuiteAttributes object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewSyntheticsTestParentSuiteAttributes() *SyntheticsTestParentSuiteAttributes {
	this := SyntheticsTestParentSuiteAttributes{}
	return &this
}

// NewSyntheticsTestParentSuiteAttributesWithDefaults instantiates a new SyntheticsTestParentSuiteAttributes object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewSyntheticsTestParentSuiteAttributesWithDefaults() *SyntheticsTestParentSuiteAttributes {
	this := SyntheticsTestParentSuiteAttributes{}
	return &this
}

// GetChildName returns the ChildName field value if set, zero value otherwise.
func (o *SyntheticsTestParentSuiteAttributes) GetChildName() string {
...
func (o *SyntheticsTestParentSuiteAttributes) GetChildNameOk() (*string, bool) {
	if o == nil || o.ChildName == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *SyntheticsTestParentSuiteAttributes) GetChildPublicIdOk() (*string, bool) {
	if o == nil || o.ChildPublicId == nil {
		return nil, false
	}
...
func (o *SyntheticsTestParentSuiteAttributes) HasChildPublicId() bool {
...
func (o *SyntheticsTestParentSuiteAttributes) SetChildPublicId(v string) {
	o.ChildPublicId = &v
}

// GetMonitorId returns the MonitorId field value if set, zero value otherwise.
func (o *SyntheticsTestParentSuiteAttributes) GetMonitorId() int64 {
...
// and a boolean to check if the value has been set.
func (o *SyntheticsTestParentSuiteAttributes) GetMonitorIdOk() (*int64, bool) {
	if o == nil || o.MonitorId == nil {
		return nil, false
	}
...
func (o *SyntheticsTestParentSuiteAttributes) HasMonitorId() bool {
	return o != nil && o.MonitorId != nil
}

// SetMonitorId gets a reference to the given int64 and assigns it to the MonitorId field.
func (o *SyntheticsTestParentSuiteAttributes) SetMonitorId(v int64) {
	o.MonitorId = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *SyntheticsTestParentSuiteAttributes) GetName() string {
	if o == nil || o.Name == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SyntheticsTestParentSuiteAttributes) GetNameOk() (*string, bool) {
	if o == nil || o.Name == nil {
		return nil, false
	}
	return o.Name, true
...
func (o *SyntheticsTestParentSuiteAttributes) HasName() bool {
	return o != nil && o.Name != nil
}

// SetName gets a reference to the given string and assigns it to the Name field.
func (o *SyntheticsTestParentSuiteAttributes) SetName(v string) {
	o.Name = &v
}

// GetOverallState returns the OverallState field value if set, zero value otherwise.
func (o *SyntheticsTestParentSuiteAttributes) GetOverallState() int64 {
...
// and a boolean to check if the value has been set.
func (o *SyntheticsTestParentSuiteAttributes) GetOverallStateOk() (*int64, bool) {
	if o == nil || o.OverallState == nil {
		return nil, false
	}
...
func (o *SyntheticsTestParentSuiteAttributes) HasOverallState() bool {
...
func (o *SyntheticsTestParentSuiteAttributes) SetOverallState(v int64) {
	o.OverallState = &v
}

// GetOverallStateModified returns the OverallStateModified field value if set, zero value otherwise.
func (o *SyntheticsTestParentSuiteAttributes) GetOverallStateModified() string {
...
// and a boolean to check if the value has been set.
func (o *SyntheticsTestParentSuiteAttributes) GetOverallStateModifiedOk() (*string, bool) {
	if o == nil || o.OverallStateModified == nil {
		return nil, false
	}
...
func (o *SyntheticsTestParentSuiteAttributes) HasOverallStateModified() bool {
...
func (o *SyntheticsTestParentSuiteAttributes) SetOverallStateModified(v string) {
	o.OverallStateModified = &v
}

// GetPublicId returns the PublicId field value if set, zero value otherwise.
func (o *SyntheticsTestParentSuiteAttributes) GetPublicId() string {
...
// and a boolean to check if the value has been set.
func (o *SyntheticsTestParentSuiteAttributes) GetPublicIdOk() (*string, bool) {
	if o == nil || o.PublicId == nil {
		return nil, false
	}
...
func (o *SyntheticsTestParentSuiteAttributes) HasPublicId() bool {
	return o != nil && o.PublicId != nil
}

// SetPublicId gets a reference to the given string and assigns it to the PublicId field.
func (o *SyntheticsTestParentSuiteAttributes) SetPublicId(v string) {
	o.PublicId = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o SyntheticsTestParentSuiteAttributes) MarshalJSON() ([]byte, error) {
...
func (o *SyntheticsTestParentSuiteAttributes) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		ChildName            *string `json:"child_name,omitempty"`
		ChildPublicId        *string `json:"child_public_id,omitempty"`
		MonitorId            *int64  `json:"monitor_id,omitempty"`
