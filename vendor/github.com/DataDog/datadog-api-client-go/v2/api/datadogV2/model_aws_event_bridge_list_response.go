...
type AWSEventBridgeListResponse struct {
	...
	Data AWSEventBridgeListResponseData `json:"data"`
...
func NewAWSEventBridgeListResponse(data AWSEventBridgeListResponseData) *AWSEventBridgeListResponse {
...
func (o *AWSEventBridgeListResponse) GetData() AWSEventBridgeListResponseData {
	if o == nil {
		var ret AWSEventBridgeListResponseData
		return ret
	}
	return o.Data
}
...
func (o *AWSEventBridgeListResponse) GetDataOk() (*AWSEventBridgeListResponseData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *AWSEventBridgeListResponse) SetData(v AWSEventBridgeListResponseData) {
	o.Data = v
}
