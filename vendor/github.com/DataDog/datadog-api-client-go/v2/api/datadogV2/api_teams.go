...
// AddMemberTeam Add a member team.
// Add a member team.
...
func (a *TeamsApi) AddMemberTeam(ctx _context.Context, superTeamId string, body AddMemberTeamRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPost
		localVarPostBody   interface{}
	)

	operationId := "v2.AddMemberTeam"
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.AddMemberTeam")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/team/{super_team_id}/member_teams"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{super_team_id}", _neturl.PathEscape(datadog.ParameterToString(superTeamId, "")))
...
// AddTeamHierarchyLink Create a team hierarchy link.
// Create a new team hierarchy link between a parent team and a sub team.
func (a *TeamsApi) AddTeamHierarchyLink(ctx _context.Context, body TeamHierarchyLinkCreateRequest) (TeamHierarchyLinkResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue TeamHierarchyLinkResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.AddTeamHierarchyLink")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/team-hierarchy-links"
...
func (a *TeamsApi) CreateTeam(ctx _context.Context, body TeamCreateRequest) (TeamResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/team"
...
func (a *TeamsApi) CreateTeamConnections(ctx _context.Context, body TeamConnectionCreateRequest) (TeamConnectionsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
...
// CreateTeamLink Create a team link.
...
// CreateTeamNotificationRule Create team notification rule.

func (a *TeamsApi) CreateTeamNotificationRule(ctx _context.Context, teamId string, body TeamNotificationRuleRequest) (TeamNotificationRuleResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue TeamNotificationRuleResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.CreateTeamNotificationRule")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/team/{team_id}/notification-rules"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{team_id}", _neturl.PathEscape(datadog.ParameterToString(teamId, "")))
...
func (a *TeamsApi) DeleteTeamConnections(ctx _context.Context, body TeamConnectionDeleteRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)
...
// DeleteTeamLink Remove a team link.
...
// DeleteTeamNotificationRule Delete team notification rule.

func (a *TeamsApi) DeleteTeamNotificationRule(ctx _context.Context, teamId string, ruleId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.DeleteTeamNotificationRule")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/team/{team_id}/notification-rules/{rule_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{team_id}", _neturl.PathEscape(datadog.ParameterToString(teamId, "")))
...
// GetTeamHierarchyLink Get a team hierarchy link.
// Get a single team hierarchy link for the given link_id.
func (a *TeamsApi) GetTeamHierarchyLink(ctx _context.Context, linkId string) (TeamHierarchyLinkResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue TeamHierarchyLinkResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.GetTeamHierarchyLink")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/team-hierarchy-links/{link_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{link_id}", _neturl.PathEscape(datadog.ParameterToString(linkId, "")))
...
// GetTeamLinks Get links for a team.
...
func (a *TeamsApi) GetTeamMemberships(ctx _context.Context, teamId string, o ...GetTeamMembershipsOptionalParameters) (UserTeamsResponse, *_nethttp.Response, error) {
	...
	if optionalParams.FilterKeyword != nil {
		localVarQueryParams.Add("filter[keyword]", datadog.ParameterToString(*optionalParams.FilterKeyword, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
// GetTeamNotificationRule Get team notification rule.

func (a *TeamsApi) GetTeamNotificationRule(ctx _context.Context, teamId string, ruleId string) (TeamNotificationRuleResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue TeamNotificationRuleResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.GetTeamNotificationRule")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// GetTeamNotificationRules Get team notification rules.

func (a *TeamsApi) GetTeamNotificationRules(ctx _context.Context, teamId string) (TeamNotificationRulesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue TeamNotificationRulesResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.GetTeamNotificationRules")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// ListMemberTeamsOptionalParameters holds optional parameters for ListMemberTeams.
type ListMemberTeamsOptionalParameters struct {
	PageSize   *int64
	PageNumber *int64
	FieldsTeam *[]TeamsField
}

// NewListMemberTeamsOptionalParameters creates an empty struct for parameters.
func NewListMemberTeamsOptionalParameters() *ListMemberTeamsOptionalParameters {
	this := ListMemberTeamsOptionalParameters{}
	return &this
}

// WithPageSize sets the corresponding parameter name and returns the struct.
func (r *ListMemberTeamsOptionalParameters) WithPageSize(pageSize int64) *ListMemberTeamsOptionalParameters {
	r.PageSize = &pageSize
	return r
}

// WithPageNumber sets the corresponding parameter name and returns the struct.
func (r *ListMemberTeamsOptionalParameters) WithPageNumber(pageNumber int64) *ListMemberTeamsOptionalParameters {
	r.PageNumber = &pageNumber
	return r
}

// WithFieldsTeam sets the corresponding parameter name and returns the struct.
func (r *ListMemberTeamsOptionalParameters) WithFieldsTeam(fieldsTeam []TeamsField) *ListMemberTeamsOptionalParameters {
	r.FieldsTeam = &fieldsTeam
	return r
}

// ListMemberTeams Get all member teams.
...
//
// Deprecated: This API is deprecated.
func (a *TeamsApi) ListMemberTeams(ctx _context.Context, superTeamId string, o ...ListMemberTeamsOptionalParameters) (TeamsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue TeamsResponse
		optionalParams      ListMemberTeamsOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, datadog.ReportError("only one argument of type ListMemberTeamsOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}

	operationId := "v2.ListMemberTeams"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.ListMemberTeams")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// ListMemberTeamsWithPagination provides a paginated version of ListMemberTeams returning a channel with all items.
func (a *TeamsApi) ListMemberTeamsWithPagination(ctx _context.Context, superTeamId string, o ...ListMemberTeamsOptionalParameters) (<-chan datadog.PaginationResult[Team], func()) {
	ctx, cancel := _context.WithCancel(ctx)
	pageSize_ := int64(10)
	if len(o) == 0 {
		o = append(o, ListMemberTeamsOptionalParameters{})
	}
	if o[0].PageSize != nil {
		pageSize_ = *o[0].PageSize
	}
	...
	go func() {
		for {
			resp, _, err := a.ListMemberTeams(ctx, superTeamId, o...)
			if err != nil {
				var returnItem Team
...
func (a *TeamsApi) ListTeamConnections(ctx _context.Context, o ...ListTeamConnectionsOptionalParameters) (TeamConnectionsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue TeamConnectionsResponse
...
func (a *TeamsApi) ListTeamConnectionsWithPagination(ctx _context.Context, o ...ListTeamConnectionsOptionalParameters) (<-chan datadog.PaginationResult[TeamConnection], func()) {
	ctx, cancel := _context.WithCancel(ctx)
	pageSize_ := int64(10)
	if len(o) == 0 {
...
// ListTeamHierarchyLinksOptionalParameters holds optional parameters for ListTeamHierarchyLinks.
type ListTeamHierarchyLinksOptionalParameters struct {
	PageNumber       *int64
	PageSize         *int64
...
// NewListTeamHierarchyLinksOptionalParameters creates an empty struct for parameters.
func NewListTeamHierarchyLinksOptionalParameters() *ListTeamHierarchyLinksOptionalParameters {
	this := ListTeamHierarchyLinksOptionalParameters{}
	return &this
}

// WithPageNumber sets the corresponding parameter name and returns the struct.
func (r *ListTeamHierarchyLinksOptionalParameters) WithPageNumber(pageNumber int64) *ListTeamHierarchyLinksOptionalParameters {
	r.PageNumber = &pageNumber
	return r
}

// WithPageSize sets the corresponding parameter name and returns the struct.
func (r *ListTeamHierarchyLinksOptionalParameters) WithPageSize(pageSize int64) *ListTeamHierarchyLinksOptionalParameters {
	r.PageSize = &pageSize
	return r
}

// WithFilterParentTeam sets the corresponding parameter name and returns the struct.
func (r *ListTeamHierarchyLinksOptionalParameters) WithFilterParentTeam(filterParentTeam string) *ListTeamHierarchyLinksOptionalParameters {
	r.FilterParentTeam = &filterParentTeam
	return r
}

// WithFilterSubTeam sets the corresponding parameter name and returns the struct.
func (r *ListTeamHierarchyLinksOptionalParameters) WithFilterSubTeam(filterSubTeam string) *ListTeamHierarchyLinksOptionalParameters {
	r.FilterSubTeam = &filterSubTeam
	return r
}

// ListTeamHierarchyLinks Get team hierarchy links.
// List all team hierarchy links that match the provided filters.
func (a *TeamsApi) ListTeamHierarchyLinks(ctx _context.Context, o ...ListTeamHierarchyLinksOptionalParameters) (TeamHierarchyLinksResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue TeamHierarchyLinksResponse
		optionalParams      ListTeamHierarchyLinksOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, datadog.ReportError("only one argument of type ListTeamHierarchyLinksOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.ListTeamHierarchyLinks")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
	...
	if optionalParams.FilterParentTeam != nil {
		localVarQueryParams.Add("filter[parent_team]", datadog.ParameterToString(*optionalParams.FilterParentTeam, ""))
	}
	if optionalParams.FilterSubTeam != nil {
		localVarQueryParams.Add("filter[sub_team]", datadog.ParameterToString(*optionalParams.FilterSubTeam, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
// ListTeamHierarchyLinksWithPagination provides a paginated version of ListTeamHierarchyLinks returning a channel with all items.
func (a *TeamsApi) ListTeamHierarchyLinksWithPagination(ctx _context.Context, o ...ListTeamHierarchyLinksOptionalParameters) (<-chan datadog.PaginationResult[TeamHierarchyLink], func()) {
	ctx, cancel := _context.WithCancel(ctx)
	pageSize_ := int64(10)
	if len(o) == 0 {
		o = append(o, ListTeamHierarchyLinksOptionalParameters{})
	}
	if o[0].PageSize != nil {
		pageSize_ = *o[0].PageSize
	}
	...
	items := make(chan datadog.PaginationResult[TeamHierarchyLink], pageSize_)
	go func() {
		for {
			resp, _, err := a.ListTeamHierarchyLinks(ctx, o...)
			if err != nil {
				var returnItem TeamHierarchyLink
				items <- datadog.PaginationResult[TeamHierarchyLink]{Item: returnItem, Error: err}
				break
			}
			respData, ok := resp.GetDataOk()
			if !ok {
			...
			for _, item := range results {
				select {
				case items <- datadog.PaginationResult[TeamHierarchyLink]{Item: item, Error: nil}:
				case <-ctx.Done():
					close(items)
					return
				}
...
// RemoveMemberTeam Remove a member team.
...
//
// Deprecated: This API is deprecated.
func (a *TeamsApi) RemoveMemberTeam(ctx _context.Context, superTeamId string, memberTeamId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	operationId := "v2.RemoveMemberTeam"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.RemoveMemberTeam")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/team/{super_team_id}/member_teams/{member_team_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{super_team_id}", _neturl.PathEscape(datadog.ParameterToString(superTeamId, "")))
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{member_team_id}", _neturl.PathEscape(datadog.ParameterToString(memberTeamId, "")))
...
// RemoveTeamHierarchyLink Remove a team hierarchy link.
// Remove a team hierarchy link by the given link_id.
func (a *TeamsApi) RemoveTeamHierarchyLink(ctx _context.Context, linkId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.RemoveTeamHierarchyLink")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// UpdateTeamLink Update a team link.
// Update a team link.
...
// UpdateTeamNotificationRule Update team notification rule.

func (a *TeamsApi) UpdateTeamNotificationRule(ctx _context.Context, teamId string, ruleId string, body TeamNotificationRuleRequest) (TeamNotificationRuleResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.TeamsApi.UpdateTeamNotificationRule")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// UpdateTeamPermissionSetting Update permission setting for team.
