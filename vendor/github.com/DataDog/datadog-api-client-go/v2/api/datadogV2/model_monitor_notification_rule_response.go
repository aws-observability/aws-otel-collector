...
// NewMonitorNotificationRuleResponse instantiates a new MonitorNotificationRuleResponse object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewMonitorNotificationRuleResponse() *MonitorNotificationRuleResponse {
	this := MonitorNotificationRuleResponse{}
	return &this
}

// NewMonitorNotificationRuleResponseWithDefaults instantiates a new MonitorNotificationRuleResponse object.
