...
// SecureEmbedCreateResponseAttributes Attributes of a newly created secure embed shared dashboard.
type SecureEmbedCreateResponseAttributes struct {
	// Creation timestamp.
...
// NewSecureEmbedCreateResponseAttributes instantiates a new SecureEmbedCreateResponseAttributes object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewSecureEmbedCreateResponseAttributes() *SecureEmbedCreateResponseAttributes {
	this := SecureEmbedCreateResponseAttributes{}
	return &this
}

// NewSecureEmbedCreateResponseAttributesWithDefaults instantiates a new SecureEmbedCreateResponseAttributes object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewSecureEmbedCreateResponseAttributesWithDefaults() *SecureEmbedCreateResponseAttributes {
	this := SecureEmbedCreateResponseAttributes{}
	return &this
}

// GetCreatedAt returns the CreatedAt field value if set, zero value otherwise.
func (o *SecureEmbedCreateResponseAttributes) GetCreatedAt() string {
...
func (o *SecureEmbedCreateResponseAttributes) GetCreatedAtOk() (*string, bool) {
	if o == nil || o.CreatedAt == nil {
		return nil, false
	}
...
func (o *SecureEmbedCreateResponseAttributes) HasCreatedAt() bool {
	return o != nil && o.CreatedAt != nil
}

// SetCreatedAt gets a reference to the given string and assigns it to the CreatedAt field.
func (o *SecureEmbedCreateResponseAttributes) SetCreatedAt(v string) {
	o.CreatedAt = &v
}

// GetCredential returns the Credential field value if set, zero value otherwise.
func (o *SecureEmbedCreateResponseAttributes) GetCredential() string {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedCreateResponseAttributes) GetCredentialOk() (*string, bool) {
	if o == nil || o.Credential == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedCreateResponseAttributes) GetDashboardIdOk() (*string, bool) {
	if o == nil || o.DashboardId == nil {
		return nil, false
	}
...
func (o *SecureEmbedCreateResponseAttributes) HasDashboardId() bool {
...
func (o *SecureEmbedCreateResponseAttributes) SetDashboardId(v string) {
	o.DashboardId = &v
}

// GetGlobalTime returns the GlobalTime field value if set, zero value otherwise.
func (o *SecureEmbedCreateResponseAttributes) GetGlobalTime() SecureEmbedGlobalTime {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedCreateResponseAttributes) GetGlobalTimeOk() (*SecureEmbedGlobalTime, bool) {
	if o == nil || o.GlobalTime == nil {
		return nil, false
	}
...
func (o *SecureEmbedCreateResponseAttributes) HasGlobalTime() bool {
...
func (o *SecureEmbedCreateResponseAttributes) SetGlobalTime(v SecureEmbedGlobalTime) {
	o.GlobalTime = &v
}

// GetGlobalTimeSelectable returns the GlobalTimeSelectable field value if set, zero value otherwise.
func (o *SecureEmbedCreateResponseAttributes) GetGlobalTimeSelectable() bool {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedCreateResponseAttributes) GetGlobalTimeSelectableOk() (*bool, bool) {
	if o == nil || o.GlobalTimeSelectable == nil {
		return nil, false
	}
...
func (o *SecureEmbedCreateResponseAttributes) HasGlobalTimeSelectable() bool {
...
func (o *SecureEmbedCreateResponseAttributes) SetGlobalTimeSelectable(v bool) {
	o.GlobalTimeSelectable = &v
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *SecureEmbedCreateResponseAttributes) GetId() string {
	if o == nil || o.Id == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedCreateResponseAttributes) GetIdOk() (*string, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return o.Id, true
...
func (o *SecureEmbedCreateResponseAttributes) HasId() bool {
	return o != nil && o.Id != nil
}

// SetId gets a reference to the given string and assigns it to the Id field.
func (o *SecureEmbedCreateResponseAttributes) SetId(v string) {
	o.Id = &v
}

// GetSelectableTemplateVars returns the SelectableTemplateVars field value if set, zero value otherwise.
func (o *SecureEmbedCreateResponseAttributes) GetSelectableTemplateVars() []SecureEmbedSelectableTemplateVariable {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedCreateResponseAttributes) GetSelectableTemplateVarsOk() (*[]SecureEmbedSelectableTemplateVariable, bool) {
	if o == nil || o.SelectableTemplateVars == nil {
		return nil, false
	}
...
func (o *SecureEmbedCreateResponseAttributes) HasSelectableTemplateVars() bool {
...
func (o *SecureEmbedCreateResponseAttributes) SetSelectableTemplateVars(v []SecureEmbedSelectableTemplateVariable) {
	o.SelectableTemplateVars = v
}

// GetShareType returns the ShareType field value if set, zero value otherwise.
func (o *SecureEmbedCreateResponseAttributes) GetShareType() SecureEmbedShareType {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedCreateResponseAttributes) GetShareTypeOk() (*SecureEmbedShareType, bool) {
	if o == nil || o.ShareType == nil {
		return nil, false
	}
...
func (o *SecureEmbedCreateResponseAttributes) HasShareType() bool {
...
func (o *SecureEmbedCreateResponseAttributes) SetShareType(v SecureEmbedShareType) {
	o.ShareType = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *SecureEmbedCreateResponseAttributes) GetStatus() SecureEmbedStatus {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedCreateResponseAttributes) GetStatusOk() (*SecureEmbedStatus, bool) {
	if o == nil || o.Status == nil {
		return nil, false
	}
...
func (o *SecureEmbedCreateResponseAttributes) HasStatus() bool {
	return o != nil && o.Status != nil
}

// SetStatus gets a reference to the given SecureEmbedStatus and assigns it to the Status field.
func (o *SecureEmbedCreateResponseAttributes) SetStatus(v SecureEmbedStatus) {
	o.Status = &v
}

// GetTitle returns the Title field value if set, zero value otherwise.
func (o *SecureEmbedCreateResponseAttributes) GetTitle() string {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedCreateResponseAttributes) GetTitleOk() (*string, bool) {
	if o == nil || o.Title == nil {
		return nil, false
	}
	return o.Title, true
...
func (o *SecureEmbedCreateResponseAttributes) HasTitle() bool {
	return o != nil && o.Title != nil
}

// SetTitle gets a reference to the given string and assigns it to the Title field.
func (o *SecureEmbedCreateResponseAttributes) SetTitle(v string) {
	o.Title = &v
}

// GetToken returns the Token field value if set, zero value otherwise.
func (o *SecureEmbedCreateResponseAttributes) GetToken() string {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedCreateResponseAttributes) GetTokenOk() (*string, bool) {
	if o == nil || o.Token == nil {
		return nil, false
	}
	return o.Token, true
...
func (o *SecureEmbedCreateResponseAttributes) HasToken() bool {
	return o != nil && o.Token != nil
}

// SetToken gets a reference to the given string and assigns it to the Token field.
func (o *SecureEmbedCreateResponseAttributes) SetToken(v string) {
	o.Token = &v
}

// GetUrl returns the Url field value if set, zero value otherwise.
func (o *SecureEmbedCreateResponseAttributes) GetUrl() string {
	if o == nil || o.Url == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedCreateResponseAttributes) GetUrlOk() (*string, bool) {
	if o == nil || o.Url == nil {
		return nil, false
	}
	return o.Url, true
...
func (o *SecureEmbedCreateResponseAttributes) HasUrl() bool {
	return o != nil && o.Url != nil
}

// SetUrl gets a reference to the given string and assigns it to the Url field.
func (o *SecureEmbedCreateResponseAttributes) SetUrl(v string) {
	o.Url = &v
}

// GetViewingPreferences returns the ViewingPreferences field value if set, zero value otherwise.
func (o *SecureEmbedCreateResponseAttributes) GetViewingPreferences() SecureEmbedViewingPreferences {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedCreateResponseAttributes) GetViewingPreferencesOk() (*SecureEmbedViewingPreferences, bool) {
	if o == nil || o.ViewingPreferences == nil {
		return nil, false
	}
...
func (o *SecureEmbedCreateResponseAttributes) HasViewingPreferences() bool {
...
func (o *SecureEmbedCreateResponseAttributes) SetViewingPreferences(v SecureEmbedViewingPreferences) {
	o.ViewingPreferences = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o SecureEmbedCreateResponseAttributes) MarshalJSON() ([]byte, error) {
...
func (o *SecureEmbedCreateResponseAttributes) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		CreatedAt              *string                                 `json:"created_at,omitempty"`
		Credential             *string                                 `json:"credential,omitempty"`
		DashboardId            *string                                 `json:"dashboard_id,omitempty"`
	...
	if err = datadog.Unmarshal(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"created_at", "credential", "dashboard_id", "global_time", "global_time_selectable", "id", "selectable_template_vars", "share_type", "status", "title", "token", "url", "viewing_preferences"})
	} else {
		return err
	}
