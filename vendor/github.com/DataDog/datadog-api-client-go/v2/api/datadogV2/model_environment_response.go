...
func NewEnvironmentResponse(data Environment) *EnvironmentResponse {
...
func (o *EnvironmentResponse) GetData() Environment {
	if o == nil {
		var ret Environment
		return ret
	}
...
func (o *EnvironmentResponse) GetDataOk() (*Environment, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *EnvironmentResponse) SetData(v Environment) {
	o.Data = v
}
...
func (o *EnvironmentResponse) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *Environment `json:"data"`
	}{}
