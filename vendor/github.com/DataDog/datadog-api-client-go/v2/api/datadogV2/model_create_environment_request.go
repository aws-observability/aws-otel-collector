...
func NewCreateEnvironmentRequest(data CreateEnvironmentData) *CreateEnvironmentRequest {
...
func (o *CreateEnvironmentRequest) GetData() CreateEnvironmentData {
	if o == nil {
		var ret CreateEnvironmentData
		return ret
	}
	return o.Data
}
...
func (o *CreateEnvironmentRequest) GetDataOk() (*CreateEnvironmentData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *CreateEnvironmentRequest) SetData(v CreateEnvironmentData) {
	o.Data = v
}
...
func (o *CreateEnvironmentRequest) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *CreateEnvironmentData `json:"data"`
	}{}
