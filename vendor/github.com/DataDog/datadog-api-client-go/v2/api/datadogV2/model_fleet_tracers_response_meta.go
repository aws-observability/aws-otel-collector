...
// FleetTracersResponseMeta Metadata for the list of tracers response.
type FleetTracersResponseMeta struct {
...
// NewFleetTracersResponseMeta instantiates a new FleetTracersResponseMeta object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewFleetTracersResponseMeta() *FleetTracersResponseMeta {
	this := FleetTracersResponseMeta{}
	return &this
}

// NewFleetTracersResponseMetaWithDefaults instantiates a new FleetTracersResponseMeta object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewFleetTracersResponseMetaWithDefaults() *FleetTracersResponseMeta {
	this := FleetTracersResponseMeta{}
	return &this
}

// GetTotalFilteredCount returns the TotalFilteredCount field value if set, zero value otherwise.
func (o *FleetTracersResponseMeta) GetTotalFilteredCount() int64 {
...
func (o *FleetTracersResponseMeta) GetTotalFilteredCountOk() (*int64, bool) {
	if o == nil || o.TotalFilteredCount == nil {
		return nil, false
	}
...
func (o *FleetTracersResponseMeta) HasTotalFilteredCount() bool {
...
func (o *FleetTracersResponseMeta) SetTotalFilteredCount(v int64) {
	o.TotalFilteredCount = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o FleetTracersResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o *FleetTracersResponseMeta) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		TotalFilteredCount *int64 `json:"total_filtered_count,omitempty"`
	}{}
