...
// GetEntityRiskScore Get Entity Risk Score.
...
func (a *EntityRiskScoresApi) GetEntityRiskScore(ctx _context.Context, entityId string) (SecurityEntityRiskScoreResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue SecurityEntityRiskScoreResponse
	)

	operationId := "v2.GetEntityRiskScore"
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.EntityRiskScoresApi.GetEntityRiskScore")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/security-entities/risk-scores/{entity_id}"
