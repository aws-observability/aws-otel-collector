...
func (o *IoCIndicator) GetTriageState() IoCTriageState {
...
// and a boolean to check if the value has been set.
func (o *IoCIndicator) GetTriageStateOk() (*IoCTriageState, bool) {
	if o == nil || o.TriageState == nil {
		return nil, false
	}
...
func (o *IoCIndicator) HasTriageState() bool {
...
func (o *IoCIndicator) SetTriageState(v IoCTriageState) {
	o.TriageState = &v
}

// GetTriagedAt returns the TriagedAt field value if set, zero value otherwise.
func (o *IoCIndicator) GetTriagedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *IoCIndicator) GetTriagedAtOk() (*time.Time, bool) {
	if o == nil || o.TriagedAt == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *IoCIndicator) GetTriagedByOk() (*string, bool) {
	if o == nil || o.TriagedBy == nil {
		return nil, false
	}
