...
func (a *LLMObservabilityApi) AggregateLLMObsExperimentation(ctx _context.Context, body LLMObsExperimentationAnalyticsRequest) (LLMObsExperimentationAnalyticsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue LLMObsExperimentationAnalyticsResponse
	)

	operationId := "v2.AggregateLLMObsExperimentation"
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.AggregateLLMObsExperimentation")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/experimentation/analytics"
...
func (a *LLMObservabilityApi) CreateLLMObsAnnotationQueue(ctx _context.Context, body LLMObsAnnotationQueueRequest) (LLMObsAnnotationQueueResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue LLMObsAnnotationQueueResponse
	)

	operationId := "v2.CreateLLMObsAnnotationQueue"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.CreateLLMObsAnnotationQueue")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/annotation-queues"
...
func (a *LLMObservabilityApi) CreateLLMObsAnnotationQueueInteractions(ctx _context.Context, queueId string, body LLMObsAnnotationQueueInteractionsRequest) (LLMObsAnnotationQueueInteractionsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue LLMObsAnnotationQueueInteractionsResponse
	)

	operationId := "v2.CreateLLMObsAnnotationQueueInteractions"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.CreateLLMObsAnnotationQueueInteractions")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/annotation-queues/{queue_id}/interactions"
...
// CreateLLMObsIntegrationInference Run an LLM inference.
// Run an LLM inference request through the specified integration and account, returning the model response and token usage.
func (a *LLMObservabilityApi) CreateLLMObsIntegrationInference(ctx _context.Context, integration LLMObsIntegrationName, accountId string, body LLMObsIntegrationInferenceRequest) (LLMObsIntegrationInferenceResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue LLMObsIntegrationInferenceResponse
	)

	operationId := "v2.CreateLLMObsIntegrationInference"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.CreateLLMObsIntegrationInference")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/integrations/{integration}/{account_id}/inference"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{integration}", _neturl.PathEscape(datadog.ParameterToString(integration, "")))
...
func (a *LLMObservabilityApi) DeleteLLMObsAnnotationQueue(ctx _context.Context, queueId string) (*_nethttp.Response, error) {
	...
	operationId := "v2.DeleteLLMObsAnnotationQueue"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.DeleteLLMObsAnnotationQueue")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/annotation-queues/{queue_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{queue_id}", _neturl.PathEscape(datadog.ParameterToString(queueId, "")))
...
// DeleteLLMObsAnnotationQueueInteractions Delete annotation queue interactions.
// Delete one or more interactions from an annotation queue.
func (a *LLMObservabilityApi) DeleteLLMObsAnnotationQueueInteractions(ctx _context.Context, queueId string, body LLMObsDeleteAnnotationQueueInteractionsRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPost
		localVarPostBody   interface{}
	)

	operationId := "v2.DeleteLLMObsAnnotationQueueInteractions"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.DeleteLLMObsAnnotationQueueInteractions")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/annotation-queues/{queue_id}/interactions/delete"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{queue_id}", _neturl.PathEscape(datadog.ParameterToString(queueId, "")))
...
// DeleteLLMObsAnnotations Delete annotations.
// Delete one or more annotations from an annotation queue.
func (a *LLMObservabilityApi) DeleteLLMObsAnnotations(ctx _context.Context, queueId string, body LLMObsDeleteAnnotationsRequest) (LLMObsDeleteAnnotationsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue LLMObsDeleteAnnotationsResponse
	)

	operationId := "v2.DeleteLLMObsAnnotations"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.DeleteLLMObsAnnotations")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/annotation-queues/{queue_id}/annotations/delete"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{queue_id}", _neturl.PathEscape(datadog.ParameterToString(queueId, "")))
...
// DeleteLLMObsPatternsConfig Delete a patterns configuration.
// Delete a patterns configuration by its ID.
func (a *LLMObservabilityApi) DeleteLLMObsPatternsConfig(ctx _context.Context, configId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	operationId := "v2.DeleteLLMObsPatternsConfig"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.DeleteLLMObsPatternsConfig")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/topic-discovery-configs/{config_id}"
...
func (a *LLMObservabilityApi) GetLLMObsAnnotatedInteractions(ctx _context.Context, queueId string) (LLMObsAnnotatedInteractionsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue LLMObsAnnotatedInteractionsResponse
	)

	operationId := "v2.GetLLMObsAnnotatedInteractions"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.GetLLMObsAnnotatedInteractions")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/annotation-queues/{queue_id}/annotated-interactions"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{queue_id}", _neturl.PathEscape(datadog.ParameterToString(queueId, "")))
...
func (a *LLMObservabilityApi) GetLLMObsDatasetDraftState(ctx _context.Context, projectId string, datasetId string) (LLMObsDatasetDraftStateResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue LLMObsDatasetDraftStateResponse
	)

	operationId := "v2.GetLLMObsDatasetDraftState"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.GetLLMObsDatasetDraftState")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/{project_id}/datasets/{dataset_id}/draft_state"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{project_id}", _neturl.PathEscape(datadog.ParameterToString(projectId, "")))
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{dataset_id}", _neturl.PathEscape(datadog.ParameterToString(datasetId, "")))
...
// GetLLMObsPatternsConfig Get a patterns configuration.
// Retrieve the patterns configuration for the organization.
func (a *LLMObservabilityApi) GetLLMObsPatternsConfig(ctx _context.Context) (LLMObsPatternsConfigResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue LLMObsPatternsConfigResponse
	)

	operationId := "v2.GetLLMObsPatternsConfig"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.GetLLMObsPatternsConfig")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/topic-discovery-configs/latest"
...
// GetLLMObsPatternsRunStatus Get patterns run status.
// Retrieve the status and step-by-step progress of the current or most recent
// patterns run for a configuration.
func (a *LLMObservabilityApi) GetLLMObsPatternsRunStatus(ctx _context.Context, configId string) (LLMObsPatternsRunStatusResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue LLMObsPatternsRunStatusResponse
	)

	operationId := "v2.GetLLMObsPatternsRunStatus"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.GetLLMObsPatternsRunStatus")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/topic-discovery-runs/status"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	localVarQueryParams.Add("config_id", datadog.ParameterToString(configId, ""))
	localVarHeaderParams["Accept"] = "application/json"
...
// NewListLLMObsAnnotationQueuesOptionalParameters creates an empty struct for parameters.
func NewListLLMObsAnnotationQueuesOptionalParameters() *ListLLMObsAnnotationQueuesOptionalParameters {
	this := ListLLMObsAnnotationQueuesOptionalParameters{}
	return &this
}

// WithProjectId sets the corresponding parameter name and returns the struct.
func (r *ListLLMObsAnnotationQueuesOptionalParameters) WithProjectId(projectId string) *ListLLMObsAnnotationQueuesOptionalParameters {
	r.ProjectId = &projectId
	return r
}

// WithQueueIds sets the corresponding parameter name and returns the struct.
func (r *ListLLMObsAnnotationQueuesOptionalParameters) WithQueueIds(queueIds []string) *ListLLMObsAnnotationQueuesOptionalParameters {
	r.QueueIds = &queueIds
	return r
}
...
func (a *LLMObservabilityApi) ListLLMObsAnnotationQueues(ctx _context.Context, o ...ListLLMObsAnnotationQueuesOptionalParameters) (LLMObsAnnotationQueuesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue LLMObsAnnotationQueuesResponse
		optionalParams      ListLLMObsAnnotationQueuesOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, datadog.ReportError("only one argument of type ListLLMObsAnnotationQueuesOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}

	operationId := "v2.ListLLMObsAnnotationQueues"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.ListLLMObsAnnotationQueues")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if optionalParams.ProjectId != nil {
		localVarQueryParams.Add("projectId", datadog.ParameterToString(*optionalParams.ProjectId, ""))
	}
	if optionalParams.QueueIds != nil {
		t := *optionalParams.QueueIds
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("queueIds", datadog.ParameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("queueIds", datadog.ParameterToString(t, "multi"))
		}
	}
	localVarHeaderParams["Accept"] = "application/json"
...
func (a *LLMObservabilityApi) ListLLMObsDatasetVersions(ctx _context.Context, projectId string, datasetId string) (LLMObsDatasetVersionsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue LLMObsDatasetVersionsResponse
	)

	operationId := "v2.ListLLMObsDatasetVersions"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.ListLLMObsDatasetVersions")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/{project_id}/datasets/{dataset_id}/versions"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{project_id}", _neturl.PathEscape(datadog.ParameterToString(projectId, "")))
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{dataset_id}", _neturl.PathEscape(datadog.ParameterToString(datasetId, "")))
...
// ListLLMObsExperimentEventsOptionalParameters holds optional parameters for ListLLMObsExperimentEvents.
type ListLLMObsExperimentEventsOptionalParameters struct {
	PageLimit  *int64
	PageCursor *string
}

// NewListLLMObsExperimentEventsOptionalParameters creates an empty struct for parameters.
func NewListLLMObsExperimentEventsOptionalParameters() *ListLLMObsExperimentEventsOptionalParameters {
	this := ListLLMObsExperimentEventsOptionalParameters{}
	return &this
}

// WithPageLimit sets the corresponding parameter name and returns the struct.
func (r *ListLLMObsExperimentEventsOptionalParameters) WithPageLimit(pageLimit int64) *ListLLMObsExperimentEventsOptionalParameters {
	r.PageLimit = &pageLimit
	return r
}

// WithPageCursor sets the corresponding parameter name and returns the struct.
func (r *ListLLMObsExperimentEventsOptionalParameters) WithPageCursor(pageCursor string) *ListLLMObsExperimentEventsOptionalParameters {
	r.PageCursor = &pageCursor
	return r
}
...
func (a *LLMObservabilityApi) ListLLMObsExperimentEvents(ctx _context.Context, experimentId string, o ...ListLLMObsExperimentEventsOptionalParameters) (LLMObsExperimentEventsV2Response, *_nethttp.Response, error) {
	var (
		...
		optionalParams      ListLLMObsExperimentEventsOptionalParameters
	)
	...
	operationId := "v2.ListLLMObsExperimentEvents"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.ListLLMObsExperimentEvents")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v3/experiments/{experiment_id}/events"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{experiment_id}", _neturl.PathEscape(datadog.ParameterToString(experimentId, "")))
...
// ListLLMObsIntegrationAccounts List LLM integration accounts.
// Retrieve the list of configured accounts for the specified LLM provider integration.
func (a *LLMObservabilityApi) ListLLMObsIntegrationAccounts(ctx _context.Context, integration LLMObsIntegrationName) ([]LLMObsIntegrationAccount, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue []LLMObsIntegrationAccount
	)

	operationId := "v2.ListLLMObsIntegrationAccounts"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.ListLLMObsIntegrationAccounts")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/integrations/{integration}/accounts"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{integration}", _neturl.PathEscape(datadog.ParameterToString(integration, "")))
...
// ListLLMObsIntegrationModels List LLM integration models.
// Retrieve the list of models available for the specified LLM provider integration and account.
func (a *LLMObservabilityApi) ListLLMObsIntegrationModels(ctx _context.Context, integration LLMObsIntegrationName, accountId string) ([]LLMObsIntegrationModel, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue []LLMObsIntegrationModel
	)

	operationId := "v2.ListLLMObsIntegrationModels"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.ListLLMObsIntegrationModels")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/integrations/{integration}/{account_id}/models"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{integration}", _neturl.PathEscape(datadog.ParameterToString(integration, "")))
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{account_id}", _neturl.PathEscape(datadog.ParameterToString(accountId, "")))
...
// ListLLMObsPatternsClusteredPointsOptionalParameters holds optional parameters for ListLLMObsPatternsClusteredPoints.
type ListLLMObsPatternsClusteredPointsOptionalParameters struct {
	PageSize  *int64
	PageToken *string
}

// NewListLLMObsPatternsClusteredPointsOptionalParameters creates an empty struct for parameters.
func NewListLLMObsPatternsClusteredPointsOptionalParameters() *ListLLMObsPatternsClusteredPointsOptionalParameters {
	this := ListLLMObsPatternsClusteredPointsOptionalParameters{}
	return &this
}

// WithPageSize sets the corresponding parameter name and returns the struct.
func (r *ListLLMObsPatternsClusteredPointsOptionalParameters) WithPageSize(pageSize int64) *ListLLMObsPatternsClusteredPointsOptionalParameters {
	r.PageSize = &pageSize
	return r
}

// WithPageToken sets the corresponding parameter name and returns the struct.
func (r *ListLLMObsPatternsClusteredPointsOptionalParameters) WithPageToken(pageToken string) *ListLLMObsPatternsClusteredPointsOptionalParameters {
	r.PageToken = &pageToken
	return r
}

// ListLLMObsPatternsClusteredPoints List patterns clustered points.
// List the data points grouped into a topic. For a parent topic, points from all
// of its leaf topics are returned.
func (a *LLMObservabilityApi) ListLLMObsPatternsClusteredPoints(ctx _context.Context, topicId string, o ...ListLLMObsPatternsClusteredPointsOptionalParameters) (LLMObsPatternsClusteredPointsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue LLMObsPatternsClusteredPointsResponse
		optionalParams      ListLLMObsPatternsClusteredPointsOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, datadog.ReportError("only one argument of type ListLLMObsPatternsClusteredPointsOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}

	operationId := "v2.ListLLMObsPatternsClusteredPoints"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.ListLLMObsPatternsClusteredPoints")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/topic-discovery-clustered-points"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	localVarQueryParams.Add("topic_id", datadog.ParameterToString(topicId, ""))
...
// ListLLMObsPatternsConfigs List patterns configurations.
// List all patterns configurations for the organization.
func (a *LLMObservabilityApi) ListLLMObsPatternsConfigs(ctx _context.Context) (LLMObsPatternsConfigsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue LLMObsPatternsConfigsResponse
	)

	operationId := "v2.ListLLMObsPatternsConfigs"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.ListLLMObsPatternsConfigs")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/topic-discovery-configs"
...
// ListLLMObsPatternsRuns List patterns runs.
// List the completed patterns runs for a configuration.
func (a *LLMObservabilityApi) ListLLMObsPatternsRuns(ctx _context.Context, configId string) (LLMObsPatternsRunsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue LLMObsPatternsRunsResponse
	)

	operationId := "v2.ListLLMObsPatternsRuns"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.ListLLMObsPatternsRuns")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/topic-discovery-runs"
...
// ListLLMObsPatternsTopicsOptionalParameters holds optional parameters for ListLLMObsPatternsTopics.
type ListLLMObsPatternsTopicsOptionalParameters struct {
	RunId *string
}

// NewListLLMObsPatternsTopicsOptionalParameters creates an empty struct for parameters.
func NewListLLMObsPatternsTopicsOptionalParameters() *ListLLMObsPatternsTopicsOptionalParameters {
	this := ListLLMObsPatternsTopicsOptionalParameters{}
	return &this
}

// WithRunId sets the corresponding parameter name and returns the struct.
func (r *ListLLMObsPatternsTopicsOptionalParameters) WithRunId(runId string) *ListLLMObsPatternsTopicsOptionalParameters {
	r.RunId = &runId
	return r
}

// ListLLMObsPatternsTopics List patterns topics.
// List the topics discovered by a patterns run. When no run is specified,
// the most recent completed run is used.
func (a *LLMObservabilityApi) ListLLMObsPatternsTopics(ctx _context.Context, configId string, o ...ListLLMObsPatternsTopicsOptionalParameters) (LLMObsPatternsTopicsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue LLMObsPatternsTopicsResponse
		optionalParams      ListLLMObsPatternsTopicsOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, datadog.ReportError("only one argument of type ListLLMObsPatternsTopicsOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}

	operationId := "v2.ListLLMObsPatternsTopics"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.ListLLMObsPatternsTopics")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/topic-discovery-topics"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	localVarQueryParams.Add("config_id", datadog.ParameterToString(configId, ""))
	if optionalParams.RunId != nil {
		localVarQueryParams.Add("run_id", datadog.ParameterToString(*optionalParams.RunId, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
// ListLLMObsPatternsTopicsWithClusteredPointsOptionalParameters holds optional parameters for ListLLMObsPatternsTopicsWithClusteredPoints.
type ListLLMObsPatternsTopicsWithClusteredPointsOptionalParameters struct {
	RunId          *string
	IncludeMetrics *bool
}

// NewListLLMObsPatternsTopicsWithClusteredPointsOptionalParameters creates an empty struct for parameters.
func NewListLLMObsPatternsTopicsWithClusteredPointsOptionalParameters() *ListLLMObsPatternsTopicsWithClusteredPointsOptionalParameters {
	this := ListLLMObsPatternsTopicsWithClusteredPointsOptionalParameters{}
	return &this
}

// WithRunId sets the corresponding parameter name and returns the struct.
func (r *ListLLMObsPatternsTopicsWithClusteredPointsOptionalParameters) WithRunId(runId string) *ListLLMObsPatternsTopicsWithClusteredPointsOptionalParameters {
	r.RunId = &runId
	return r
}

// WithIncludeMetrics sets the corresponding parameter name and returns the struct.
func (r *ListLLMObsPatternsTopicsWithClusteredPointsOptionalParameters) WithIncludeMetrics(includeMetrics bool) *ListLLMObsPatternsTopicsWithClusteredPointsOptionalParameters {
	r.IncludeMetrics = &includeMetrics
	return r
}

// ListLLMObsPatternsTopicsWithClusteredPoints List patterns topics with clustered points.
...
// run is used.
func (a *LLMObservabilityApi) ListLLMObsPatternsTopicsWithClusteredPoints(ctx _context.Context, configId string, o ...ListLLMObsPatternsTopicsWithClusteredPointsOptionalParameters) (LLMObsPatternsTopicsWithClusteredPointsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue LLMObsPatternsTopicsWithClusteredPointsResponse
		optionalParams      ListLLMObsPatternsTopicsWithClusteredPointsOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, datadog.ReportError("only one argument of type ListLLMObsPatternsTopicsWithClusteredPointsOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}

	operationId := "v2.ListLLMObsPatternsTopicsWithClusteredPoints"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.ListLLMObsPatternsTopicsWithClusteredPoints")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/topic-discovery-topics/with-cluster-points"
	...
	if optionalParams.IncludeMetrics != nil {
		localVarQueryParams.Add("include_metrics", datadog.ParameterToString(*optionalParams.IncludeMetrics, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
func (a *LLMObservabilityApi) LockLLMObsDatasetDraftState(ctx _context.Context, projectId string, datasetId string) (LLMObsDatasetDraftStateResponse, *_nethttp.Response, error) {
	...
	operationId := "v2.LockLLMObsDatasetDraftState"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.LockLLMObsDatasetDraftState")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/{project_id}/datasets/{dataset_id}/draft_state/lock"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{project_id}", _neturl.PathEscape(datadog.ParameterToString(projectId, "")))
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{dataset_id}", _neturl.PathEscape(datadog.ParameterToString(datasetId, "")))
...
func (a *LLMObservabilityApi) SearchLLMObsExperimentation(ctx _context.Context, body LLMObsExperimentationSearchRequest) (LLMObsExperimentationSearchResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue LLMObsExperimentationSearchResponse
	)

	operationId := "v2.SearchLLMObsExperimentation"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.SearchLLMObsExperimentation")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/experimentation/search"
...
//
// The `filter.scope` field controls which entity types are returned. At least one valid scope must be provided.
func (a *LLMObservabilityApi) SimpleSearchLLMObsExperimentation(ctx _context.Context, body LLMObsExperimentationSimpleSearchRequest) (LLMObsExperimentationSimpleSearchResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue LLMObsExperimentationSimpleSearchResponse
	)
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.SimpleSearchLLMObsExperimentation")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/experimentation/simple-search"
...
// TriggerLLMObsPatterns Trigger a patterns run.
// Start a patterns run for a given configuration. The run executes asynchronously.
func (a *LLMObservabilityApi) TriggerLLMObsPatterns(ctx _context.Context, body LLMObsPatternsTriggerRequest) (LLMObsPatternsTriggerResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue LLMObsPatternsTriggerResponse
	)

	operationId := "v2.TriggerLLMObsPatterns"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.TriggerLLMObsPatterns")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *LLMObservabilityApi) UnlockLLMObsDatasetDraftState(ctx _context.Context, projectId string, datasetId string) (*_nethttp.Response, error) {
	...
	operationId := "v2.UnlockLLMObsDatasetDraftState"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.UnlockLLMObsDatasetDraftState")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/{project_id}/datasets/{dataset_id}/draft_state/unlock"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{project_id}", _neturl.PathEscape(datadog.ParameterToString(projectId, "")))
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{dataset_id}", _neturl.PathEscape(datadog.ParameterToString(datasetId, "")))
...
func (a *LLMObservabilityApi) UpdateLLMObsAnnotationQueue(ctx _context.Context, queueId string, body LLMObsAnnotationQueueUpdateRequest) (LLMObsAnnotationQueueResponse, *_nethttp.Response, error) {
	...
	operationId := "v2.UpdateLLMObsAnnotationQueue"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.UpdateLLMObsAnnotationQueue")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// UpsertLLMObsAnnotations Create or update annotations.
...
func (a *LLMObservabilityApi) UpsertLLMObsAnnotations(ctx _context.Context, queueId string, body LLMObsAnnotationsRequest) (LLMObsAnnotationsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue LLMObsAnnotationsResponse
	)

	operationId := "v2.UpsertLLMObsAnnotations"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.UpsertLLMObsAnnotations")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/llm-obs/v1/annotation-queues/{queue_id}/annotations"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{queue_id}", _neturl.PathEscape(datadog.ParameterToString(queueId, "")))
...
// UpsertLLMObsPatternsConfig Create or update a patterns configuration.
// Create a new patterns configuration, or update an existing one when a configuration ID is provided.
func (a *LLMObservabilityApi) UpsertLLMObsPatternsConfig(ctx _context.Context, body LLMObsPatternsConfigUpsertRequest) (LLMObsPatternsConfigResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPut
		localVarPostBody    interface{}
		localVarReturnValue LLMObsPatternsConfigResponse
	...
	operationId := "v2.UpsertLLMObsPatternsConfig"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.LLMObservabilityApi.UpsertLLMObsPatternsConfig")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
