...
// GCPIntegration The definition of the `GCPIntegration` object.
...
func NewGCPIntegration(credentials GCPCredentials, typeVar GCPIntegrationType) *GCPIntegration {
	this := GCPIntegration{}
...
func (o *GCPIntegration) GetCredentials() GCPCredentials {
	if o == nil {
...
func (o *GCPIntegration) GetCredentialsOk() (*GCPCredentials, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GCPIntegration) SetCredentials(v GCPCredentials) {
	o.Credentials = v
}

// GetType returns the Type field value.
func (o *GCPIntegration) GetType() GCPIntegrationType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *GCPIntegration) GetTypeOk() (*GCPIntegrationType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *GCPIntegration) SetType(v GCPIntegrationType) {
	o.Type = v
}
...
func (o *GCPIntegration) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Credentials *GCPCredentials     `json:"credentials"`
		Type        *GCPIntegrationType `json:"type"`
	}{}
