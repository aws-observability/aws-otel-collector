...
// OnCallNotificationRuleAttributes Attributes for an on-call notification rule.
type OnCallNotificationRuleAttributes struct {
...
// NewOnCallNotificationRuleAttributes instantiates a new OnCallNotificationRuleAttributes object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewOnCallNotificationRuleAttributes() *OnCallNotificationRuleAttributes {
	this := OnCallNotificationRuleAttributes{}
	var category OnCallNotificationRuleCategory = ONCALLNOTIFICATIONRULECATEGORY_HIGH_URGENCY
	this.Category = &category
	return &this
}

// NewOnCallNotificationRuleAttributesWithDefaults instantiates a new OnCallNotificationRuleAttributes object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewOnCallNotificationRuleAttributesWithDefaults() *OnCallNotificationRuleAttributes {
	this := OnCallNotificationRuleAttributes{}
	var category OnCallNotificationRuleCategory = ONCALLNOTIFICATIONRULECATEGORY_HIGH_URGENCY
	this.Category = &category
	return &this
...
func (o *OnCallNotificationRuleAttributes) GetCategory() OnCallNotificationRuleCategory {
...
func (o *OnCallNotificationRuleAttributes) GetCategoryOk() (*OnCallNotificationRuleCategory, bool) {
	if o == nil || o.Category == nil {
		return nil, false
	}
...
func (o *OnCallNotificationRuleAttributes) HasCategory() bool {
...
func (o *OnCallNotificationRuleAttributes) SetCategory(v OnCallNotificationRuleCategory) {
	o.Category = &v
}

// GetChannelSettings returns the ChannelSettings field value if set, zero value otherwise.
func (o *OnCallNotificationRuleAttributes) GetChannelSettings() OnCallNotificationRuleChannelSettings {
...
// and a boolean to check if the value has been set.
func (o *OnCallNotificationRuleAttributes) GetChannelSettingsOk() (*OnCallNotificationRuleChannelSettings, bool) {
	if o == nil || o.ChannelSettings == nil {
		return nil, false
	}
...
func (o *OnCallNotificationRuleAttributes) HasChannelSettings() bool {
...
func (o *OnCallNotificationRuleAttributes) SetChannelSettings(v OnCallNotificationRuleChannelSettings) {
	o.ChannelSettings = &v
}

// GetDelayMinutes returns the DelayMinutes field value if set, zero value otherwise.
func (o *OnCallNotificationRuleAttributes) GetDelayMinutes() int64 {
...
// and a boolean to check if the value has been set.
func (o *OnCallNotificationRuleAttributes) GetDelayMinutesOk() (*int64, bool) {
	if o == nil || o.DelayMinutes == nil {
		return nil, false
	}
...
func (o *OnCallNotificationRuleAttributes) HasDelayMinutes() bool {
...
func (o *OnCallNotificationRuleAttributes) SetDelayMinutes(v int64) {
	o.DelayMinutes = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o OnCallNotificationRuleAttributes) MarshalJSON() ([]byte, error) {
...
func (o *OnCallNotificationRuleAttributes) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Category        *OnCallNotificationRuleCategory        `json:"category,omitempty"`
		ChannelSettings *OnCallNotificationRuleChannelSettings `json:"channel_settings,omitempty"`
		DelayMinutes    *int64                                 `json:"delay_minutes,omitempty"`
