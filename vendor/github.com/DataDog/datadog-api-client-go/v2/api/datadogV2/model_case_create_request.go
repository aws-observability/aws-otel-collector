...
// NewCaseCreateRequest instantiates a new CaseCreateRequest object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewCaseCreateRequest(data CaseCreate) *CaseCreateRequest {
	this := CaseCreateRequest{}
	this.Data = data
	return &this
}

// NewCaseCreateRequestWithDefaults instantiates a new CaseCreateRequest object.
