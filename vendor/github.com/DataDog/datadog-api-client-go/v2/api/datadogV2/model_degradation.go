...
// Degradation Response object for a single degradation.
...
// NewDegradation instantiates a new Degradation object.
...
// NewDegradationWithDefaults instantiates a new Degradation object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewDegradationWithDefaults() *Degradation {
	this := Degradation{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *Degradation) GetData() DegradationData {
	if o == nil || o.Data == nil {
...
func (o *Degradation) GetDataOk() (*DegradationData, bool) {
	if o == nil || o.Data == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *Degradation) HasData() bool {
	return o != nil && o.Data != nil
}

// SetData gets a reference to the given DegradationData and assigns it to the Data field.
func (o *Degradation) SetData(v DegradationData) {
	o.Data = &v
}
...
func (o *Degradation) HasIncluded() bool {
...
func (o Degradation) MarshalJSON() ([]byte, error) {
