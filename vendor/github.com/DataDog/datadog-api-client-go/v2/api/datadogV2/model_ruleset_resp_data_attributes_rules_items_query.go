...
func NewRulesetRespDataAttributesRulesItemsQuery(addition NullableRulesetRespDataAttributesRulesItemsQueryAddition, query string) *RulesetRespDataAttributesRulesItemsQuery {
...
// NewRulesetRespDataAttributesRulesItemsQueryWithDefaults instantiates a new RulesetRespDataAttributesRulesItemsQuery object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewRulesetRespDataAttributesRulesItemsQueryWithDefaults() *RulesetRespDataAttributesRulesItemsQuery {
	this := RulesetRespDataAttributesRulesItemsQuery{}
	return &this
}
...
func (o *RulesetRespDataAttributesRulesItemsQuery) GetAddition() RulesetRespDataAttributesRulesItemsQueryAddition {
	if o == nil || o.Addition.Get() == nil {
		var ret RulesetRespDataAttributesRulesItemsQueryAddition
		return ret
	}
...
func (o *RulesetRespDataAttributesRulesItemsQuery) GetAdditionOk() (*RulesetRespDataAttributesRulesItemsQueryAddition, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *RulesetRespDataAttributesRulesItemsQuery) GetCaseInsensitivityOk() (*bool, bool) {
	if o == nil || o.CaseInsensitivity == nil {
		return nil, false
	}
...
func (o *RulesetRespDataAttributesRulesItemsQuery) HasCaseInsensitivity() bool {
...
func (o *RulesetRespDataAttributesRulesItemsQuery) SetCaseInsensitivity(v bool) {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *RulesetRespDataAttributesRulesItemsQuery) GetIfNotExistsOk() (*bool, bool) {
	if o == nil || o.IfNotExists == nil {
		return nil, false
	}
...
func (o *RulesetRespDataAttributesRulesItemsQuery) HasIfNotExists() bool {
...
func (o *RulesetRespDataAttributesRulesItemsQuery) GetIfTagExists() DataAttributesRulesItemsIfTagExists {
...
// and a boolean to check if the value has been set.
func (o *RulesetRespDataAttributesRulesItemsQuery) GetIfTagExistsOk() (*DataAttributesRulesItemsIfTagExists, bool) {
	if o == nil || o.IfTagExists == nil {
		return nil, false
	}
...
func (o *RulesetRespDataAttributesRulesItemsQuery) HasIfTagExists() bool {
...
func (o *RulesetRespDataAttributesRulesItemsQuery) SetIfTagExists(v DataAttributesRulesItemsIfTagExists) {
	o.IfTagExists = &v
}
...
// and a boolean to check if the value has been set.
func (o *RulesetRespDataAttributesRulesItemsQuery) GetQueryOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Query, true
...
func (o *RulesetRespDataAttributesRulesItemsQuery) SetQuery(v string) {
	o.Query = v
}
...
func (v NullableRulesetRespDataAttributesRulesItemsQuery) Get() *RulesetRespDataAttributesRulesItemsQuery {
	return v.value
}

// Set changes the value and indicates it's been called.
func (v *NullableRulesetRespDataAttributesRulesItemsQuery) Set(val *RulesetRespDataAttributesRulesItemsQuery) {
	v.value = val
	v.isSet = true
}

// IsSet returns whether Set has been called.
func (v NullableRulesetRespDataAttributesRulesItemsQuery) IsSet() bool {
	return v.isSet
}

// Unset sets the value to nil and resets the set flag/
func (v *NullableRulesetRespDataAttributesRulesItemsQuery) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableRulesetRespDataAttributesRulesItemsQuery initializes the struct as if Set has been called.
func NewNullableRulesetRespDataAttributesRulesItemsQuery(val *RulesetRespDataAttributesRulesItemsQuery) *NullableRulesetRespDataAttributesRulesItemsQuery {
	return &NullableRulesetRespDataAttributesRulesItemsQuery{value: val, isSet: true}
}

// MarshalJSON serializes the associated value.
func (v NullableRulesetRespDataAttributesRulesItemsQuery) MarshalJSON() ([]byte, error) {
	return datadog.Marshal(v.value)
}

// UnmarshalJSON deserializes the payload and sets the flag as if Set has been called.
func (v *NullableRulesetRespDataAttributesRulesItemsQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
