...
func NewGeminiAPIKeyUpdate(typeVar GeminiAPIKeyType) *GeminiAPIKeyUpdate {
	this := GeminiAPIKeyUpdate{}
	this.Type = typeVar
	return &this
}

// NewGeminiAPIKeyUpdateWithDefaults instantiates a new GeminiAPIKeyUpdate object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewGeminiAPIKeyUpdateWithDefaults() *GeminiAPIKeyUpdate {
	this := GeminiAPIKeyUpdate{}
	return &this
}
...
func (o *GeminiAPIKeyUpdate) GetApiKeyOk() (*string, bool) {
	if o == nil || o.ApiKey == nil {
		return nil, false
	}
...
func (o *GeminiAPIKeyUpdate) HasApiKey() bool {
	return o != nil && o.ApiKey != nil
}

// SetApiKey gets a reference to the given string and assigns it to the ApiKey field.
func (o *GeminiAPIKeyUpdate) SetApiKey(v string) {
	o.ApiKey = &v
}
...
// and a boolean to check if the value has been set.
func (o *GeminiAPIKeyUpdate) GetTypeOk() (*GeminiAPIKeyType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *GeminiAPIKeyUpdate) SetType(v GeminiAPIKeyType) {
	o.Type = v
}
