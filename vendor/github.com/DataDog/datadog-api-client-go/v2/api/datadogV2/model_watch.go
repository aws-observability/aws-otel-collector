...
func NewWatch(data WatchData) *Watch {
	this := Watch{}
	this.Data = data
	return &this
}
...
func (o *Watch) GetData() WatchData {
	if o == nil {
		var ret WatchData
		return ret
	}
...
func (o *Watch) GetDataOk() (*WatchData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *Watch) SetData(v WatchData) {
	o.Data = v
}
...
func (o *Watch) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *WatchData `json:"data"`
	}{}
