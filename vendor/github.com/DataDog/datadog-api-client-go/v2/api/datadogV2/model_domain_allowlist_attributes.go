...
// NewDomainAllowlistAttributes instantiates a new DomainAllowlistAttributes object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewDomainAllowlistAttributes() *DomainAllowlistAttributes {
	this := DomainAllowlistAttributes{}
	return &this
}

// NewDomainAllowlistAttributesWithDefaults instantiates a new DomainAllowlistAttributes object.
