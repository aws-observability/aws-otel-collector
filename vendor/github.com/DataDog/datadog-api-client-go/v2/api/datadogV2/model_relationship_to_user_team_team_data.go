...
// NewRelationshipToUserTeamTeamData instantiates a new RelationshipToUserTeamTeamData object.
...
func NewRelationshipToUserTeamTeamData(id string, typeVar UserTeamTeamType) *RelationshipToUserTeamTeamData {
	this := RelationshipToUserTeamTeamData{}
	this.Id = id
	this.Type = typeVar
	return &this
}

// NewRelationshipToUserTeamTeamDataWithDefaults instantiates a new RelationshipToUserTeamTeamData object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewRelationshipToUserTeamTeamDataWithDefaults() *RelationshipToUserTeamTeamData {
	this := RelationshipToUserTeamTeamData{}
	var typeVar UserTeamTeamType = USERTEAMTEAMTYPE_TEAM
	this.Type = typeVar
	return &this
}
