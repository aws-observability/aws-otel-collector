...
func (a *CaseManagementApi) CommentCase(ctx _context.Context, caseId string, body CaseCommentRequest) (TimelineResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CaseManagementApi.CommentCase")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/cases/{case_id}/comment"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{case_id}", _neturl.PathEscape(datadog.ParameterToString(caseId, "")))
...
func (a *CaseManagementApi) CreateCase(ctx _context.Context, body CaseCreateRequest) (CaseResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/cases"
...
func (a *CaseManagementApi) CreateCaseJiraIssue(ctx _context.Context, caseId string, body JiraIssueCreateRequest) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/cases/{case_id}/relationships/jira_issues"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{case_id}", _neturl.PathEscape(datadog.ParameterToString(caseId, "")))
...
func (a *CaseManagementApi) CreateCaseNotebook(ctx _context.Context, caseId string, body NotebookCreateRequest) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/cases/{case_id}/relationships/notebook"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{case_id}", _neturl.PathEscape(datadog.ParameterToString(caseId, "")))
...
func (a *CaseManagementApi) CreateCaseServiceNowTicket(ctx _context.Context, caseId string, body ServiceNowTicketCreateRequest) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/cases/{case_id}/relationships/servicenow_tickets"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{case_id}", _neturl.PathEscape(datadog.ParameterToString(caseId, "")))
...
func (a *CaseManagementApi) CreateProject(ctx _context.Context, body ProjectCreateRequest) (ProjectResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/cases/projects"
...
// CreateProjectNotificationRule Create a notification rule.
// Create a notification rule for a project.
func (a *CaseManagementApi) CreateProjectNotificationRule(ctx _context.Context, projectId string, body CaseNotificationRuleCreateRequest) (CaseNotificationRuleResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue CaseNotificationRuleResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CaseManagementApi.CreateProjectNotificationRule")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/cases/projects/{project_id}/notification_rules"
...
func (a *CaseManagementApi) DeleteCaseComment(ctx _context.Context, caseId string, cellId string) (*_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CaseManagementApi.DeleteCaseComment")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/cases/{case_id}/comment/{cell_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{case_id}", _neturl.PathEscape(datadog.ParameterToString(caseId, "")))
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{cell_id}", _neturl.PathEscape(datadog.ParameterToString(cellId, "")))
...
func (a *CaseManagementApi) DeleteCaseCustomAttribute(ctx _context.Context, caseId string, customAttributeKey string) (CaseResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CaseManagementApi.DeleteCaseCustomAttribute")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/cases/{case_id}/custom_attributes/{custom_attribute_key}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{case_id}", _neturl.PathEscape(datadog.ParameterToString(caseId, "")))
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{custom_attribute_key}", _neturl.PathEscape(datadog.ParameterToString(customAttributeKey, "")))
...
// DeleteProjectNotificationRule Delete a notification rule.
// Delete a notification rule using the notification rule's `id`.
func (a *CaseManagementApi) DeleteProjectNotificationRule(ctx _context.Context, projectId string, notificationRuleId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CaseManagementApi.DeleteProjectNotificationRule")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/cases/projects/{project_id}/notification_rules/{notification_rule_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{project_id}", _neturl.PathEscape(datadog.ParameterToString(projectId, "")))
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{notification_rule_id}", _neturl.PathEscape(datadog.ParameterToString(notificationRuleId, "")))
...
// GetProject Get the details of a project.
...
// GetProjectNotificationRules Get notification rules.
// Get all notification rules for a project.
func (a *CaseManagementApi) GetProjectNotificationRules(ctx _context.Context, projectId string) (CaseNotificationRulesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue CaseNotificationRulesResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CaseManagementApi.GetProjectNotificationRules")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *CaseManagementApi) LinkIncident(ctx _context.Context, caseId string, body RelationshipToIncidentRequest) (CaseResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/cases/{case_id}/relationships/incidents"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{case_id}", _neturl.PathEscape(datadog.ParameterToString(caseId, "")))
...
func (a *CaseManagementApi) MoveCaseToProject(ctx _context.Context, caseId string, body ProjectRelationship) (CaseResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/cases/{case_id}/relationships/project"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{case_id}", _neturl.PathEscape(datadog.ParameterToString(caseId, "")))
...
func (a *CaseManagementApi) SearchCases(ctx _context.Context, o ...SearchCasesOptionalParameters) (CasesResponse, *_nethttp.Response, error) {
	...
	if optionalParams.SortAsc != nil {
		localVarQueryParams.Add("sort[asc]", datadog.ParameterToString(*optionalParams.SortAsc, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
func (a *CaseManagementApi) SearchCasesWithPagination(ctx _context.Context, o ...SearchCasesOptionalParameters) (<-chan datadog.PaginationResult[Case], func()) {
	...
	pageSize_ := int64(10)
	if len(o) == 0 {
		o = append(o, SearchCasesOptionalParameters{})
	}
	if o[0].PageSize != nil {
	...
	go func() {
		for {
			resp, _, err := a.SearchCases(ctx, o...)
			if err != nil {
				var returnItem Case
				items <- datadog.PaginationResult[Case]{Item: returnItem, Error: err}
				break
			}
...
func (a *CaseManagementApi) UpdateCaseCustomAttribute(ctx _context.Context, caseId string, customAttributeKey string, body CaseUpdateCustomAttributeRequest) (CaseResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CaseManagementApi.UpdateCaseCustomAttribute")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *CaseManagementApi) UpdateCaseDescription(ctx _context.Context, caseId string, body CaseUpdateDescriptionRequest) (CaseResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CaseManagementApi.UpdateCaseDescription")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/cases/{case_id}/description"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{case_id}", _neturl.PathEscape(datadog.ParameterToString(caseId, "")))
...
func (a *CaseManagementApi) UpdateCaseTitle(ctx _context.Context, caseId string, body CaseUpdateTitleRequest) (CaseResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CaseManagementApi.UpdateCaseTitle")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/cases/{case_id}/title"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{case_id}", _neturl.PathEscape(datadog.ParameterToString(caseId, "")))
...
// Update a project.
func (a *CaseManagementApi) UpdateProject(ctx _context.Context, projectId string, body ProjectUpdateRequest) (ProjectResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPatch
		localVarPostBody    interface{}
		localVarReturnValue ProjectResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CaseManagementApi.UpdateProject")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// UpdateProjectNotificationRule Update a notification rule.
// Update a notification rule.
func (a *CaseManagementApi) UpdateProjectNotificationRule(ctx _context.Context, projectId string, notificationRuleId string, body CaseNotificationRuleUpdateRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPut
		localVarPostBody   interface{}
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CaseManagementApi.UpdateProjectNotificationRule")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
