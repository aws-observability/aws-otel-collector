...
type AWSEventBridgeCreateResponse struct {
	...
	Data AWSEventBridgeCreateResponseData `json:"data"`
...
func NewAWSEventBridgeCreateResponse(data AWSEventBridgeCreateResponseData) *AWSEventBridgeCreateResponse {
...
func (o *AWSEventBridgeCreateResponse) GetData() AWSEventBridgeCreateResponseData {
	if o == nil {
		var ret AWSEventBridgeCreateResponseData
		return ret
	}
	return o.Data
}
...
func (o *AWSEventBridgeCreateResponse) GetDataOk() (*AWSEventBridgeCreateResponseData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *AWSEventBridgeCreateResponse) SetData(v AWSEventBridgeCreateResponseData) {
	o.Data = v
}
