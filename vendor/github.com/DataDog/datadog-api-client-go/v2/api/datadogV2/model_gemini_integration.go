...
func NewGeminiIntegration(credentials GeminiCredentials, typeVar GeminiIntegrationType) *GeminiIntegration {
...
// NewGeminiIntegrationWithDefaults instantiates a new GeminiIntegration object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewGeminiIntegrationWithDefaults() *GeminiIntegration {
	this := GeminiIntegration{}
	return &this
}
...
func (o *GeminiIntegration) GetCredentialsOk() (*GeminiCredentials, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *GeminiIntegration) GetTypeOk() (*GeminiIntegrationType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *GeminiIntegration) SetType(v GeminiIntegrationType) {
	o.Type = v
}
