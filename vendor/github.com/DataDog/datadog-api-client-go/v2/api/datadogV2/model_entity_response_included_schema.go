...
func (o *EntityResponseIncludedSchema) GetType() string {
	if o == nil || o.Type == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EntityResponseIncludedSchema) GetTypeOk() (*string, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return o.Type, true
...
func (o *EntityResponseIncludedSchema) SetType(v string) {
	o.Type = &v
}
