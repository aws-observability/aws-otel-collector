...
func NewProjectUpdateRequest(data ProjectUpdate) *ProjectUpdateRequest {
...
func (o *ProjectUpdateRequest) GetData() ProjectUpdate {
	if o == nil {
...
func (o *ProjectUpdateRequest) GetDataOk() (*ProjectUpdate, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *ProjectUpdateRequest) SetData(v ProjectUpdate) {
	o.Data = v
}
...
func (o *ProjectUpdateRequest) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *ProjectUpdate `json:"data"`
	}{}
