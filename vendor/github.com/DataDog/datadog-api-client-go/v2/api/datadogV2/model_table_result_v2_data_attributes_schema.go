...
func NewTableResultV2DataAttributesSchema(fields []TableResultV2DataAttributesSchemaFieldsItems, primaryKeys []string) *TableResultV2DataAttributesSchema {
...
// NewTableResultV2DataAttributesSchemaWithDefaults instantiates a new TableResultV2DataAttributesSchema object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewTableResultV2DataAttributesSchemaWithDefaults() *TableResultV2DataAttributesSchema {
	this := TableResultV2DataAttributesSchema{}
	return &this
}
...
func (o *TableResultV2DataAttributesSchema) GetFields() []TableResultV2DataAttributesSchemaFieldsItems {
	if o == nil {
		var ret []TableResultV2DataAttributesSchemaFieldsItems
		return ret
	}
	return o.Fields
}
...
func (o *TableResultV2DataAttributesSchema) GetFieldsOk() (*[]TableResultV2DataAttributesSchemaFieldsItems, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *TableResultV2DataAttributesSchema) GetPrimaryKeysOk() (*[]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TableResultV2DataAttributesSchema) SetPrimaryKeys(v []string) {
	o.PrimaryKeys = v
}
