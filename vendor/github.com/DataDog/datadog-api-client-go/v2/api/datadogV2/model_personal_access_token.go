...
func (o *PersonalAccessToken) HasAttributes() bool {
...
func (o *PersonalAccessToken) HasRelationships() bool {
...
func (o *PersonalAccessToken) GetType() PersonalAccessTokensType {
	if o == nil || o.Type == nil {
...
// and a boolean to check if the value has been set.
func (o *PersonalAccessToken) GetTypeOk() (*PersonalAccessTokensType, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return o.Type, true
...
func (o *PersonalAccessToken) HasType() bool {
	return o != nil && o.Type != nil
}

// SetType gets a reference to the given PersonalAccessTokensType and assigns it to the Type field.
func (o *PersonalAccessToken) SetType(v PersonalAccessTokensType) {
	o.Type = &v
}
