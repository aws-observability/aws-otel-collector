...
// CreateGoogleChatTargetAudience Create a target audience.
// Create a target audience for a Google Chat organization binding in the Datadog Google Chat integration.
func (a *GoogleChatIntegrationApi) CreateGoogleChatTargetAudience(ctx _context.Context, organizationBindingId string, body GoogleChatTargetAudienceCreateRequest) (GoogleChatTargetAudienceResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue GoogleChatTargetAudienceResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.GoogleChatIntegrationApi.CreateGoogleChatTargetAudience")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/integration/google-chat/organizations/{organization_binding_id}/target-audiences"
...
// DeleteGoogleChatDelegatedUser Delete the delegated user.
// Delete the delegated user for a Google Chat organization binding from the Datadog Google Chat integration.
func (a *GoogleChatIntegrationApi) DeleteGoogleChatDelegatedUser(ctx _context.Context, organizationBindingId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.GoogleChatIntegrationApi.DeleteGoogleChatDelegatedUser")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/integration/google-chat/organizations/{organization_binding_id}/delegated-user"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{organization_binding_id}", _neturl.PathEscape(datadog.ParameterToString(organizationBindingId, "")))
...
// DeleteGoogleChatOrganization Delete a Google Chat organization binding.
// Delete a Google Chat organization binding from the Datadog Google Chat integration.
func (a *GoogleChatIntegrationApi) DeleteGoogleChatOrganization(ctx _context.Context, organizationBindingId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.GoogleChatIntegrationApi.DeleteGoogleChatOrganization")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/integration/google-chat/organizations/{organization_binding_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{organization_binding_id}", _neturl.PathEscape(datadog.ParameterToString(organizationBindingId, "")))
...
// DeleteGoogleChatTargetAudience Delete a target audience.
// Delete a target audience from a Google Chat organization binding in the Datadog Google Chat integration.
func (a *GoogleChatIntegrationApi) DeleteGoogleChatTargetAudience(ctx _context.Context, organizationBindingId string, targetAudienceId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.GoogleChatIntegrationApi.DeleteGoogleChatTargetAudience")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/integration/google-chat/organizations/{organization_binding_id}/target-audiences/{target_audience_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{organization_binding_id}", _neturl.PathEscape(datadog.ParameterToString(organizationBindingId, "")))
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{target_audience_id}", _neturl.PathEscape(datadog.ParameterToString(targetAudienceId, "")))
...
// GetGoogleChatDelegatedUser Get the delegated user.
// Get the delegated user for a Google Chat organization binding in the Datadog Google Chat integration.
func (a *GoogleChatIntegrationApi) GetGoogleChatDelegatedUser(ctx _context.Context, organizationBindingId string) (GoogleChatDelegatedUserResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue GoogleChatDelegatedUserResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.GoogleChatIntegrationApi.GetGoogleChatDelegatedUser")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// GetGoogleChatOrganization Get a Google Chat organization binding.
// Get a Google Chat organization binding from the Datadog Google Chat integration.
func (a *GoogleChatIntegrationApi) GetGoogleChatOrganization(ctx _context.Context, organizationBindingId string) (GoogleChatOrganizationResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue GoogleChatOrganizationResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.GoogleChatIntegrationApi.GetGoogleChatOrganization")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// GetGoogleChatTargetAudience Get a target audience.
// Get a target audience for a Google Chat organization binding in the Datadog Google Chat integration.
func (a *GoogleChatIntegrationApi) GetGoogleChatTargetAudience(ctx _context.Context, organizationBindingId string, targetAudienceId string) (GoogleChatTargetAudienceResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue GoogleChatTargetAudienceResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.GoogleChatIntegrationApi.GetGoogleChatTargetAudience")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// ListGoogleChatOrganizations Get all Google Chat organization bindings.
// Get a list of all Google Chat organization bindings in the Datadog Google Chat integration.
func (a *GoogleChatIntegrationApi) ListGoogleChatOrganizations(ctx _context.Context) (GoogleChatOrganizationsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue GoogleChatOrganizationsResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.GoogleChatIntegrationApi.ListGoogleChatOrganizations")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/integration/google-chat/organizations"
...
// ListGoogleChatTargetAudiences Get all target audiences.
// Get a list of all target audiences for a Google Chat organization binding in the Datadog Google Chat integration.
func (a *GoogleChatIntegrationApi) ListGoogleChatTargetAudiences(ctx _context.Context, organizationBindingId string) (GoogleChatTargetAudiencesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue GoogleChatTargetAudiencesResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.GoogleChatIntegrationApi.ListGoogleChatTargetAudiences")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// UpdateGoogleChatTargetAudience Update a target audience.
// Update a target audience for a Google Chat organization binding in the Datadog Google Chat integration.
func (a *GoogleChatIntegrationApi) UpdateGoogleChatTargetAudience(ctx _context.Context, organizationBindingId string, targetAudienceId string, body GoogleChatTargetAudienceUpdateRequest) (GoogleChatTargetAudienceResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.GoogleChatIntegrationApi.UpdateGoogleChatTargetAudience")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
