...
// GetStegadographyWidgets Get widgets from an image.
...
func (a *StegadographyApi) GetStegadographyWidgets(ctx _context.Context, image _io.Reader) (StegadographyGetWidgetsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue StegadographyGetWidgetsResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.StegadographyApi.GetStegadographyWidgets")
	if err != nil {
