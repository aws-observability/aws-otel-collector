...
// IncidentUserDataAsIncidentHandleIncludedItemResponse is a convenience function that returns IncidentUserData wrapped in IncidentHandleIncludedItemResponse.
func IncidentUserDataAsIncidentHandleIncludedItemResponse(v *IncidentUserData) IncidentHandleIncludedItemResponse {
	return IncidentHandleIncludedItemResponse{IncidentUserData: v}
}

// IncidentTypeObjectAsIncidentHandleIncludedItemResponse is a convenience function that returns IncidentTypeObject wrapped in IncidentHandleIncludedItemResponse.
func IncidentTypeObjectAsIncidentHandleIncludedItemResponse(v *IncidentTypeObject) IncidentHandleIncludedItemResponse {
	return IncidentHandleIncludedItemResponse{IncidentTypeObject: v}
}

// UnmarshalJSON turns data into one of the pointers in the struct.
func (obj *IncidentHandleIncludedItemResponse) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
...
func (obj IncidentHandleIncludedItemResponse) MarshalJSON() ([]byte, error) {
...
func (obj *IncidentHandleIncludedItemResponse) GetActualInstance() interface{} {
	if obj.IncidentUserData != nil {
