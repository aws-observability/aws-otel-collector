...
// NewRoutingRuleRelationshipsPolicyData instantiates a new RoutingRuleRelationshipsPolicyData object.
...
func NewRoutingRuleRelationshipsPolicyData(id string, typeVar RoutingRuleRelationshipsPolicyDataType) *RoutingRuleRelationshipsPolicyData {
	this := RoutingRuleRelationshipsPolicyData{}
	this.Id = id
	this.Type = typeVar
	return &this
}

// NewRoutingRuleRelationshipsPolicyDataWithDefaults instantiates a new RoutingRuleRelationshipsPolicyData object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewRoutingRuleRelationshipsPolicyDataWithDefaults() *RoutingRuleRelationshipsPolicyData {
	this := RoutingRuleRelationshipsPolicyData{}
	var typeVar RoutingRuleRelationshipsPolicyDataType = ROUTINGRULERELATIONSHIPSPOLICYDATATYPE_POLICIES
	this.Type = typeVar
	return &this
}
...
func (o *RoutingRuleRelationshipsPolicyData) GetType() RoutingRuleRelationshipsPolicyDataType {
	if o == nil {
		var ret RoutingRuleRelationshipsPolicyDataType
		return ret
	}
	return o.Type
}
