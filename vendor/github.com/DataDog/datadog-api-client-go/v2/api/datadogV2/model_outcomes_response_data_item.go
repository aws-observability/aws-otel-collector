...
// NewOutcomesResponseDataItem instantiates a new OutcomesResponseDataItem object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewOutcomesResponseDataItem() *OutcomesResponseDataItem {
	this := OutcomesResponseDataItem{}
	var typeVar OutcomeType = OUTCOMETYPE_OUTCOME
	this.Type = &typeVar
	return &this
}

// NewOutcomesResponseDataItemWithDefaults instantiates a new OutcomesResponseDataItem object.
...
func (o *OutcomesResponseDataItem) GetAttributes() OutcomesBatchResponseAttributes {
	if o == nil || o.Attributes == nil {
		var ret OutcomesBatchResponseAttributes
		return ret
	}
	return *o.Attributes
}
...
func (o *OutcomesResponseDataItem) GetRelationships() RuleOutcomeRelationships {
	if o == nil || o.Relationships == nil {
		var ret RuleOutcomeRelationships
		return ret
	}
