...
func NewAzureUCConfigsResponse(data []AzureUCConfigPair) *AzureUCConfigsResponse {
	this := AzureUCConfigsResponse{}
	this.Data = data
	return &this
}

// NewAzureUCConfigsResponseWithDefaults instantiates a new AzureUCConfigsResponse object.
