...
// NewAwsOnDemandData instantiates a new AwsOnDemandData object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewAwsOnDemandData() *AwsOnDemandData {
	this := AwsOnDemandData{}
	var typeVar AwsOnDemandType = AWSONDEMANDTYPE_AWS_RESOURCE
	this.Type = &typeVar
	return &this
}

// NewAwsOnDemandDataWithDefaults instantiates a new AwsOnDemandData object.
