...
// NewTeamPermissionSettingsResponse instantiates a new TeamPermissionSettingsResponse object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewTeamPermissionSettingsResponse() *TeamPermissionSettingsResponse {
	this := TeamPermissionSettingsResponse{}
	return &this
}

// NewTeamPermissionSettingsResponseWithDefaults instantiates a new TeamPermissionSettingsResponse object.
