...
// OnCallNotificationRuleRequestAttributes Attributes for creating or modifying an on-call notification rule.
type OnCallNotificationRuleRequestAttributes struct {
...
// NewOnCallNotificationRuleRequestAttributes instantiates a new OnCallNotificationRuleRequestAttributes object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewOnCallNotificationRuleRequestAttributes() *OnCallNotificationRuleRequestAttributes {
	this := OnCallNotificationRuleRequestAttributes{}
	var category OnCallNotificationRuleCategory = ONCALLNOTIFICATIONRULECATEGORY_HIGH_URGENCY
	this.Category = &category
	return &this
}

// NewOnCallNotificationRuleRequestAttributesWithDefaults instantiates a new OnCallNotificationRuleRequestAttributes object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewOnCallNotificationRuleRequestAttributesWithDefaults() *OnCallNotificationRuleRequestAttributes {
	this := OnCallNotificationRuleRequestAttributes{}
	var category OnCallNotificationRuleCategory = ONCALLNOTIFICATIONRULECATEGORY_HIGH_URGENCY
	this.Category = &category
	return &this
...
func (o *OnCallNotificationRuleRequestAttributes) GetCategory() OnCallNotificationRuleCategory {
...
func (o *OnCallNotificationRuleRequestAttributes) GetCategoryOk() (*OnCallNotificationRuleCategory, bool) {
	if o == nil || o.Category == nil {
		return nil, false
	}
...
func (o *OnCallNotificationRuleRequestAttributes) HasCategory() bool {
...
func (o *OnCallNotificationRuleRequestAttributes) SetCategory(v OnCallNotificationRuleCategory) {
	o.Category = &v
}

// GetChannelSettings returns the ChannelSettings field value if set, zero value otherwise.
func (o *OnCallNotificationRuleRequestAttributes) GetChannelSettings() OnCallNotificationRuleChannelSettings {
...
// and a boolean to check if the value has been set.
func (o *OnCallNotificationRuleRequestAttributes) GetChannelSettingsOk() (*OnCallNotificationRuleChannelSettings, bool) {
	if o == nil || o.ChannelSettings == nil {
		return nil, false
	}
...
func (o *OnCallNotificationRuleRequestAttributes) HasChannelSettings() bool {
...
func (o *OnCallNotificationRuleRequestAttributes) SetChannelSettings(v OnCallNotificationRuleChannelSettings) {
	o.ChannelSettings = &v
}

// GetDelayMinutes returns the DelayMinutes field value if set, zero value otherwise.
func (o *OnCallNotificationRuleRequestAttributes) GetDelayMinutes() int64 {
...
// and a boolean to check if the value has been set.
func (o *OnCallNotificationRuleRequestAttributes) GetDelayMinutesOk() (*int64, bool) {
	if o == nil || o.DelayMinutes == nil {
		return nil, false
	}
...
func (o *OnCallNotificationRuleRequestAttributes) HasDelayMinutes() bool {
...
func (o *OnCallNotificationRuleRequestAttributes) SetDelayMinutes(v int64) {
	o.DelayMinutes = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o OnCallNotificationRuleRequestAttributes) MarshalJSON() ([]byte, error) {
...
func (o *OnCallNotificationRuleRequestAttributes) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Category        *OnCallNotificationRuleCategory        `json:"category,omitempty"`
		ChannelSettings *OnCallNotificationRuleChannelSettings `json:"channel_settings,omitempty"`
		DelayMinutes    *int64                                 `json:"delay_minutes,omitempty"`
