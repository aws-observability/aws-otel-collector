...
type ApmMetricsQuery struct {
	...
	SpanKind *ApmMetricsSpanKind `json:"span_kind,omitempty"`
	// The APM metric statistic to query.
	Stat ApmMetricsStat `json:"stat"`
	// UnparsedObject contains the raw value of the object if there was an error when deserializing into the struct
	UnparsedObject       map[string]interface{} `json:"-"`
	AdditionalProperties map[string]interface{} `json:"-"`
}

// NewApmMetricsQuery instantiates a new ApmMetricsQuery object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewApmMetricsQuery(dataSource ApmMetricsDataSource, name string, stat ApmMetricsStat) *ApmMetricsQuery {
	this := ApmMetricsQuery{}
...
// NewApmMetricsQueryWithDefaults instantiates a new ApmMetricsQuery object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewApmMetricsQueryWithDefaults() *ApmMetricsQuery {
	this := ApmMetricsQuery{}
...
func (o *ApmMetricsQuery) GetDataSourceOk() (*ApmMetricsDataSource, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ApmMetricsQuery) SetDataSource(v ApmMetricsDataSource) {
	o.DataSource = v
}

// GetGroupBy returns the GroupBy field value if set, zero value otherwise.
func (o *ApmMetricsQuery) GetGroupBy() []string {
...
// and a boolean to check if the value has been set.
func (o *ApmMetricsQuery) GetGroupByOk() (*[]string, bool) {
	if o == nil || o.GroupBy == nil {
		return nil, false
	}
...
func (o *ApmMetricsQuery) HasGroupBy() bool {
	return o != nil && o.GroupBy != nil
}

// SetGroupBy gets a reference to the given []string and assigns it to the GroupBy field.
func (o *ApmMetricsQuery) SetGroupBy(v []string) {
	o.GroupBy = v
}

// GetName returns the Name field value.
func (o *ApmMetricsQuery) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ApmMetricsQuery) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *ApmMetricsQuery) SetName(v string) {
	o.Name = v
}

// GetOperationMode returns the OperationMode field value if set, zero value otherwise.
func (o *ApmMetricsQuery) GetOperationMode() string {
...
// and a boolean to check if the value has been set.
func (o *ApmMetricsQuery) GetOperationModeOk() (*string, bool) {
	if o == nil || o.OperationMode == nil {
		return nil, false
	}
...
func (o *ApmMetricsQuery) HasOperationMode() bool {
...
func (o *ApmMetricsQuery) SetOperationMode(v string) {
	o.OperationMode = &v
}

// GetOperationName returns the OperationName field value if set, zero value otherwise.
func (o *ApmMetricsQuery) GetOperationName() string {
...
// and a boolean to check if the value has been set.
func (o *ApmMetricsQuery) GetOperationNameOk() (*string, bool) {
	if o == nil || o.OperationName == nil {
		return nil, false
	}
...
func (o *ApmMetricsQuery) HasOperationName() bool {
...
func (o *ApmMetricsQuery) SetOperationName(v string) {
	o.OperationName = &v
}

// GetPeerTags returns the PeerTags field value if set, zero value otherwise.
func (o *ApmMetricsQuery) GetPeerTags() []string {
...
// and a boolean to check if the value has been set.
func (o *ApmMetricsQuery) GetPeerTagsOk() (*[]string, bool) {
	if o == nil || o.PeerTags == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *ApmMetricsQuery) GetQueryFilterOk() (*string, bool) {
	if o == nil || o.QueryFilter == nil {
		return nil, false
	}
...
func (o *ApmMetricsQuery) HasQueryFilter() bool {
...
func (o *ApmMetricsQuery) SetQueryFilter(v string) {
	o.QueryFilter = &v
}

// GetResourceHash returns the ResourceHash field value if set, zero value otherwise.
func (o *ApmMetricsQuery) GetResourceHash() string {
...
// and a boolean to check if the value has been set.
func (o *ApmMetricsQuery) GetResourceHashOk() (*string, bool) {
	if o == nil || o.ResourceHash == nil {
		return nil, false
	}
...
func (o *ApmMetricsQuery) HasResourceHash() bool {
...
func (o *ApmMetricsQuery) SetResourceHash(v string) {
	o.ResourceHash = &v
}

// GetResourceName returns the ResourceName field value if set, zero value otherwise.
func (o *ApmMetricsQuery) GetResourceName() string {
...
// and a boolean to check if the value has been set.
func (o *ApmMetricsQuery) GetResourceNameOk() (*string, bool) {
	if o == nil || o.ResourceName == nil {
		return nil, false
	}
...
func (o *ApmMetricsQuery) HasResourceName() bool {
	return o != nil && o.ResourceName != nil
}

// SetResourceName gets a reference to the given string and assigns it to the ResourceName field.
func (o *ApmMetricsQuery) SetResourceName(v string) {
	o.ResourceName = &v
}

// GetService returns the Service field value if set, zero value otherwise.
func (o *ApmMetricsQuery) GetService() string {
...
// and a boolean to check if the value has been set.
func (o *ApmMetricsQuery) GetServiceOk() (*string, bool) {
	if o == nil || o.Service == nil {
		return nil, false
	}
...
func (o *ApmMetricsQuery) HasService() bool {
	return o != nil && o.Service != nil
}

// SetService gets a reference to the given string and assigns it to the Service field.
func (o *ApmMetricsQuery) SetService(v string) {
	o.Service = &v
}

// GetSpanKind returns the SpanKind field value if set, zero value otherwise.
func (o *ApmMetricsQuery) GetSpanKind() ApmMetricsSpanKind {
	if o == nil || o.SpanKind == nil {
		var ret ApmMetricsSpanKind
		return ret
	}
	return *o.SpanKind
}
...
// and a boolean to check if the value has been set.
func (o *ApmMetricsQuery) GetSpanKindOk() (*ApmMetricsSpanKind, bool) {
	if o == nil || o.SpanKind == nil {
		return nil, false
	}
...
func (o *ApmMetricsQuery) HasSpanKind() bool {
	return o != nil && o.SpanKind != nil
}

// SetSpanKind gets a reference to the given ApmMetricsSpanKind and assigns it to the SpanKind field.
func (o *ApmMetricsQuery) SetSpanKind(v ApmMetricsSpanKind) {
	o.SpanKind = &v
}

// GetStat returns the Stat field value.
func (o *ApmMetricsQuery) GetStat() ApmMetricsStat {
	if o == nil {
		var ret ApmMetricsStat
		return ret
	}
	return o.Stat
}
...
// and a boolean to check if the value has been set.
func (o *ApmMetricsQuery) GetStatOk() (*ApmMetricsStat, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Stat, true
...
func (o *ApmMetricsQuery) SetStat(v ApmMetricsStat) {
	o.Stat = v
}

// MarshalJSON serializes the struct using spec logic.
func (o ApmMetricsQuery) MarshalJSON() ([]byte, error) {
