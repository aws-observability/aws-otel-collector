...
func NewPlaylist(data PlaylistData) *Playlist {
	this := Playlist{}
	this.Data = data
	return &this
}
...
func (o *Playlist) GetData() PlaylistData {
	if o == nil {
...
func (o *Playlist) GetDataOk() (*PlaylistData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *Playlist) SetData(v PlaylistData) {
	o.Data = v
}
...
func (o *Playlist) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *PlaylistData `json:"data"`
	}{}
