...
// SecurityMonitoringDatasetDependenciesResponse Response listing the dependents of each requested dataset.
type SecurityMonitoringDatasetDependenciesResponse struct {
	// The list of dataset dependents entries.
	Data []SecurityMonitoringDatasetDependentsData `json:"data"`
...
func NewSecurityMonitoringDatasetDependenciesResponse(data []SecurityMonitoringDatasetDependentsData) *SecurityMonitoringDatasetDependenciesResponse {
...
func (o *SecurityMonitoringDatasetDependenciesResponse) GetData() []SecurityMonitoringDatasetDependentsData {
	if o == nil {
		var ret []SecurityMonitoringDatasetDependentsData
		return ret
	}
	return o.Data
}
...
func (o *SecurityMonitoringDatasetDependenciesResponse) GetDataOk() (*[]SecurityMonitoringDatasetDependentsData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *SecurityMonitoringDatasetDependenciesResponse) SetData(v []SecurityMonitoringDatasetDependentsData) {
	o.Data = v
}
