...
// CoverageSummaryServiceStats Coverage statistics for a specific service.
type CoverageSummaryServiceStats struct {
...
// NewCoverageSummaryServiceStats instantiates a new CoverageSummaryServiceStats object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewCoverageSummaryServiceStats() *CoverageSummaryServiceStats {
	this := CoverageSummaryServiceStats{}
	return &this
}

// NewCoverageSummaryServiceStatsWithDefaults instantiates a new CoverageSummaryServiceStats object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewCoverageSummaryServiceStatsWithDefaults() *CoverageSummaryServiceStats {
	this := CoverageSummaryServiceStats{}
	return &this
}

// GetEvaluatedFlagsCount returns the EvaluatedFlagsCount field value if set, zero value otherwise.
func (o *CoverageSummaryServiceStats) GetEvaluatedFlagsCount() int64 {
...
func (o *CoverageSummaryServiceStats) GetEvaluatedFlagsCountOk() (*int64, bool) {
	if o == nil || o.EvaluatedFlagsCount == nil {
		return nil, false
	}
...
func (o *CoverageSummaryServiceStats) HasEvaluatedFlagsCount() bool {
...
func (o *CoverageSummaryServiceStats) SetEvaluatedFlagsCount(v int64) {
...
func (o *CoverageSummaryServiceStats) GetEvaluatedReportsCount() int64 {
...
// and a boolean to check if the value has been set.
func (o *CoverageSummaryServiceStats) GetEvaluatedReportsCountOk() (*int64, bool) {
	if o == nil || o.EvaluatedReportsCount == nil {
		return nil, false
	}
...
func (o *CoverageSummaryServiceStats) HasEvaluatedReportsCount() bool {
...
func (o *CoverageSummaryServiceStats) SetEvaluatedReportsCount(v int64) {
...
func (o *CoverageSummaryServiceStats) GetPatchCoverage() float64 {
...
func (o *CoverageSummaryServiceStats) GetPatchCoverageOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CoverageSummaryServiceStats) HasPatchCoverage() bool {
...
func (o *CoverageSummaryServiceStats) GetTotalCoverage() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *CoverageSummaryServiceStats) GetTotalCoverageOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CoverageSummaryServiceStats) HasTotalCoverage() bool {
...
func (o *CoverageSummaryServiceStats) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		EvaluatedFlagsCount   *int64                  `json:"evaluated_flags_count,omitempty"`
		EvaluatedReportsCount *int64                  `json:"evaluated_reports_count,omitempty"`
		PatchCoverage         datadog.NullableFloat64 `json:"patch_coverage,omitempty"`
