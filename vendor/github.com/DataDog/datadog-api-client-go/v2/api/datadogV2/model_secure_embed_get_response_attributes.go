...
// SecureEmbedGetResponseAttributes Attributes of an existing secure embed shared dashboard.
type SecureEmbedGetResponseAttributes struct {
	// Creation timestamp.
...
// NewSecureEmbedGetResponseAttributes instantiates a new SecureEmbedGetResponseAttributes object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewSecureEmbedGetResponseAttributes() *SecureEmbedGetResponseAttributes {
	this := SecureEmbedGetResponseAttributes{}
	return &this
}

// NewSecureEmbedGetResponseAttributesWithDefaults instantiates a new SecureEmbedGetResponseAttributes object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewSecureEmbedGetResponseAttributesWithDefaults() *SecureEmbedGetResponseAttributes {
	this := SecureEmbedGetResponseAttributes{}
	return &this
}

// GetCreatedAt returns the CreatedAt field value if set, zero value otherwise.
func (o *SecureEmbedGetResponseAttributes) GetCreatedAt() string {
...
func (o *SecureEmbedGetResponseAttributes) GetCreatedAtOk() (*string, bool) {
	if o == nil || o.CreatedAt == nil {
		return nil, false
	}
...
func (o *SecureEmbedGetResponseAttributes) HasCreatedAt() bool {
	return o != nil && o.CreatedAt != nil
}

// SetCreatedAt gets a reference to the given string and assigns it to the CreatedAt field.
func (o *SecureEmbedGetResponseAttributes) SetCreatedAt(v string) {
	o.CreatedAt = &v
}

// GetCredentialSuffix returns the CredentialSuffix field value if set, zero value otherwise.
func (o *SecureEmbedGetResponseAttributes) GetCredentialSuffix() string {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedGetResponseAttributes) GetCredentialSuffixOk() (*string, bool) {
	if o == nil || o.CredentialSuffix == nil {
		return nil, false
	}
...
func (o *SecureEmbedGetResponseAttributes) HasCredentialSuffix() bool {
...
func (o *SecureEmbedGetResponseAttributes) SetCredentialSuffix(v string) {
	o.CredentialSuffix = &v
}

// GetDashboardId returns the DashboardId field value if set, zero value otherwise.
func (o *SecureEmbedGetResponseAttributes) GetDashboardId() string {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedGetResponseAttributes) GetDashboardIdOk() (*string, bool) {
	if o == nil || o.DashboardId == nil {
		return nil, false
	}
...
func (o *SecureEmbedGetResponseAttributes) HasDashboardId() bool {
...
func (o *SecureEmbedGetResponseAttributes) SetDashboardId(v string) {
	o.DashboardId = &v
}

// GetGlobalTime returns the GlobalTime field value if set, zero value otherwise.
func (o *SecureEmbedGetResponseAttributes) GetGlobalTime() SecureEmbedGlobalTime {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedGetResponseAttributes) GetGlobalTimeOk() (*SecureEmbedGlobalTime, bool) {
	if o == nil || o.GlobalTime == nil {
		return nil, false
	}
...
func (o *SecureEmbedGetResponseAttributes) HasGlobalTime() bool {
...
func (o *SecureEmbedGetResponseAttributes) SetGlobalTime(v SecureEmbedGlobalTime) {
	o.GlobalTime = &v
}

// GetGlobalTimeSelectable returns the GlobalTimeSelectable field value if set, zero value otherwise.
func (o *SecureEmbedGetResponseAttributes) GetGlobalTimeSelectable() bool {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedGetResponseAttributes) GetGlobalTimeSelectableOk() (*bool, bool) {
	if o == nil || o.GlobalTimeSelectable == nil {
		return nil, false
	}
...
func (o *SecureEmbedGetResponseAttributes) HasGlobalTimeSelectable() bool {
...
func (o *SecureEmbedGetResponseAttributes) SetGlobalTimeSelectable(v bool) {
	o.GlobalTimeSelectable = &v
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *SecureEmbedGetResponseAttributes) GetId() string {
	if o == nil || o.Id == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedGetResponseAttributes) GetIdOk() (*string, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return o.Id, true
...
func (o *SecureEmbedGetResponseAttributes) HasId() bool {
	return o != nil && o.Id != nil
}

// SetId gets a reference to the given string and assigns it to the Id field.
func (o *SecureEmbedGetResponseAttributes) SetId(v string) {
	o.Id = &v
}

// GetSelectableTemplateVars returns the SelectableTemplateVars field value if set, zero value otherwise.
func (o *SecureEmbedGetResponseAttributes) GetSelectableTemplateVars() []SecureEmbedSelectableTemplateVariable {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedGetResponseAttributes) GetSelectableTemplateVarsOk() (*[]SecureEmbedSelectableTemplateVariable, bool) {
	if o == nil || o.SelectableTemplateVars == nil {
		return nil, false
	}
...
func (o *SecureEmbedGetResponseAttributes) HasSelectableTemplateVars() bool {
...
func (o *SecureEmbedGetResponseAttributes) SetSelectableTemplateVars(v []SecureEmbedSelectableTemplateVariable) {
	o.SelectableTemplateVars = v
}

// GetShareType returns the ShareType field value if set, zero value otherwise.
func (o *SecureEmbedGetResponseAttributes) GetShareType() SecureEmbedShareType {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedGetResponseAttributes) GetShareTypeOk() (*SecureEmbedShareType, bool) {
	if o == nil || o.ShareType == nil {
		return nil, false
	}
...
func (o *SecureEmbedGetResponseAttributes) HasShareType() bool {
...
func (o *SecureEmbedGetResponseAttributes) SetShareType(v SecureEmbedShareType) {
	o.ShareType = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *SecureEmbedGetResponseAttributes) GetStatus() SecureEmbedStatus {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedGetResponseAttributes) GetStatusOk() (*SecureEmbedStatus, bool) {
	if o == nil || o.Status == nil {
		return nil, false
	}
...
func (o *SecureEmbedGetResponseAttributes) HasStatus() bool {
	return o != nil && o.Status != nil
}

// SetStatus gets a reference to the given SecureEmbedStatus and assigns it to the Status field.
func (o *SecureEmbedGetResponseAttributes) SetStatus(v SecureEmbedStatus) {
	o.Status = &v
}

// GetTitle returns the Title field value if set, zero value otherwise.
func (o *SecureEmbedGetResponseAttributes) GetTitle() string {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedGetResponseAttributes) GetTitleOk() (*string, bool) {
	if o == nil || o.Title == nil {
		return nil, false
	}
	return o.Title, true
...
func (o *SecureEmbedGetResponseAttributes) HasTitle() bool {
	return o != nil && o.Title != nil
}

// SetTitle gets a reference to the given string and assigns it to the Title field.
func (o *SecureEmbedGetResponseAttributes) SetTitle(v string) {
	o.Title = &v
}

// GetToken returns the Token field value if set, zero value otherwise.
func (o *SecureEmbedGetResponseAttributes) GetToken() string {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedGetResponseAttributes) GetTokenOk() (*string, bool) {
	if o == nil || o.Token == nil {
		return nil, false
	}
	return o.Token, true
...
func (o *SecureEmbedGetResponseAttributes) HasToken() bool {
	return o != nil && o.Token != nil
}

// SetToken gets a reference to the given string and assigns it to the Token field.
func (o *SecureEmbedGetResponseAttributes) SetToken(v string) {
	o.Token = &v
}

// GetUrl returns the Url field value if set, zero value otherwise.
func (o *SecureEmbedGetResponseAttributes) GetUrl() string {
	if o == nil || o.Url == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedGetResponseAttributes) GetUrlOk() (*string, bool) {
	if o == nil || o.Url == nil {
		return nil, false
	}
	return o.Url, true
...
func (o *SecureEmbedGetResponseAttributes) HasUrl() bool {
	return o != nil && o.Url != nil
}

// SetUrl gets a reference to the given string and assigns it to the Url field.
func (o *SecureEmbedGetResponseAttributes) SetUrl(v string) {
	o.Url = &v
}

// GetViewingPreferences returns the ViewingPreferences field value if set, zero value otherwise.
func (o *SecureEmbedGetResponseAttributes) GetViewingPreferences() SecureEmbedViewingPreferences {
...
// and a boolean to check if the value has been set.
func (o *SecureEmbedGetResponseAttributes) GetViewingPreferencesOk() (*SecureEmbedViewingPreferences, bool) {
	if o == nil || o.ViewingPreferences == nil {
		return nil, false
	}
...
func (o *SecureEmbedGetResponseAttributes) HasViewingPreferences() bool {
...
func (o *SecureEmbedGetResponseAttributes) SetViewingPreferences(v SecureEmbedViewingPreferences) {
	o.ViewingPreferences = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o SecureEmbedGetResponseAttributes) MarshalJSON() ([]byte, error) {
...
func (o *SecureEmbedGetResponseAttributes) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		CreatedAt              *string                                 `json:"created_at,omitempty"`
		CredentialSuffix       *string                                 `json:"credential_suffix,omitempty"`
		DashboardId            *string                                 `json:"dashboard_id,omitempty"`
