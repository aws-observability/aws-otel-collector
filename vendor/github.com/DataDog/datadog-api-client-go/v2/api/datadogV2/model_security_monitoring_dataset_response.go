...
// SecurityMonitoringDatasetResponse Response containing a single Cloud SIEM dataset.
...
func NewSecurityMonitoringDatasetResponse(data SecurityMonitoringDatasetData) *SecurityMonitoringDatasetResponse {
...
func (o *SecurityMonitoringDatasetResponse) GetData() SecurityMonitoringDatasetData {
	if o == nil {
...
func (o *SecurityMonitoringDatasetResponse) GetDataOk() (*SecurityMonitoringDatasetData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *SecurityMonitoringDatasetResponse) SetData(v SecurityMonitoringDatasetData) {
	o.Data = v
}
