...
// Maintenance Response object for a single maintenance.
type Maintenance struct {
	// The data object for a maintenance.
	Data *MaintenanceData `json:"data,omitempty"`
...
func (o *Maintenance) GetData() MaintenanceData {
	if o == nil || o.Data == nil {
...
func (o *Maintenance) GetDataOk() (*MaintenanceData, bool) {
	if o == nil || o.Data == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *Maintenance) HasData() bool {
	return o != nil && o.Data != nil
}

// SetData gets a reference to the given MaintenanceData and assigns it to the Data field.
func (o *Maintenance) SetData(v MaintenanceData) {
	o.Data = &v
}

// GetIncluded returns the Included field value if set, zero value otherwise.
func (o *Maintenance) GetIncluded() []DegradationIncluded {
...
// and a boolean to check if the value has been set.
func (o *Maintenance) GetIncludedOk() (*[]DegradationIncluded, bool) {
	if o == nil || o.Included == nil {
		return nil, false
	}
...
func (o *Maintenance) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data     *MaintenanceData      `json:"data,omitempty"`
		Included []DegradationIncluded `json:"included,omitempty"`
	}{}
