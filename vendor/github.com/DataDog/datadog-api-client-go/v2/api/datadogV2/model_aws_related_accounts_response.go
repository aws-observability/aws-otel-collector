...
// NewAWSRelatedAccountsResponse instantiates a new AWSRelatedAccountsResponse object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewAWSRelatedAccountsResponse() *AWSRelatedAccountsResponse {
	this := AWSRelatedAccountsResponse{}
	return &this
}

// NewAWSRelatedAccountsResponseWithDefaults instantiates a new AWSRelatedAccountsResponse object.
