...
// PatchDegradationRequestDataAttributesComponentsAffectedItems A component affected by a degradation.
...
func NewPatchDegradationRequestDataAttributesComponentsAffectedItems(id uuid.UUID, status StatusPagesComponentDataAttributesStatus) *PatchDegradationRequestDataAttributesComponentsAffectedItems {
...
func (o *PatchDegradationRequestDataAttributesComponentsAffectedItems) GetId() uuid.UUID {
	if o == nil {
		var ret uuid.UUID
		return ret
	}
...
func (o *PatchDegradationRequestDataAttributesComponentsAffectedItems) GetIdOk() (*uuid.UUID, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *PatchDegradationRequestDataAttributesComponentsAffectedItems) SetId(v uuid.UUID) {
	o.Id = v
}
