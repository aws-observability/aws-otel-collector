...
// CreateAWSAccountCCMConfig Create AWS CCM config.
...
func (a *AWSIntegrationApi) CreateAWSAccountCCMConfig(ctx _context.Context, awsAccountConfigId string, body AWSCcmConfigRequest) (AWSCcmConfigResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue AWSCcmConfigResponse
	)

	operationId := "v2.CreateAWSAccountCCMConfig"
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.AWSIntegrationApi.CreateAWSAccountCCMConfig")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/integration/aws/accounts/{aws_account_config_id}/ccm_config"
...
func (a *AWSIntegrationApi) CreateAWSEventBridgeSource(ctx _context.Context, body AWSEventBridgeCreateRequest) (AWSEventBridgeCreateResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.AWSIntegrationApi.CreateAWSEventBridgeSource")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/integration/aws/event_bridge"
...
// DeleteAWSAccountCCMConfig Delete AWS CCM config.
// Delete the Cloud Cost Management config for an AWS Account Integration Config using Cost and Usage Report
// (CUR) 2.0 by config ID.
func (a *AWSIntegrationApi) DeleteAWSAccountCCMConfig(ctx _context.Context, awsAccountConfigId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)

	operationId := "v2.DeleteAWSAccountCCMConfig"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.AWSIntegrationApi.DeleteAWSAccountCCMConfig")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *AWSIntegrationApi) DeleteAWSEventBridgeSource(ctx _context.Context, body AWSEventBridgeDeleteRequest) (AWSEventBridgeDeleteResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.AWSIntegrationApi.DeleteAWSEventBridgeSource")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// GetAWSAccountCCMConfig Get AWS CCM config.
// Get the Cloud Cost Management config for an AWS Account Integration Config using Cost and Usage Report
// (CUR) 2.0 by config ID.
func (a *AWSIntegrationApi) GetAWSAccountCCMConfig(ctx _context.Context, awsAccountConfigId string) (AWSCcmConfigResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue AWSCcmConfigResponse
	...
	operationId := "v2.GetAWSAccountCCMConfig"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.AWSIntegrationApi.GetAWSAccountCCMConfig")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *AWSIntegrationApi) ListAWSEventBridgeSources(ctx _context.Context) (AWSEventBridgeListResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.AWSIntegrationApi.ListAWSEventBridgeSources")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// UpdateAWSAccountCCMConfig Update AWS CCM config.
// Update the Cloud Cost Management config for an AWS Account Integration Config using Cost and Usage Report
// (CUR) 2.0 by config ID.
func (a *AWSIntegrationApi) UpdateAWSAccountCCMConfig(ctx _context.Context, awsAccountConfigId string, body AWSCcmConfigRequest) (AWSCcmConfigResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPatch
		localVarPostBody    interface{}
		localVarReturnValue AWSCcmConfigResponse
	...
	operationId := "v2.UpdateAWSAccountCCMConfig"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.AWSIntegrationApi.UpdateAWSAccountCCMConfig")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
