...
// IntegrationLinks Links for the integration resource.
...
func (o *IntegrationLinks) GetSelf() string {
	if o == nil || o.Self == nil {
		var ret string
		return ret
	}
...
func (o *IntegrationLinks) GetSelfOk() (*string, bool) {
	if o == nil || o.Self == nil {
		return nil, false
	}
	return o.Self, true
...
func (o *IntegrationLinks) SetSelf(v string) {
	o.Self = &v
}
...
func (o *IntegrationLinks) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Self *string `json:"self,omitempty"`
	}{}
