...
type FormPublicationResponse struct {
	...
	Data FormPublicationData `json:"data"`
...
func NewFormPublicationResponse(data FormPublicationData) *FormPublicationResponse {
...
func (o *FormPublicationResponse) GetData() FormPublicationData {
	if o == nil {
		var ret FormPublicationData
		return ret
	}
	return o.Data
}
...
func (o *FormPublicationResponse) GetDataOk() (*FormPublicationData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *FormPublicationResponse) SetData(v FormPublicationData) {
	o.Data = v
}
