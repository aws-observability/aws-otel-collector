...
// NewAzureScanOptionsDataAttributes instantiates a new AzureScanOptionsDataAttributes object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewAzureScanOptionsDataAttributes() *AzureScanOptionsDataAttributes {
	this := AzureScanOptionsDataAttributes{}
	return &this
}

// NewAzureScanOptionsDataAttributesWithDefaults instantiates a new AzureScanOptionsDataAttributes object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewAzureScanOptionsDataAttributesWithDefaults() *AzureScanOptionsDataAttributes {
	this := AzureScanOptionsDataAttributes{}
	return &this
}

// GetComplianceHost returns the ComplianceHost field value if set, zero value otherwise.
func (o *AzureScanOptionsDataAttributes) GetComplianceHost() bool {
...
func (o *AzureScanOptionsDataAttributes) GetComplianceHostOk() (*bool, bool) {
	if o == nil || o.ComplianceHost == nil {
		return nil, false
	}
...
func (o *AzureScanOptionsDataAttributes) HasComplianceHost() bool {
...
func (o *AzureScanOptionsDataAttributes) GetVulnContainersOs() bool {
...
// and a boolean to check if the value has been set.
func (o *AzureScanOptionsDataAttributes) GetVulnContainersOsOk() (*bool, bool) {
	if o == nil || o.VulnContainersOs == nil {
		return nil, false
	}
...
func (o *AzureScanOptionsDataAttributes) HasVulnContainersOs() bool {
...
func (o *AzureScanOptionsDataAttributes) SetVulnContainersOs(v bool) {
	o.VulnContainersOs = &v
}

// GetVulnHostOs returns the VulnHostOs field value if set, zero value otherwise.
func (o *AzureScanOptionsDataAttributes) GetVulnHostOs() bool {
...
// and a boolean to check if the value has been set.
func (o *AzureScanOptionsDataAttributes) GetVulnHostOsOk() (*bool, bool) {
	if o == nil || o.VulnHostOs == nil {
		return nil, false
	}
...
func (o *AzureScanOptionsDataAttributes) HasVulnHostOs() bool {
	return o != nil && o.VulnHostOs != nil
}

// SetVulnHostOs gets a reference to the given bool and assigns it to the VulnHostOs field.
func (o *AzureScanOptionsDataAttributes) SetVulnHostOs(v bool) {
	o.VulnHostOs = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o AzureScanOptionsDataAttributes) MarshalJSON() ([]byte, error) {
