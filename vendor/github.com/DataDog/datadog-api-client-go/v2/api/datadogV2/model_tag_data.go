...
// TagData A tag resource associated with an app.
type TagData struct {
	// The name of the tag.
	Id string `json:"id"`
...
func NewTagData(id string, typeVar TagDataType) *TagData {
	this := TagData{}
	this.Id = id
	this.Type = typeVar
	return &this
...
func (o *TagData) GetType() TagDataType {
	if o == nil {
		var ret TagDataType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TagData) GetTypeOk() (*TagDataType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *TagData) SetType(v TagDataType) {
	o.Type = v
}
...
func (o *TagData) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Id   *string      `json:"id"`
		Type *TagDataType `json:"type"`
	}{}
