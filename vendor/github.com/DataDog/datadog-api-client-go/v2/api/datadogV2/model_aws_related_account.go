...
// NewAWSRelatedAccount instantiates a new AWSRelatedAccount object.
...
func NewAWSRelatedAccount(id string, typeVar AWSRelatedAccountType) *AWSRelatedAccount {
	this := AWSRelatedAccount{}
	this.Id = id
	this.Type = typeVar
	return &this
}

// NewAWSRelatedAccountWithDefaults instantiates a new AWSRelatedAccount object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewAWSRelatedAccountWithDefaults() *AWSRelatedAccount {
	this := AWSRelatedAccount{}
	var typeVar AWSRelatedAccountType = AWSRELATEDACCOUNTTYPE_AWS_ACCOUNT
	this.Type = typeVar
	return &this
}
...
func (o *AWSRelatedAccount) GetAttributes() AWSRelatedAccountAttributes {
	if o == nil || o.Attributes == nil {
		var ret AWSRelatedAccountAttributes
		return ret
	}
	return *o.Attributes
}
