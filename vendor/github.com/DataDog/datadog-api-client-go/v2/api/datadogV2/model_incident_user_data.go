...
// NewIncidentUserData instantiates a new IncidentUserData object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewIncidentUserData() *IncidentUserData {
	this := IncidentUserData{}
	var typeVar UsersType = USERSTYPE_USERS
	this.Type = &typeVar
	return &this
}

// NewIncidentUserDataWithDefaults instantiates a new IncidentUserData object.
...
func (o *IncidentUserData) GetAttributes() IncidentUserAttributes {
	if o == nil || o.Attributes == nil {
		var ret IncidentUserAttributes
		return ret
	}
	return *o.Attributes
}
