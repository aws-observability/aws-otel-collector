...
func NewObservabilityPipelineSplunkTcpSource(id string, typeVar ObservabilityPipelineSplunkTcpSourceType) *ObservabilityPipelineSplunkTcpSource {
	this := ObservabilityPipelineSplunkTcpSource{}
	this.Id = id
	this.Type = typeVar
	return &this
}

// NewObservabilityPipelineSplunkTcpSourceWithDefaults instantiates a new ObservabilityPipelineSplunkTcpSource object.
...
func NewObservabilityPipelineSplunkTcpSourceWithDefaults() *ObservabilityPipelineSplunkTcpSource {
	this := ObservabilityPipelineSplunkTcpSource{}
	var typeVar ObservabilityPipelineSplunkTcpSourceType = OBSERVABILITYPIPELINESPLUNKTCPSOURCETYPE_SPLUNK_TCP
	this.Type = typeVar
	return &this
}
...
func (o *ObservabilityPipelineSplunkTcpSource) GetType() ObservabilityPipelineSplunkTcpSourceType {
	if o == nil {
		var ret ObservabilityPipelineSplunkTcpSourceType
		return ret
	}
	return o.Type
}
