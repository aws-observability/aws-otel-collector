...
// NewListAPIsResponseMeta instantiates a new ListAPIsResponseMeta object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewListAPIsResponseMeta() *ListAPIsResponseMeta {
	this := ListAPIsResponseMeta{}
	return &this
}

// NewListAPIsResponseMetaWithDefaults instantiates a new ListAPIsResponseMeta object.
...
func (o *ListAPIsResponseMeta) GetPagination() ListAPIsResponseMetaPagination {
	if o == nil || o.Pagination == nil {
		var ret ListAPIsResponseMetaPagination
		return ret
	}
	return *o.Pagination
}
