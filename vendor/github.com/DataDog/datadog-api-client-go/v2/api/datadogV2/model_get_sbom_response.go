...
// NewGetSBOMResponse instantiates a new GetSBOMResponse object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewGetSBOMResponse(data SBOM) *GetSBOMResponse {
	this := GetSBOMResponse{}
	this.Data = data
	return &this
}

// NewGetSBOMResponseWithDefaults instantiates a new GetSBOMResponse object.
