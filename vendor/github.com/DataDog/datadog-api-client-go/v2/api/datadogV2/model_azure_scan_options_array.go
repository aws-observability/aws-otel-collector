...
func NewAzureScanOptionsArray(data []AzureScanOptionsData) *AzureScanOptionsArray {
	this := AzureScanOptionsArray{}
	this.Data = data
	return &this
}

// NewAzureScanOptionsArrayWithDefaults instantiates a new AzureScanOptionsArray object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewAzureScanOptionsArrayWithDefaults() *AzureScanOptionsArray {
	this := AzureScanOptionsArray{}
	return &this
}
...
func (o *AzureScanOptionsArray) GetDataOk() (*[]AzureScanOptionsData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *AzureScanOptionsArray) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *[]AzureScanOptionsData `json:"data"`
	}{}
