...
// FleetAgentsResponseMeta Metadata for the list of agents response.
type FleetAgentsResponseMeta struct {
...
// NewFleetAgentsResponseMeta instantiates a new FleetAgentsResponseMeta object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewFleetAgentsResponseMeta() *FleetAgentsResponseMeta {
	this := FleetAgentsResponseMeta{}
	return &this
}

// NewFleetAgentsResponseMetaWithDefaults instantiates a new FleetAgentsResponseMeta object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewFleetAgentsResponseMetaWithDefaults() *FleetAgentsResponseMeta {
	this := FleetAgentsResponseMeta{}
	return &this
}

// GetTotalFilteredCount returns the TotalFilteredCount field value if set, zero value otherwise.
func (o *FleetAgentsResponseMeta) GetTotalFilteredCount() int64 {
...
func (o *FleetAgentsResponseMeta) GetTotalFilteredCountOk() (*int64, bool) {
	if o == nil || o.TotalFilteredCount == nil {
		return nil, false
	}
...
func (o *FleetAgentsResponseMeta) HasTotalFilteredCount() bool {
...
func (o *FleetAgentsResponseMeta) SetTotalFilteredCount(v int64) {
	o.TotalFilteredCount = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o FleetAgentsResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o *FleetAgentsResponseMeta) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		TotalFilteredCount *int64 `json:"total_filtered_count,omitempty"`
	}{}
