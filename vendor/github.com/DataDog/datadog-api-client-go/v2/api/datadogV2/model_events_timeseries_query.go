...
func (o *EventsTimeseriesQuery) GetCrossOrgUuids() []string {
...
// and a boolean to check if the value has been set.
func (o *EventsTimeseriesQuery) GetCrossOrgUuidsOk() (*[]string, bool) {
	if o == nil || o.CrossOrgUuids == nil {
		return nil, false
	}
...
func (o *EventsTimeseriesQuery) HasCrossOrgUuids() bool {
...
func (o *EventsTimeseriesQuery) SetCrossOrgUuids(v []string) {
	o.CrossOrgUuids = v
}
