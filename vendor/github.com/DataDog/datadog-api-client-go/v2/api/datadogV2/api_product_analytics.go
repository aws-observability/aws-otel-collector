...
func (a *ProductAnalyticsApi) SubmitProductAnalyticsEvent(ctx _context.Context, body ProductAnalyticsServerSideEventItem) (interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.ProductAnalyticsApi.SubmitProductAnalyticsEvent")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/prodlytics"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 || localVarHTTPResponse.StatusCode == 401 || localVarHTTPResponse.StatusCode == 403 || localVarHTTPResponse.StatusCode == 408 || localVarHTTPResponse.StatusCode == 413 || localVarHTTPResponse.StatusCode == 429 || localVarHTTPResponse.StatusCode == 500 || localVarHTTPResponse.StatusCode == 503 {
			var v ProductAnalyticsServerSideEventErrors
			err = a.Client.Decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				return localVarReturnValue, localVarHTTPResponse, newErr
			}
...
// NewProductAnalyticsApi Returns NewProductAnalyticsApi.
func NewProductAnalyticsApi(client *datadog.APIClient) *ProductAnalyticsApi {
	return &ProductAnalyticsApi{
		Client: client,
	}
}
