...
// NewListDevicesResponseMetadataPage instantiates a new ListDevicesResponseMetadataPage object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewListDevicesResponseMetadataPage() *ListDevicesResponseMetadataPage {
	this := ListDevicesResponseMetadataPage{}
	return &this
}

// NewListDevicesResponseMetadataPageWithDefaults instantiates a new ListDevicesResponseMetadataPage object.
