...
func NewCreateUploadResponse() *CreateUploadResponse {
...
func (o *CreateUploadResponse) GetData() CreateUploadResponseData {
	if o == nil || o.Data == nil {
		var ret CreateUploadResponseData
		return ret
	}
	return *o.Data
}
...
func (o *CreateUploadResponse) GetDataOk() (*CreateUploadResponseData, bool) {
	if o == nil || o.Data == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *CreateUploadResponse) HasData() bool {
	return o != nil && o.Data != nil
}

// SetData gets a reference to the given CreateUploadResponseData and assigns it to the Data field.
func (o *CreateUploadResponse) SetData(v CreateUploadResponseData) {
	o.Data = &v
}
...
func (o *CreateUploadResponse) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *CreateUploadResponseData `json:"data,omitempty"`
	}{}
