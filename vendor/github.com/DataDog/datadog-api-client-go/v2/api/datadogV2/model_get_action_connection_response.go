...
// NewGetActionConnectionResponse instantiates a new GetActionConnectionResponse object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewGetActionConnectionResponse() *GetActionConnectionResponse {
	this := GetActionConnectionResponse{}
	return &this
}

// NewGetActionConnectionResponseWithDefaults instantiates a new GetActionConnectionResponse object.
