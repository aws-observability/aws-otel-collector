...
func NewTableRowResourceArray(data []TableRowResourceData) *TableRowResourceArray {
	this := TableRowResourceArray{}
	this.Data = data
	return &this
}

// NewTableRowResourceArrayWithDefaults instantiates a new TableRowResourceArray object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewTableRowResourceArrayWithDefaults() *TableRowResourceArray {
	this := TableRowResourceArray{}
	return &this
}
...
func (o *TableRowResourceArray) GetDataOk() (*[]TableRowResourceData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *TableRowResourceArray) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *[]TableRowResourceData `json:"data"`
	}{}
