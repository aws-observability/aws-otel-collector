...
// ApplicationSecurityPolicyMetadata Metadata associated with the WAF policy.
type ApplicationSecurityPolicyMetadata struct {
...
// NewApplicationSecurityPolicyMetadata instantiates a new ApplicationSecurityPolicyMetadata object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewApplicationSecurityPolicyMetadata() *ApplicationSecurityPolicyMetadata {
	this := ApplicationSecurityPolicyMetadata{}
	return &this
}

// NewApplicationSecurityPolicyMetadataWithDefaults instantiates a new ApplicationSecurityPolicyMetadata object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewApplicationSecurityPolicyMetadataWithDefaults() *ApplicationSecurityPolicyMetadata {
	this := ApplicationSecurityPolicyMetadata{}
	return &this
}

// GetAddedAt returns the AddedAt field value if set, zero value otherwise.
func (o *ApplicationSecurityPolicyMetadata) GetAddedAt() time.Time {
...
func (o *ApplicationSecurityPolicyMetadata) GetAddedAtOk() (*time.Time, bool) {
	if o == nil || o.AddedAt == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *ApplicationSecurityPolicyMetadata) GetAddedByOk() (*string, bool) {
	if o == nil || o.AddedBy == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *ApplicationSecurityPolicyMetadata) GetAddedByNameOk() (*string, bool) {
	if o == nil || o.AddedByName == nil {
		return nil, false
	}
...
func (o *ApplicationSecurityPolicyMetadata) HasAddedByName() bool {
...
func (o *ApplicationSecurityPolicyMetadata) SetAddedByName(v string) {
	o.AddedByName = &v
}

// GetModifiedAt returns the ModifiedAt field value if set, zero value otherwise.
func (o *ApplicationSecurityPolicyMetadata) GetModifiedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ApplicationSecurityPolicyMetadata) GetModifiedAtOk() (*time.Time, bool) {
	if o == nil || o.ModifiedAt == nil {
		return nil, false
	}
...
func (o *ApplicationSecurityPolicyMetadata) HasModifiedAt() bool {
	return o != nil && o.ModifiedAt != nil
}

// SetModifiedAt gets a reference to the given time.Time and assigns it to the ModifiedAt field.
func (o *ApplicationSecurityPolicyMetadata) SetModifiedAt(v time.Time) {
	o.ModifiedAt = &v
}

// GetModifiedBy returns the ModifiedBy field value if set, zero value otherwise.
func (o *ApplicationSecurityPolicyMetadata) GetModifiedBy() string {
...
// and a boolean to check if the value has been set.
func (o *ApplicationSecurityPolicyMetadata) GetModifiedByOk() (*string, bool) {
	if o == nil || o.ModifiedBy == nil {
		return nil, false
	}
...
func (o *ApplicationSecurityPolicyMetadata) HasModifiedBy() bool {
	return o != nil && o.ModifiedBy != nil
}

// SetModifiedBy gets a reference to the given string and assigns it to the ModifiedBy field.
func (o *ApplicationSecurityPolicyMetadata) SetModifiedBy(v string) {
	o.ModifiedBy = &v
}

// GetModifiedByName returns the ModifiedByName field value if set, zero value otherwise.
func (o *ApplicationSecurityPolicyMetadata) GetModifiedByName() string {
...
// and a boolean to check if the value has been set.
func (o *ApplicationSecurityPolicyMetadata) GetModifiedByNameOk() (*string, bool) {
	if o == nil || o.ModifiedByName == nil {
		return nil, false
	}
...
func (o *ApplicationSecurityPolicyMetadata) HasModifiedByName() bool {
...
func (o *ApplicationSecurityPolicyMetadata) SetModifiedByName(v string) {
	o.ModifiedByName = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o ApplicationSecurityPolicyMetadata) MarshalJSON() ([]byte, error) {
...
func (o *ApplicationSecurityPolicyMetadata) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		AddedAt        *time.Time `json:"added_at,omitempty"`
		AddedBy        *string    `json:"added_by,omitempty"`
		AddedByName    *string    `json:"added_by_name,omitempty"`
