...
// GetDevice Get the device details.
...
func (a *NetworkDeviceMonitoringApi) GetDevice(ctx _context.Context, deviceId string) (GetDeviceResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.NetworkDeviceMonitoringApi.GetDevice")
	if err != nil {
...
func NewGetInterfacesOptionalParameters() *GetInterfacesOptionalParameters {
	this := GetInterfacesOptionalParameters{}
	return &this
}
...
func (r *GetInterfacesOptionalParameters) WithGetIpAddresses(getIpAddresses bool) *GetInterfacesOptionalParameters {
	r.GetIpAddresses = &getIpAddresses
	return r
}

// GetInterfaces Get the list of interfaces of the device.
...
func (a *NetworkDeviceMonitoringApi) GetInterfaces(ctx _context.Context, deviceId string, o ...GetInterfacesOptionalParameters) (GetInterfacesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue GetInterfacesResponse
		optionalParams      GetInterfacesOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, datadog.ReportError("only one argument of type GetInterfacesOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.NetworkDeviceMonitoringApi.GetInterfaces")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/ndm/interfaces"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	localVarQueryParams.Add("device_id", datadog.ParameterToString(deviceId, ""))
	if optionalParams.GetIpAddresses != nil {
		localVarQueryParams.Add("get_ip_addresses", datadog.ParameterToString(*optionalParams.GetIpAddresses, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
// ListDeviceUserTags Get the list of tags for a device.
...
func (a *NetworkDeviceMonitoringApi) ListDeviceUserTags(ctx _context.Context, deviceId string) (ListTagsResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.NetworkDeviceMonitoringApi.ListDeviceUserTags")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func NewListDevicesOptionalParameters() *ListDevicesOptionalParameters {
	this := ListDevicesOptionalParameters{}
	return &this
}
...
// ListDevices Get the list of devices.
...
func (a *NetworkDeviceMonitoringApi) ListDevices(ctx _context.Context, o ...ListDevicesOptionalParameters) (ListDevicesResponse, *_nethttp.Response, error) {
	var (
		...
		optionalParams      ListDevicesOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, datadog.ReportError("only one argument of type ListDevicesOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.NetworkDeviceMonitoringApi.ListDevices")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/ndm/devices"
	...
	if optionalParams.FilterTag != nil {
		localVarQueryParams.Add("filter[tag]", datadog.ParameterToString(*optionalParams.FilterTag, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
func (a *NetworkDeviceMonitoringApi) UpdateDeviceUserTags(ctx _context.Context, deviceId string, body ListTagsResponse) (ListTagsResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.NetworkDeviceMonitoringApi.UpdateDeviceUserTags")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
