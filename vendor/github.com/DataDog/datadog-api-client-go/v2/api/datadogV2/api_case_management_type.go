...
// CaseManagementTypeApi service type
...
func (a *CaseManagementTypeApi) CreateCaseType(ctx _context.Context, body CaseTypeCreateRequest) (CaseTypeResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CaseManagementTypeApi.CreateCaseType")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/cases/types"
...
func (a *CaseManagementTypeApi) DeleteCaseType(ctx _context.Context, caseTypeId string) (*_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CaseManagementTypeApi.DeleteCaseType")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/cases/types/{case_type_id}"
...
func (a *CaseManagementTypeApi) GetAllCaseTypes(ctx _context.Context) (CaseTypesResponse, *_nethttp.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		localVarReturnValue CaseTypesResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CaseManagementTypeApi.GetAllCaseTypes")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// NewCaseManagementTypeApi Returns NewCaseManagementTypeApi.
func NewCaseManagementTypeApi(client *datadog.APIClient) *CaseManagementTypeApi {
	return &CaseManagementTypeApi{
		Client: client,
	}
}
