...
// NewOktaAccountUpdateRequestData instantiates a new OktaAccountUpdateRequestData object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewOktaAccountUpdateRequestData() *OktaAccountUpdateRequestData {
	this := OktaAccountUpdateRequestData{}
	var typeVar OktaAccountType = OKTAACCOUNTTYPE_OKTA_ACCOUNTS
	this.Type = &typeVar
	return &this
}

// NewOktaAccountUpdateRequestDataWithDefaults instantiates a new OktaAccountUpdateRequestData object.
...
func (o *OktaAccountUpdateRequestData) GetAttributes() OktaAccountUpdateRequestAttributes {
	if o == nil || o.Attributes == nil {
		var ret OktaAccountUpdateRequestAttributes
		return ret
	}
	return *o.Attributes
}
