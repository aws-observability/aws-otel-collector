...
// AnnotationInPage A flat annotation object as it appears within a page annotations response.
type AnnotationInPage struct {
...
// NewAnnotationInPage instantiates a new AnnotationInPage object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewAnnotationInPage(authorId string, color AnnotationColor, createdAt int64, description string, endTime datadog.NullableInt64, id uuid.UUID, modifiedAt int64, pageId string, startTime int64, typeVar AnnotationKind) *AnnotationInPage {
	this := AnnotationInPage{}
...
// NewAnnotationInPageWithDefaults instantiates a new AnnotationInPage object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewAnnotationInPageWithDefaults() *AnnotationInPage {
	this := AnnotationInPage{}
	return &this
}

// GetAuthorId returns the AuthorId field value.
func (o *AnnotationInPage) GetAuthorId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *AnnotationInPage) GetAuthorIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AnnotationInPage) SetAuthorId(v string) {
	o.AuthorId = v
}

// GetColor returns the Color field value.
func (o *AnnotationInPage) GetColor() AnnotationColor {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *AnnotationInPage) GetColorOk() (*AnnotationColor, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Color, true
...
func (o *AnnotationInPage) SetColor(v AnnotationColor) {
	o.Color = v
}

// GetCreatedAt returns the CreatedAt field value.
func (o *AnnotationInPage) GetCreatedAt() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AnnotationInPage) GetCreatedAtOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AnnotationInPage) SetCreatedAt(v int64) {
	o.CreatedAt = v
}

// GetDescription returns the Description field value.
func (o *AnnotationInPage) GetDescription() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AnnotationInPage) GetDescriptionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AnnotationInPage) SetDescription(v string) {
	o.Description = v
}

// GetEndTime returns the EndTime field value.
// If the value is explicit nil, the zero value for int64 will be returned.
func (o *AnnotationInPage) GetEndTime() int64 {
...
func (o *AnnotationInPage) GetEndTimeOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AnnotationInPage) SetEndTime(v int64) {
	o.EndTime.Set(&v)
}

// GetId returns the Id field value.
func (o *AnnotationInPage) GetId() uuid.UUID {
	if o == nil {
		var ret uuid.UUID
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AnnotationInPage) GetIdOk() (*uuid.UUID, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *AnnotationInPage) SetId(v uuid.UUID) {
	o.Id = v
}

// GetModifiedAt returns the ModifiedAt field value.
func (o *AnnotationInPage) GetModifiedAt() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AnnotationInPage) GetModifiedAtOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AnnotationInPage) SetModifiedAt(v int64) {
	o.ModifiedAt = v
}

// GetPageId returns the PageId field value.
func (o *AnnotationInPage) GetPageId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AnnotationInPage) GetPageIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AnnotationInPage) SetPageId(v string) {
	o.PageId = v
}

// GetStartTime returns the StartTime field value.
func (o *AnnotationInPage) GetStartTime() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AnnotationInPage) GetStartTimeOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AnnotationInPage) SetStartTime(v int64) {
	o.StartTime = v
}

// GetType returns the Type field value.
func (o *AnnotationInPage) GetType() AnnotationKind {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *AnnotationInPage) GetTypeOk() (*AnnotationKind, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *AnnotationInPage) SetType(v AnnotationKind) {
	o.Type = v
}

// GetWidgetIds returns the WidgetIds field value if set, zero value otherwise.
func (o *AnnotationInPage) GetWidgetIds() []string {
...
// and a boolean to check if the value has been set.
func (o *AnnotationInPage) GetWidgetIdsOk() (*[]string, bool) {
	if o == nil || o.WidgetIds == nil {
		return nil, false
	}
...
func (o *AnnotationInPage) HasWidgetIds() bool {
	return o != nil && o.WidgetIds != nil
}

// SetWidgetIds gets a reference to the given []string and assigns it to the WidgetIds field.
func (o *AnnotationInPage) SetWidgetIds(v []string) {
	o.WidgetIds = v
}

// MarshalJSON serializes the struct using spec logic.
func (o AnnotationInPage) MarshalJSON() ([]byte, error) {
...
func (o *AnnotationInPage) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		AuthorId    *string               `json:"author_id"`
		Color       *AnnotationColor      `json:"color"`
		CreatedAt   *int64                `json:"created_at"`
	...
	if err = datadog.UnmarshalUseNumber(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"author_id", "color", "created_at", "description", "end_time", "id", "modified_at", "page_id", "start_time", "type", "widget_ids"})
	} else {
		return err
	}
