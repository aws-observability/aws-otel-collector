...
func (o *TimelineResponse) GetData() []TimelineCellResource {
	if o == nil || o.Data == nil {
		var ret []TimelineCellResource
		return ret
	}
	return o.Data
}
...
func (o *TimelineResponse) GetDataOk() (*[]TimelineCellResource, bool) {
	if o == nil || o.Data == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *TimelineResponse) HasData() bool {
	return o != nil && o.Data != nil
}

// SetData gets a reference to the given []TimelineCellResource and assigns it to the Data field.
func (o *TimelineResponse) SetData(v []TimelineCellResource) {
	o.Data = v
}
...
func (o *TimelineResponse) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data []TimelineCellResource `json:"data,omitempty"`
	}{}
