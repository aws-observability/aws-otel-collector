...
func NewSnapshotUpdateRequest(data SnapshotUpdateRequestData) *SnapshotUpdateRequest {
...
func (o *SnapshotUpdateRequest) GetData() SnapshotUpdateRequestData {
	if o == nil {
		var ret SnapshotUpdateRequestData
		return ret
	}
	return o.Data
}
...
func (o *SnapshotUpdateRequest) GetDataOk() (*SnapshotUpdateRequestData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *SnapshotUpdateRequest) SetData(v SnapshotUpdateRequestData) {
	o.Data = v
}
...
func (o *SnapshotUpdateRequest) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *SnapshotUpdateRequestData `json:"data"`
	}{}
