...
type CIAppPipelineEventFinishedJob struct {
...
// NewCIAppPipelineEventFinishedJob instantiates a new CIAppPipelineEventFinishedJob object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewCIAppPipelineEventFinishedJob(end time.Time, id string, level CIAppPipelineEventJobLevel, name string, pipelineName string, pipelineUniqueId string, start time.Time, status CIAppPipelineEventJobStatus, url string) *CIAppPipelineEventFinishedJob {
	this := CIAppPipelineEventFinishedJob{}
	this.End = end
	this.Id = id
	this.Level = level
	this.Name = name
...
// NewCIAppPipelineEventFinishedJobWithDefaults instantiates a new CIAppPipelineEventFinishedJob object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewCIAppPipelineEventFinishedJobWithDefaults() *CIAppPipelineEventFinishedJob {
	this := CIAppPipelineEventFinishedJob{}
...
func (o *CIAppPipelineEventFinishedJob) GetDependencies() []string {
...
func (o *CIAppPipelineEventFinishedJob) GetDependenciesOk() (*[]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CIAppPipelineEventFinishedJob) HasDependencies() bool {
...
// and a boolean to check if the value has been set.
func (o *CIAppPipelineEventFinishedJob) GetEndOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
	return &o.End, true
...
func (o *CIAppPipelineEventFinishedJob) SetEnd(v time.Time) {
	o.End = v
}

// GetError returns the Error field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CIAppPipelineEventFinishedJob) GetError() CIAppCIError {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *CIAppPipelineEventFinishedJob) GetErrorOk() (*CIAppCIError, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CIAppPipelineEventFinishedJob) HasError() bool {
	return o != nil && o.Error.IsSet()
}

// SetError gets a reference to the given NullableCIAppCIError and assigns it to the Error field.
func (o *CIAppPipelineEventFinishedJob) SetError(v CIAppCIError) {
	o.Error.Set(&v)
}

// SetErrorNil sets the value for Error to be an explicit nil.
func (o *CIAppPipelineEventFinishedJob) SetErrorNil() {
	o.Error.Set(nil)
}

// UnsetError ensures that no value is present for Error, not even an explicit nil.
func (o *CIAppPipelineEventFinishedJob) UnsetError() {
	o.Error.Unset()
}

// GetGit returns the Git field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CIAppPipelineEventFinishedJob) GetGit() CIAppGitInfo {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *CIAppPipelineEventFinishedJob) GetGitOk() (*CIAppGitInfo, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *CIAppPipelineEventFinishedJob) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *CIAppPipelineEventFinishedJob) SetId(v string) {
	o.Id = v
}

// GetLevel returns the Level field value.
func (o *CIAppPipelineEventFinishedJob) GetLevel() CIAppPipelineEventJobLevel {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CIAppPipelineEventFinishedJob) GetLevelOk() (*CIAppPipelineEventJobLevel, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Level, true
...
func (o *CIAppPipelineEventFinishedJob) SetLevel(v CIAppPipelineEventJobLevel) {
	o.Level = v
}

// GetMetrics returns the Metrics field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CIAppPipelineEventFinishedJob) GetMetrics() []string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *CIAppPipelineEventFinishedJob) GetMetricsOk() (*[]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CIAppPipelineEventFinishedJob) HasMetrics() bool {
...
func (o *CIAppPipelineEventFinishedJob) SetMetrics(v []string) {
	o.Metrics.Set(&v)
}

// SetMetricsNil sets the value for Metrics to be an explicit nil.
func (o *CIAppPipelineEventFinishedJob) SetMetricsNil() {
	o.Metrics.Set(nil)
}

// UnsetMetrics ensures that no value is present for Metrics, not even an explicit nil.
func (o *CIAppPipelineEventFinishedJob) UnsetMetrics() {
	o.Metrics.Unset()
}

// GetName returns the Name field value.
func (o *CIAppPipelineEventFinishedJob) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CIAppPipelineEventFinishedJob) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *CIAppPipelineEventFinishedJob) SetName(v string) {
	o.Name = v
}

// GetNode returns the Node field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CIAppPipelineEventFinishedJob) GetNode() CIAppHostInfo {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *CIAppPipelineEventFinishedJob) GetNodeOk() (*CIAppHostInfo, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CIAppPipelineEventFinishedJob) HasNode() bool {
	return o != nil && o.Node.IsSet()
}

// SetNode gets a reference to the given NullableCIAppHostInfo and assigns it to the Node field.
func (o *CIAppPipelineEventFinishedJob) SetNode(v CIAppHostInfo) {
	o.Node.Set(&v)
}

// SetNodeNil sets the value for Node to be an explicit nil.
func (o *CIAppPipelineEventFinishedJob) SetNodeNil() {
	o.Node.Set(nil)
}

// UnsetNode ensures that no value is present for Node, not even an explicit nil.
func (o *CIAppPipelineEventFinishedJob) UnsetNode() {
	o.Node.Unset()
}

// GetParameters returns the Parameters field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CIAppPipelineEventFinishedJob) GetParameters() map[string]string {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *CIAppPipelineEventFinishedJob) GetParametersOk() (*map[string]string, bool) {
...
func (o *CIAppPipelineEventFinishedJob) HasParameters() bool {
	return o != nil && o.Parameters != nil
}

// SetParameters gets a reference to the given map[string]string and assigns it to the Parameters field.
func (o *CIAppPipelineEventFinishedJob) SetParameters(v map[string]string) {
	o.Parameters = v
}

// GetPipelineName returns the PipelineName field value.
func (o *CIAppPipelineEventFinishedJob) GetPipelineName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CIAppPipelineEventFinishedJob) GetPipelineNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CIAppPipelineEventFinishedJob) SetPipelineName(v string) {
	o.PipelineName = v
}

// GetPipelineUniqueId returns the PipelineUniqueId field value.
func (o *CIAppPipelineEventFinishedJob) GetPipelineUniqueId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CIAppPipelineEventFinishedJob) GetPipelineUniqueIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CIAppPipelineEventFinishedJob) SetPipelineUniqueId(v string) {
...
func (o *CIAppPipelineEventFinishedJob) GetQueueTime() int64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *CIAppPipelineEventFinishedJob) GetQueueTimeOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CIAppPipelineEventFinishedJob) HasQueueTime() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *CIAppPipelineEventFinishedJob) GetStageIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CIAppPipelineEventFinishedJob) HasStageId() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *CIAppPipelineEventFinishedJob) GetStageNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CIAppPipelineEventFinishedJob) HasStageName() bool {
...
func (o *CIAppPipelineEventFinishedJob) SetStageName(v string) {
	o.StageName.Set(&v)
}

// SetStageNameNil sets the value for StageName to be an explicit nil.
func (o *CIAppPipelineEventFinishedJob) SetStageNameNil() {
	o.StageName.Set(nil)
}

// UnsetStageName ensures that no value is present for StageName, not even an explicit nil.
func (o *CIAppPipelineEventFinishedJob) UnsetStageName() {
	o.StageName.Unset()
}

// GetStart returns the Start field value.
func (o *CIAppPipelineEventFinishedJob) GetStart() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CIAppPipelineEventFinishedJob) GetStartOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Start, true
...
func (o *CIAppPipelineEventFinishedJob) SetStart(v time.Time) {
	o.Start = v
}

// GetStatus returns the Status field value.
func (o *CIAppPipelineEventFinishedJob) GetStatus() CIAppPipelineEventJobStatus {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CIAppPipelineEventFinishedJob) GetStatusOk() (*CIAppPipelineEventJobStatus, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CIAppPipelineEventFinishedJob) SetStatus(v CIAppPipelineEventJobStatus) {
	o.Status = v
}

// GetTags returns the Tags field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CIAppPipelineEventFinishedJob) GetTags() []string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *CIAppPipelineEventFinishedJob) GetTagsOk() (*[]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CIAppPipelineEventFinishedJob) HasTags() bool {
...
func (o *CIAppPipelineEventFinishedJob) SetTags(v []string) {
	o.Tags.Set(&v)
}

// SetTagsNil sets the value for Tags to be an explicit nil.
func (o *CIAppPipelineEventFinishedJob) SetTagsNil() {
	o.Tags.Set(nil)
}

// UnsetTags ensures that no value is present for Tags, not even an explicit nil.
func (o *CIAppPipelineEventFinishedJob) UnsetTags() {
	o.Tags.Unset()
}

// GetUrl returns the Url field value.
func (o *CIAppPipelineEventFinishedJob) GetUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CIAppPipelineEventFinishedJob) GetUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Url, true
...
func (o *CIAppPipelineEventFinishedJob) SetUrl(v string) {
	o.Url = v
}

// MarshalJSON serializes the struct using spec logic.
func (o CIAppPipelineEventFinishedJob) MarshalJSON() ([]byte, error) {
...
func (o *CIAppPipelineEventFinishedJob) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Dependencies     datadog.NullableList[string] `json:"dependencies,omitempty"`
		End              *time.Time                   `json:"end"`
		Error            NullableCIAppCIError         `json:"error,omitempty"`
