...
// ServiceNowTemplateUpdateRequestAttributes Attributes for updating a ServiceNow template
type ServiceNowTemplateUpdateRequestAttributes struct {
...
// NewServiceNowTemplateUpdateRequestAttributes instantiates a new ServiceNowTemplateUpdateRequestAttributes object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewServiceNowTemplateUpdateRequestAttributes(handleName string, instanceId uuid.UUID, servicenowTablename string) *ServiceNowTemplateUpdateRequestAttributes {
	this := ServiceNowTemplateUpdateRequestAttributes{}
...
// NewServiceNowTemplateUpdateRequestAttributesWithDefaults instantiates a new ServiceNowTemplateUpdateRequestAttributes object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewServiceNowTemplateUpdateRequestAttributesWithDefaults() *ServiceNowTemplateUpdateRequestAttributes {
	this := ServiceNowTemplateUpdateRequestAttributes{}
	return &this
}

// GetAssignmentGroupId returns the AssignmentGroupId field value if set, zero value otherwise.
func (o *ServiceNowTemplateUpdateRequestAttributes) GetAssignmentGroupId() uuid.UUID {
...
func (o *ServiceNowTemplateUpdateRequestAttributes) GetAssignmentGroupIdOk() (*uuid.UUID, bool) {
	if o == nil || o.AssignmentGroupId == nil {
		return nil, false
	}
...
func (o *ServiceNowTemplateUpdateRequestAttributes) HasAssignmentGroupId() bool {
...
func (o *ServiceNowTemplateUpdateRequestAttributes) SetAssignmentGroupId(v uuid.UUID) {
	o.AssignmentGroupId = &v
}

// GetBusinessServiceId returns the BusinessServiceId field value if set, zero value otherwise.
func (o *ServiceNowTemplateUpdateRequestAttributes) GetBusinessServiceId() uuid.UUID {
...
// and a boolean to check if the value has been set.
func (o *ServiceNowTemplateUpdateRequestAttributes) GetBusinessServiceIdOk() (*uuid.UUID, bool) {
	if o == nil || o.BusinessServiceId == nil {
		return nil, false
	}
...
func (o *ServiceNowTemplateUpdateRequestAttributes) HasBusinessServiceId() bool {
...
func (o *ServiceNowTemplateUpdateRequestAttributes) SetBusinessServiceId(v uuid.UUID) {
	o.BusinessServiceId = &v
}

// GetFieldsMapping returns the FieldsMapping field value if set, zero value otherwise.
func (o *ServiceNowTemplateUpdateRequestAttributes) GetFieldsMapping() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *ServiceNowTemplateUpdateRequestAttributes) GetFieldsMappingOk() (*map[string]string, bool) {
	if o == nil || o.FieldsMapping == nil {
		return nil, false
	}
...
func (o *ServiceNowTemplateUpdateRequestAttributes) HasFieldsMapping() bool {
...
func (o *ServiceNowTemplateUpdateRequestAttributes) SetFieldsMapping(v map[string]string) {
	o.FieldsMapping = v
}

// GetHandleName returns the HandleName field value.
func (o *ServiceNowTemplateUpdateRequestAttributes) GetHandleName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ServiceNowTemplateUpdateRequestAttributes) GetHandleNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ServiceNowTemplateUpdateRequestAttributes) SetHandleName(v string) {
	o.HandleName = v
}

// GetInstanceId returns the InstanceId field value.
func (o *ServiceNowTemplateUpdateRequestAttributes) GetInstanceId() uuid.UUID {
	if o == nil {
		var ret uuid.UUID
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ServiceNowTemplateUpdateRequestAttributes) GetInstanceIdOk() (*uuid.UUID, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ServiceNowTemplateUpdateRequestAttributes) SetInstanceId(v uuid.UUID) {
	o.InstanceId = v
}

// GetServicenowTablename returns the ServicenowTablename field value.
func (o *ServiceNowTemplateUpdateRequestAttributes) GetServicenowTablename() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ServiceNowTemplateUpdateRequestAttributes) GetServicenowTablenameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ServiceNowTemplateUpdateRequestAttributes) SetServicenowTablename(v string) {
	o.ServicenowTablename = v
}

// GetUserId returns the UserId field value if set, zero value otherwise.
func (o *ServiceNowTemplateUpdateRequestAttributes) GetUserId() uuid.UUID {
...
// and a boolean to check if the value has been set.
func (o *ServiceNowTemplateUpdateRequestAttributes) GetUserIdOk() (*uuid.UUID, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *ServiceNowTemplateUpdateRequestAttributes) HasUserId() bool {
	return o != nil && o.UserId != nil
}

// SetUserId gets a reference to the given uuid.UUID and assigns it to the UserId field.
func (o *ServiceNowTemplateUpdateRequestAttributes) SetUserId(v uuid.UUID) {
	o.UserId = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o ServiceNowTemplateUpdateRequestAttributes) MarshalJSON() ([]byte, error) {
...
func (o *ServiceNowTemplateUpdateRequestAttributes) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		AssignmentGroupId   *uuid.UUID        `json:"assignment_group_id,omitempty"`
		BusinessServiceId   *uuid.UUID        `json:"business_service_id,omitempty"`
		FieldsMapping       map[string]string `json:"fields_mapping,omitempty"`
