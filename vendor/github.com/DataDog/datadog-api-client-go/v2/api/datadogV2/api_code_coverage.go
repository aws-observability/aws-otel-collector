...
// CodeCoverageApi service type
type CodeCoverageApi datadog.Service

// GetCodeCoverageBranchSummary Get code coverage summary for a branch.
...
func (a *CodeCoverageApi) GetCodeCoverageBranchSummary(ctx _context.Context, body BranchCoverageSummaryRequest) (CoverageSummaryResponse, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue CoverageSummaryResponse
	)

	operationId := "v2.GetCodeCoverageBranchSummary"
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CodeCoverageApi.GetCodeCoverageBranchSummary")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/code-coverage/branch/summary"
...
// GetCodeCoverageCommitSummary Get code coverage summary for a commit.
...
func (a *CodeCoverageApi) GetCodeCoverageCommitSummary(ctx _context.Context, body CommitCoverageSummaryRequest) (CoverageSummaryResponse, *_nethttp.Response, error) {
	...
	operationId := "v2.GetCodeCoverageCommitSummary"
	isOperationEnabled := a.Client.Cfg.IsUnstableOperationEnabled(operationId)
	if !isOperationEnabled {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: _fmt.Sprintf("Unstable operation '%s' is disabled", operationId)}
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.CodeCoverageApi.GetCodeCoverageCommitSummary")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/code-coverage/commit/summary"
...
// NewCodeCoverageApi Returns NewCodeCoverageApi.
func NewCodeCoverageApi(client *datadog.APIClient) *CodeCoverageApi {
	return &CodeCoverageApi{
		Client: client,
	}
}
