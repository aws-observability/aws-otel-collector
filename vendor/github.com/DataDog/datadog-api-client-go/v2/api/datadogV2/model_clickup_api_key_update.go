...
func NewClickupAPIKeyUpdate(typeVar ClickupAPIKeyType) *ClickupAPIKeyUpdate {
	this := ClickupAPIKeyUpdate{}
	this.Type = typeVar
	return &this
}

// NewClickupAPIKeyUpdateWithDefaults instantiates a new ClickupAPIKeyUpdate object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewClickupAPIKeyUpdateWithDefaults() *ClickupAPIKeyUpdate {
	this := ClickupAPIKeyUpdate{}
	return &this
}
...
func (o *ClickupAPIKeyUpdate) GetApiTokenOk() (*string, bool) {
	if o == nil || o.ApiToken == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *ClickupAPIKeyUpdate) GetTypeOk() (*ClickupAPIKeyType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *ClickupAPIKeyUpdate) SetType(v ClickupAPIKeyType) {
	o.Type = v
}
