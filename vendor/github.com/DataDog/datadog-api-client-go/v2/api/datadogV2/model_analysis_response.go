...
func NewAnalysisResponse(data AnalysisResponseData) *AnalysisResponse {
...
func (o *AnalysisResponse) GetData() AnalysisResponseData {
	if o == nil {
		var ret AnalysisResponseData
		return ret
	}
	return o.Data
}
...
func (o *AnalysisResponse) GetDataOk() (*AnalysisResponseData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *AnalysisResponse) SetData(v AnalysisResponseData) {
	o.Data = v
}
...
func (o *AnalysisResponse) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Data *AnalysisResponseData `json:"data"`
	}{}
