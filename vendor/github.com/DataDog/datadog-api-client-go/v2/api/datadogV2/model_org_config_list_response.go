...
// NewOrgConfigListResponse instantiates a new OrgConfigListResponse object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewOrgConfigListResponse(data []OrgConfigRead) *OrgConfigListResponse {
	this := OrgConfigListResponse{}
	this.Data = data
	return &this
}

// NewOrgConfigListResponseWithDefaults instantiates a new OrgConfigListResponse object.
