...
// NewCreateRuleResponseData instantiates a new CreateRuleResponseData object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewCreateRuleResponseData() *CreateRuleResponseData {
	this := CreateRuleResponseData{}
	var typeVar RuleType = RULETYPE_RULE
	this.Type = &typeVar
	return &this
}

// NewCreateRuleResponseDataWithDefaults instantiates a new CreateRuleResponseData object.
