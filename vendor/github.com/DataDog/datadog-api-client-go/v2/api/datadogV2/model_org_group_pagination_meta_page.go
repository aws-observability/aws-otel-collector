...
// OrgGroupPaginationMetaPage Page-based pagination details for org group list responses.
type OrgGroupPaginationMetaPage struct {
	// First page number.
	FirstNumber *int64 `json:"first_number,omitempty"`
	// Last page number.
	LastNumber datadog.NullableInt64 `json:"last_number,omitempty"`
	// Next page number.
...
func NewOrgGroupPaginationMetaPage() *OrgGroupPaginationMetaPage {
...
func (o *OrgGroupPaginationMetaPage) GetFirstNumber() int64 {
...
func (o *OrgGroupPaginationMetaPage) GetFirstNumberOk() (*int64, bool) {
	if o == nil || o.FirstNumber == nil {
		return nil, false
	}
...
func (o *OrgGroupPaginationMetaPage) HasFirstNumber() bool {
	return o != nil && o.FirstNumber != nil
}

// SetFirstNumber gets a reference to the given int64 and assigns it to the FirstNumber field.
func (o *OrgGroupPaginationMetaPage) SetFirstNumber(v int64) {
	o.FirstNumber = &v
}

// GetLastNumber returns the LastNumber field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *OrgGroupPaginationMetaPage) GetLastNumber() int64 {
	if o == nil || o.LastNumber.Get() == nil {
		var ret int64
		return ret
	}
	return *o.LastNumber.Get()
}

// GetLastNumberOk returns a tuple with the LastNumber field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *OrgGroupPaginationMetaPage) GetLastNumberOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
	return o.LastNumber.Get(), o.LastNumber.IsSet()
}

// HasLastNumber returns a boolean if a field has been set.
func (o *OrgGroupPaginationMetaPage) HasLastNumber() bool {
	return o != nil && o.LastNumber.IsSet()
}

// SetLastNumber gets a reference to the given datadog.NullableInt64 and assigns it to the LastNumber field.
func (o *OrgGroupPaginationMetaPage) SetLastNumber(v int64) {
	o.LastNumber.Set(&v)
}

// SetLastNumberNil sets the value for LastNumber to be an explicit nil.
func (o *OrgGroupPaginationMetaPage) SetLastNumberNil() {
	o.LastNumber.Set(nil)
}

// UnsetLastNumber ensures that no value is present for LastNumber, not even an explicit nil.
func (o *OrgGroupPaginationMetaPage) UnsetLastNumber() {
	o.LastNumber.Unset()
}

// GetNextNumber returns the NextNumber field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *OrgGroupPaginationMetaPage) GetNextNumber() int64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *OrgGroupPaginationMetaPage) GetNextNumberOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrgGroupPaginationMetaPage) HasNextNumber() bool {
...
func (o *OrgGroupPaginationMetaPage) SetNextNumber(v int64) {
	o.NextNumber.Set(&v)
}

// SetNextNumberNil sets the value for NextNumber to be an explicit nil.
func (o *OrgGroupPaginationMetaPage) SetNextNumberNil() {
	o.NextNumber.Set(nil)
}

// UnsetNextNumber ensures that no value is present for NextNumber, not even an explicit nil.
func (o *OrgGroupPaginationMetaPage) UnsetNextNumber() {
	o.NextNumber.Unset()
}

// GetNumber returns the Number field value if set, zero value otherwise.
func (o *OrgGroupPaginationMetaPage) GetNumber() int64 {
...
// and a boolean to check if the value has been set.
func (o *OrgGroupPaginationMetaPage) GetNumberOk() (*int64, bool) {
	if o == nil || o.Number == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *OrgGroupPaginationMetaPage) GetPrevNumberOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrgGroupPaginationMetaPage) HasPrevNumber() bool {
...
func (o *OrgGroupPaginationMetaPage) SetPrevNumber(v int64) {
	o.PrevNumber.Set(&v)
}

// SetPrevNumberNil sets the value for PrevNumber to be an explicit nil.
func (o *OrgGroupPaginationMetaPage) SetPrevNumberNil() {
	o.PrevNumber.Set(nil)
}

// UnsetPrevNumber ensures that no value is present for PrevNumber, not even an explicit nil.
func (o *OrgGroupPaginationMetaPage) UnsetPrevNumber() {
	o.PrevNumber.Unset()
}

// GetSize returns the Size field value if set, zero value otherwise.
func (o *OrgGroupPaginationMetaPage) GetSize() int64 {
	if o == nil || o.Size == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OrgGroupPaginationMetaPage) GetSizeOk() (*int64, bool) {
	if o == nil || o.Size == nil {
		return nil, false
	}
	return o.Size, true
...
func (o *OrgGroupPaginationMetaPage) HasSize() bool {
	return o != nil && o.Size != nil
}

// SetSize gets a reference to the given int64 and assigns it to the Size field.
func (o *OrgGroupPaginationMetaPage) SetSize(v int64) {
	o.Size = &v
}

// GetTotal returns the Total field value if set, zero value otherwise.
func (o *OrgGroupPaginationMetaPage) GetTotal() int64 {
...
// and a boolean to check if the value has been set.
func (o *OrgGroupPaginationMetaPage) GetTotalOk() (*int64, bool) {
	if o == nil || o.Total == nil {
		return nil, false
	}
	return o.Total, true
...
func (o *OrgGroupPaginationMetaPage) HasTotal() bool {
	return o != nil && o.Total != nil
}

// SetTotal gets a reference to the given int64 and assigns it to the Total field.
func (o *OrgGroupPaginationMetaPage) SetTotal(v int64) {
	o.Total = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *OrgGroupPaginationMetaPage) GetType() string {
	if o == nil || o.Type == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OrgGroupPaginationMetaPage) GetTypeOk() (*string, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return o.Type, true
...
func (o *OrgGroupPaginationMetaPage) HasType() bool {
	return o != nil && o.Type != nil
}

// SetType gets a reference to the given string and assigns it to the Type field.
func (o *OrgGroupPaginationMetaPage) SetType(v string) {
	o.Type = &v
}
...
func (o OrgGroupPaginationMetaPage) MarshalJSON() ([]byte, error) {
	...
	if o.LastNumber.IsSet() {
		toSerialize["last_number"] = o.LastNumber.Get()
	}
