...
func (o *SyntheticsSuiteResponseData) GetId() string {
	if o == nil || o.Id == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SyntheticsSuiteResponseData) GetIdOk() (*string, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return o.Id, true
...
func (o *SyntheticsSuiteResponseData) HasId() bool {
	return o != nil && o.Id != nil
}

// SetId gets a reference to the given string and assigns it to the Id field.
func (o *SyntheticsSuiteResponseData) SetId(v string) {
	o.Id = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *SyntheticsSuiteResponseData) GetType() SyntheticsSuiteTypes {
	if o == nil || o.Type == nil {
...
// and a boolean to check if the value has been set.
func (o *SyntheticsSuiteResponseData) GetTypeOk() (*SyntheticsSuiteTypes, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return o.Type, true
...
func (o *SyntheticsSuiteResponseData) HasType() bool {
	return o != nil && o.Type != nil
}

// SetType gets a reference to the given SyntheticsSuiteTypes and assigns it to the Type field.
func (o *SyntheticsSuiteResponseData) SetType(v SyntheticsSuiteTypes) {
	o.Type = &v
}
