...
// NewOktaAccountsResponse instantiates a new OktaAccountsResponse object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewOktaAccountsResponse() *OktaAccountsResponse {
	this := OktaAccountsResponse{}
	return &this
}

// NewOktaAccountsResponseWithDefaults instantiates a new OktaAccountsResponse object.
...
func (o *OktaAccountsResponse) GetData() []OktaAccountResponseData {
	if o == nil || o.Data == nil {
		var ret []OktaAccountResponseData
		return ret
	}
	return o.Data
}
