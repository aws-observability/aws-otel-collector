...
// NewBulkMuteFindingsRequestMeta instantiates a new BulkMuteFindingsRequestMeta object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewBulkMuteFindingsRequestMeta() *BulkMuteFindingsRequestMeta {
	this := BulkMuteFindingsRequestMeta{}
	return &this
}

// NewBulkMuteFindingsRequestMetaWithDefaults instantiates a new BulkMuteFindingsRequestMeta object.
...
func (o *BulkMuteFindingsRequestMeta) GetFindings() []BulkMuteFindingsRequestMetaFindings {
	if o == nil || o.Findings == nil {
		var ret []BulkMuteFindingsRequestMetaFindings
		return ret
	}
	return o.Findings
}
