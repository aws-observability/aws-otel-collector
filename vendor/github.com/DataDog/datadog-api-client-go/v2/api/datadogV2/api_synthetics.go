...
// AbortTestFileMultipartUpload Abort a multipart upload of a test file.
...
func (a *SyntheticsApi) AbortTestFileMultipartUpload(ctx _context.Context, publicId string, body SyntheticsTestFileAbortMultipartUploadRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPost
		localVarPostBody   interface{}
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.AbortTestFileMultipartUpload")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/tests/{public_id}/files/multipart-upload-abort"
...
// CompleteTestFileMultipartUpload Complete a multipart upload of a test file.
...
func (a *SyntheticsApi) CompleteTestFileMultipartUpload(ctx _context.Context, publicId string, body SyntheticsTestFileCompleteMultipartUploadRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPost
		localVarPostBody   interface{}
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.CompleteTestFileMultipartUpload")
	if err != nil {
		return nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/tests/{public_id}/files/multipart-upload-complete"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{public_id}", _neturl.PathEscape(datadog.ParameterToString(publicId, "")))
...
func (a *SyntheticsApi) CreateSyntheticsNetworkTest(ctx _context.Context, body SyntheticsNetworkTestEditRequest) (SyntheticsNetworkTestResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue SyntheticsNetworkTestResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.CreateSyntheticsNetworkTest")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/tests/network"
...
func (a *SyntheticsApi) CreateSyntheticsSuite(ctx _context.Context, body SuiteCreateEditRequest) (SyntheticsSuiteResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue SyntheticsSuiteResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.CreateSyntheticsSuite")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/suites"
...
func (a *SyntheticsApi) DeleteSyntheticsSuites(ctx _context.Context, body DeletedSuitesRequestDeleteRequest) (DeletedSuitesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue DeletedSuitesResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.DeleteSyntheticsSuites")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/suites/bulk-delete"
...
func (a *SyntheticsApi) DeleteSyntheticsTests(ctx _context.Context, body DeletedTestsRequestDeleteRequest) (DeletedTestsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue DeletedTestsResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.DeleteSyntheticsTests")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/tests/bulk-delete"
...
func (a *SyntheticsApi) EditSyntheticsSuite(ctx _context.Context, publicId string, body SuiteCreateEditRequest) (SyntheticsSuiteResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.EditSyntheticsSuite")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/suites/{public_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{public_id}", _neturl.PathEscape(datadog.ParameterToString(publicId, "")))
...
// GetApiMultistepSubtestParents Get parent tests for a subtest.
// Get the list of API multistep tests that include a given subtest,
// along with their monitor status.
func (a *SyntheticsApi) GetApiMultistepSubtestParents(ctx _context.Context, publicId string) (SyntheticsApiMultistepParentTestsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue SyntheticsApiMultistepParentTestsResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.GetApiMultistepSubtestParents")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/api-multistep/subtests/{public_id}/parents"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{public_id}", _neturl.PathEscape(datadog.ParameterToString(publicId, "")))
...
// GetApiMultistepSubtests Get available subtests for a multistep test.
...
func (a *SyntheticsApi) GetApiMultistepSubtests(ctx _context.Context, publicId string) (SyntheticsApiMultistepSubtestsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue SyntheticsApiMultistepSubtestsResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.GetApiMultistepSubtests")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/api-multistep/subtests/{public_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{public_id}", _neturl.PathEscape(datadog.ParameterToString(publicId, "")))
...
func (a *SyntheticsApi) GetSyntheticsFastTestResult(ctx _context.Context, id string) (SyntheticsFastTestResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue SyntheticsFastTestResult
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.GetSyntheticsFastTestResult")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/tests/fast/{id}"
...
func (a *SyntheticsApi) GetSyntheticsNetworkTest(ctx _context.Context, publicId string) (SyntheticsNetworkTestResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.GetSyntheticsNetworkTest")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/tests/network/{public_id}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{public_id}", _neturl.PathEscape(datadog.ParameterToString(publicId, "")))
...
func (a *SyntheticsApi) GetSyntheticsSuite(ctx _context.Context, publicId string) (SyntheticsSuiteResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.GetSyntheticsSuite")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// GetSyntheticsTestVersionOptionalParameters holds optional parameters for GetSyntheticsTestVersion.
type GetSyntheticsTestVersionOptionalParameters struct {
	IncludeChangeMetadata *bool
	OnlyCheckExistence    *bool
}

// NewGetSyntheticsTestVersionOptionalParameters creates an empty struct for parameters.
func NewGetSyntheticsTestVersionOptionalParameters() *GetSyntheticsTestVersionOptionalParameters {
	this := GetSyntheticsTestVersionOptionalParameters{}
	return &this
}

// WithIncludeChangeMetadata sets the corresponding parameter name and returns the struct.
func (r *GetSyntheticsTestVersionOptionalParameters) WithIncludeChangeMetadata(includeChangeMetadata bool) *GetSyntheticsTestVersionOptionalParameters {
	r.IncludeChangeMetadata = &includeChangeMetadata
	return r
}

// WithOnlyCheckExistence sets the corresponding parameter name and returns the struct.
func (r *GetSyntheticsTestVersionOptionalParameters) WithOnlyCheckExistence(onlyCheckExistence bool) *GetSyntheticsTestVersionOptionalParameters {
	r.OnlyCheckExistence = &onlyCheckExistence
	return r
}

// GetSyntheticsTestVersion Get a specific version of a test.
// Get a specific version of a Synthetic test by its version number.
func (a *SyntheticsApi) GetSyntheticsTestVersion(ctx _context.Context, publicId string, versionNumber int64, o ...GetSyntheticsTestVersionOptionalParameters) (SyntheticsTestVersionResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue SyntheticsTestVersionResponse
		optionalParams      GetSyntheticsTestVersionOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, datadog.ReportError("only one argument of type GetSyntheticsTestVersionOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.GetSyntheticsTestVersion")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/tests/{public_id}/version_history/{version_number}"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{public_id}", _neturl.PathEscape(datadog.ParameterToString(publicId, "")))
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{version_number}", _neturl.PathEscape(datadog.ParameterToString(versionNumber, "")))

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if optionalParams.IncludeChangeMetadata != nil {
		localVarQueryParams.Add("include_change_metadata", datadog.ParameterToString(*optionalParams.IncludeChangeMetadata, ""))
	}
	if optionalParams.OnlyCheckExistence != nil {
		localVarQueryParams.Add("only_check_existence", datadog.ParameterToString(*optionalParams.OnlyCheckExistence, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
// GetTestFileDownloadUrl Get a presigned URL for downloading a test file.
...
func (a *SyntheticsApi) GetTestFileDownloadUrl(ctx _context.Context, publicId string, body SyntheticsTestFileDownloadRequest) (SyntheticsTestFileDownloadResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue SyntheticsTestFileDownloadResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.GetTestFileDownloadUrl")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/tests/{public_id}/files/download"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{public_id}", _neturl.PathEscape(datadog.ParameterToString(publicId, "")))
...
// GetTestFileMultipartPresignedUrls Get presigned URLs for uploading a test file.
...
func (a *SyntheticsApi) GetTestFileMultipartPresignedUrls(ctx _context.Context, publicId string, body SyntheticsTestFileMultipartPresignedUrlsRequest) (SyntheticsTestFileMultipartPresignedUrlsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue SyntheticsTestFileMultipartPresignedUrlsResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.GetTestFileMultipartPresignedUrls")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/tests/{public_id}/files/multipart-presigned-urls"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{public_id}", _neturl.PathEscape(datadog.ParameterToString(publicId, "")))
...
// GetTestParentSuites Get parent suites for a test.
// Get the list of parent suites and their status for a given Synthetic test.
func (a *SyntheticsApi) GetTestParentSuites(ctx _context.Context, publicId string) (SyntheticsTestParentSuitesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue SyntheticsTestParentSuitesResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.GetTestParentSuites")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/tests/{public_id}/parent-suites"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{public_id}", _neturl.PathEscape(datadog.ParameterToString(publicId, "")))
...
// NewListSyntheticsTestVersionsOptionalParameters creates an empty struct for parameters.
func NewListSyntheticsTestVersionsOptionalParameters() *ListSyntheticsTestVersionsOptionalParameters {
	this := ListSyntheticsTestVersionsOptionalParameters{}
	return &this
}

// WithLastVersionNumber sets the corresponding parameter name and returns the struct.
func (r *ListSyntheticsTestVersionsOptionalParameters) WithLastVersionNumber(lastVersionNumber int64) *ListSyntheticsTestVersionsOptionalParameters {
	r.LastVersionNumber = &lastVersionNumber
	return r
}

// WithLimit sets the corresponding parameter name and returns the struct.
func (r *ListSyntheticsTestVersionsOptionalParameters) WithLimit(limit int64) *ListSyntheticsTestVersionsOptionalParameters {
	r.Limit = &limit
	return r
}

// ListSyntheticsTestVersions Get version history of a test.
// Get the paginated version history for a Synthetic test.
func (a *SyntheticsApi) ListSyntheticsTestVersions(ctx _context.Context, publicId string, o ...ListSyntheticsTestVersionsOptionalParameters) (SyntheticsTestVersionHistoryResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue SyntheticsTestVersionHistoryResponse
		optionalParams      ListSyntheticsTestVersionsOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, datadog.ReportError("only one argument of type ListSyntheticsTestVersionsOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.ListSyntheticsTestVersions")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/tests/{public_id}/version_history"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{public_id}", _neturl.PathEscape(datadog.ParameterToString(publicId, "")))

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if optionalParams.LastVersionNumber != nil {
		localVarQueryParams.Add("last_version_number", datadog.ParameterToString(*optionalParams.LastVersionNumber, ""))
	}
...
// PatchGlobalVariable Patch a global variable.
...
func (a *SyntheticsApi) PatchGlobalVariable(ctx _context.Context, variableId string, body GlobalVariableJsonPatchRequest) (GlobalVariableResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPatch
		localVarPostBody    interface{}
		localVarReturnValue GlobalVariableResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.PatchGlobalVariable")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/variables/{variable_id}/jsonpatch"
...
// PatchTestSuite Patch a test suite.
...
func (a *SyntheticsApi) PatchTestSuite(ctx _context.Context, publicId string, body SuiteJsonPatchRequest) (SyntheticsSuiteResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPatch
		localVarPostBody    interface{}
		localVarReturnValue SyntheticsSuiteResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.PatchTestSuite")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/suites/{public_id}/jsonpatch"
	localVarPath = datadog.ReplacePathParameter(localVarPath, "{public_id}", _neturl.PathEscape(datadog.ParameterToString(publicId, "")))
...
// SearchSuitesOptionalParameters holds optional parameters for SearchSuites.
type SearchSuitesOptionalParameters struct {
	Query      *string
	Sort       *string
	FacetsOnly *bool
	Start      *int64
...
// NewSearchSuitesOptionalParameters creates an empty struct for parameters.
func NewSearchSuitesOptionalParameters() *SearchSuitesOptionalParameters {
	this := SearchSuitesOptionalParameters{}
	return &this
}

// WithQuery sets the corresponding parameter name and returns the struct.
func (r *SearchSuitesOptionalParameters) WithQuery(query string) *SearchSuitesOptionalParameters {
	r.Query = &query
	return r
}

// WithSort sets the corresponding parameter name and returns the struct.
func (r *SearchSuitesOptionalParameters) WithSort(sort string) *SearchSuitesOptionalParameters {
	r.Sort = &sort
	return r
}

// WithFacetsOnly sets the corresponding parameter name and returns the struct.
func (r *SearchSuitesOptionalParameters) WithFacetsOnly(facetsOnly bool) *SearchSuitesOptionalParameters {
	r.FacetsOnly = &facetsOnly
	return r
}

// WithStart sets the corresponding parameter name and returns the struct.
func (r *SearchSuitesOptionalParameters) WithStart(start int64) *SearchSuitesOptionalParameters {
	r.Start = &start
	return r
}

// WithCount sets the corresponding parameter name and returns the struct.
func (r *SearchSuitesOptionalParameters) WithCount(count int64) *SearchSuitesOptionalParameters {
	r.Count = &count
	return r
}
...
func (a *SyntheticsApi) SearchSuites(ctx _context.Context, o ...SearchSuitesOptionalParameters) (SyntheticsSuiteSearchResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue SyntheticsSuiteSearchResponse
		optionalParams      SearchSuitesOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, datadog.ReportError("only one argument of type SearchSuitesOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.SearchSuites")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/synthetics/suites/search"
...
func (a *SyntheticsApi) UpdateSyntheticsNetworkTest(ctx _context.Context, publicId string, body SyntheticsNetworkTestEditRequest) (SyntheticsNetworkTestResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, "v2.SyntheticsApi.UpdateSyntheticsNetworkTest")
	if err != nil {
		return localVarReturnValue, nil, datadog.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
