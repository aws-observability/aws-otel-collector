...
// ProcessTimeseriesQuery A query for host-level process metrics such as CPU and memory usage.
type ProcessTimeseriesQuery struct {
...
// NewProcessTimeseriesQuery instantiates a new ProcessTimeseriesQuery object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewProcessTimeseriesQuery(dataSource ProcessDataSource, metric string, name string) *ProcessTimeseriesQuery {
	this := ProcessTimeseriesQuery{}
...
// NewProcessTimeseriesQueryWithDefaults instantiates a new ProcessTimeseriesQuery object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewProcessTimeseriesQueryWithDefaults() *ProcessTimeseriesQuery {
	this := ProcessTimeseriesQuery{}
...
func (o *ProcessTimeseriesQuery) GetCrossOrgUuids() []string {
...
func (o *ProcessTimeseriesQuery) GetCrossOrgUuidsOk() (*[]string, bool) {
	if o == nil || o.CrossOrgUuids == nil {
		return nil, false
	}
...
func (o *ProcessTimeseriesQuery) HasCrossOrgUuids() bool {
...
func (o *ProcessTimeseriesQuery) SetCrossOrgUuids(v []string) {
	o.CrossOrgUuids = v
}

// GetDataSource returns the DataSource field value.
func (o *ProcessTimeseriesQuery) GetDataSource() ProcessDataSource {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ProcessTimeseriesQuery) GetDataSourceOk() (*ProcessDataSource, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProcessTimeseriesQuery) SetDataSource(v ProcessDataSource) {
	o.DataSource = v
}

// GetIsNormalizedCpu returns the IsNormalizedCpu field value if set, zero value otherwise.
func (o *ProcessTimeseriesQuery) GetIsNormalizedCpu() bool {
...
// and a boolean to check if the value has been set.
func (o *ProcessTimeseriesQuery) GetIsNormalizedCpuOk() (*bool, bool) {
	if o == nil || o.IsNormalizedCpu == nil {
		return nil, false
	}
...
func (o *ProcessTimeseriesQuery) HasIsNormalizedCpu() bool {
...
func (o *ProcessTimeseriesQuery) SetIsNormalizedCpu(v bool) {
	o.IsNormalizedCpu = &v
}

// GetLimit returns the Limit field value if set, zero value otherwise.
func (o *ProcessTimeseriesQuery) GetLimit() int64 {
...
// and a boolean to check if the value has been set.
func (o *ProcessTimeseriesQuery) GetLimitOk() (*int64, bool) {
	if o == nil || o.Limit == nil {
		return nil, false
	}
	return o.Limit, true
...
func (o *ProcessTimeseriesQuery) HasLimit() bool {
	return o != nil && o.Limit != nil
}

// SetLimit gets a reference to the given int64 and assigns it to the Limit field.
func (o *ProcessTimeseriesQuery) SetLimit(v int64) {
	o.Limit = &v
}

// GetMetric returns the Metric field value.
func (o *ProcessTimeseriesQuery) GetMetric() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProcessTimeseriesQuery) GetMetricOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProcessTimeseriesQuery) SetMetric(v string) {
	o.Metric = v
}

// GetName returns the Name field value.
func (o *ProcessTimeseriesQuery) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProcessTimeseriesQuery) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *ProcessTimeseriesQuery) SetName(v string) {
	o.Name = v
}

// GetSort returns the Sort field value if set, zero value otherwise.
func (o *ProcessTimeseriesQuery) GetSort() QuerySortOrder {
	if o == nil || o.Sort == nil {
...
// and a boolean to check if the value has been set.
func (o *ProcessTimeseriesQuery) GetSortOk() (*QuerySortOrder, bool) {
	if o == nil || o.Sort == nil {
		return nil, false
	}
	return o.Sort, true
...
// and a boolean to check if the value has been set.
func (o *ProcessTimeseriesQuery) GetTagFiltersOk() (*[]string, bool) {
	if o == nil || o.TagFilters == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *ProcessTimeseriesQuery) GetTextFilterOk() (*string, bool) {
	if o == nil || o.TextFilter == nil {
		return nil, false
	}
...
func (o *ProcessTimeseriesQuery) HasTextFilter() bool {
	return o != nil && o.TextFilter != nil
}

// SetTextFilter gets a reference to the given string and assigns it to the TextFilter field.
func (o *ProcessTimeseriesQuery) SetTextFilter(v string) {
	o.TextFilter = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o ProcessTimeseriesQuery) MarshalJSON() ([]byte, error) {
...
func (o *ProcessTimeseriesQuery) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		CrossOrgUuids   []string           `json:"cross_org_uuids,omitempty"`
		DataSource      *ProcessDataSource `json:"data_source"`
		IsNormalizedCpu *bool              `json:"is_normalized_cpu,omitempty"`
