...
func NewConfiguration() *Configuration {
	cfg := &Configuration{
		...
		unstableOperations: map[string]bool{
			...
			"v2.AddCaseInsights":                                      false,
			"v2.AggregateCases":                                       false,
			"v2.BulkUpdateCases":                                      false,
			"v2.CountCases":                                           false,
			"v2.CreateCaseAutomationRule":                             false,
			"v2.CreateCaseJiraIssue":                                  false,
			"v2.CreateCaseLink":                                       false,
			"v2.CreateCaseNotebook":                                   false,
			"v2.CreateCaseServiceNowTicket":                           false,
			"v2.CreateCaseView":                                       false,
			"v2.CreateMaintenanceWindow":                              false,
			"v2.DeleteCaseAutomationRule":                             false,
			"v2.DeleteCaseLink":                                       false,
			"v2.DeleteCaseView":                                       false,
			"v2.DeleteMaintenanceWindow":                              false,
			"v2.DisableCaseAutomationRule":                            false,
			"v2.EnableCaseAutomationRule":                             false,
			"v2.FavoriteCaseProject":                                  false,
			"v2.GetCaseAutomationRule":                                false,
			"v2.GetCaseView":                                          false,
			"v2.LinkIncident":                                         false,
			"v2.LinkJiraIssueToCase":                                  false,
			"v2.ListCaseAutomationRules":                              false,
			"v2.ListCaseLinks":                                        false,
			"v2.ListCaseTimeline":                                     false,
			"v2.ListCaseViews":                                        false,
			"v2.ListCaseWatchers":                                     false,
			"v2.ListMaintenanceWindows":                               false,
			"v2.ListUserCaseProjectFavorites":                         false,
			"v2.MoveCaseToProject":                                    false,
			"v2.RemoveCaseInsights":                                   false,
			"v2.UnfavoriteCaseProject":                                false,
			"v2.UnlinkJiraIssue":                                      false,
			"v2.UnwatchCase":                                          false,
			"v2.UpdateCaseAutomationRule":                             false,
			"v2.UpdateCaseComment":                                    false,
			"v2.UpdateCaseDueDate":                                    false,
			"v2.UpdateCaseResolvedReason":                             false,
			"v2.UpdateCaseView":                                       false,
			"v2.UpdateMaintenanceWindow":                              false,
			"v2.WatchCase":                                            false,
			"v2.UpdateCaseType":                                       false,
			"v2.UpdateCustomAttributeConfig":                          false,
