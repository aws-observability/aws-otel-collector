...
var allowedSyntheticsMobileStepParamsElementContextTypeEnumValues = []SyntheticsMobileStepParamsElementContextType{
	SYNTHETICSMOBILESTEPPARAMSELEMENTCONTEXTTYPE_NATIVE,
	SYNTHETICSMOBILESTEPPARAMSELEMENTCONTEXTTYPE_WEB,
}
...
func (v *SyntheticsMobileStepParamsElementContextType) GetAllowedValues() []SyntheticsMobileStepParamsElementContextType {
	return allowedSyntheticsMobileStepParamsElementContextTypeEnumValues
}
...
func (v *SyntheticsMobileStepParamsElementContextType) UnmarshalJSON(src []byte) error {
	...
	*v = SyntheticsMobileStepParamsElementContextType(value)
	return nil
}

// NewSyntheticsMobileStepParamsElementContextTypeFromValue returns a pointer to a valid SyntheticsMobileStepParamsElementContextType
...
func NewSyntheticsMobileStepParamsElementContextTypeFromValue(v string) (*SyntheticsMobileStepParamsElementContextType, error) {
	ev := SyntheticsMobileStepParamsElementContextType(v)
	if ev.IsValid() {
		return &ev, nil
	}
	return nil, fmt.Errorf("invalid value '%v' for SyntheticsMobileStepParamsElementContextType: valid values are %v", v, allowedSyntheticsMobileStepParamsElementContextTypeEnumValues)
}

// IsValid return true if the value is valid for the enum, false otherwise.
func (v SyntheticsMobileStepParamsElementContextType) IsValid() bool {
	for _, existing := range allowedSyntheticsMobileStepParamsElementContextTypeEnumValues {
		if existing == v {
			return true
		}
	}
