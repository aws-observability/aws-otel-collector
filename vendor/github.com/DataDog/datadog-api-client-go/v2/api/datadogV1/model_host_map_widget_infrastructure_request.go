...
// HostMapWidgetInfrastructureRequest Infrastructure-backed request for the host map widget. Supports entity-based
// visualization with metric query enrichments, tag-based filtering, flexible grouping,
// and hierarchical views.
type HostMapWidgetInfrastructureRequest struct {
	// Infrastructure-backed host map child request (leaf node, no further nesting supported).
	Child *HostMapWidgetInfrastructureRequestLeaf `json:"child,omitempty"`
...
// NewHostMapWidgetInfrastructureRequest instantiates a new HostMapWidgetInfrastructureRequest object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewHostMapWidgetInfrastructureRequest(enrichments []HostMapWidgetScalarRequest, nodeType HostMapWidgetNodeType, requestType HostMapWidgetInfrastructureRequestRequestType) *HostMapWidgetInfrastructureRequest {
	this := HostMapWidgetInfrastructureRequest{}
...
// NewHostMapWidgetInfrastructureRequestWithDefaults instantiates a new HostMapWidgetInfrastructureRequest object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewHostMapWidgetInfrastructureRequestWithDefaults() *HostMapWidgetInfrastructureRequest {
	this := HostMapWidgetInfrastructureRequest{}
	return &this
}

// GetChild returns the Child field value if set, zero value otherwise.
func (o *HostMapWidgetInfrastructureRequest) GetChild() HostMapWidgetInfrastructureRequestLeaf {
	if o == nil || o.Child == nil {
		var ret HostMapWidgetInfrastructureRequestLeaf
		return ret
	}
	return *o.Child
}
...
func (o *HostMapWidgetInfrastructureRequest) GetChildOk() (*HostMapWidgetInfrastructureRequestLeaf, bool) {
	if o == nil || o.Child == nil {
		return nil, false
	}
	return o.Child, true
...
func (o *HostMapWidgetInfrastructureRequest) HasChild() bool {
	return o != nil && o.Child != nil
}

// SetChild gets a reference to the given HostMapWidgetInfrastructureRequestLeaf and assigns it to the Child field.
func (o *HostMapWidgetInfrastructureRequest) SetChild(v HostMapWidgetInfrastructureRequestLeaf) {
	o.Child = &v
}

// GetConditionalFormats returns the ConditionalFormats field value if set, zero value otherwise.
func (o *HostMapWidgetInfrastructureRequest) GetConditionalFormats() []WidgetConditionalFormat {
...
// and a boolean to check if the value has been set.
func (o *HostMapWidgetInfrastructureRequest) GetConditionalFormatsOk() (*[]WidgetConditionalFormat, bool) {
	if o == nil || o.ConditionalFormats == nil {
		return nil, false
	}
...
func (o *HostMapWidgetInfrastructureRequest) HasConditionalFormats() bool {
...
func (o *HostMapWidgetInfrastructureRequest) SetConditionalFormats(v []WidgetConditionalFormat) {
	o.ConditionalFormats = v
}

// GetEnrichments returns the Enrichments field value.
func (o *HostMapWidgetInfrastructureRequest) GetEnrichments() []HostMapWidgetScalarRequest {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *HostMapWidgetInfrastructureRequest) GetEnrichmentsOk() (*[]HostMapWidgetScalarRequest, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *HostMapWidgetInfrastructureRequest) SetEnrichments(v []HostMapWidgetScalarRequest) {
	o.Enrichments = v
}

// GetFilter returns the Filter field value if set, zero value otherwise.
func (o *HostMapWidgetInfrastructureRequest) GetFilter() string {
...
// and a boolean to check if the value has been set.
func (o *HostMapWidgetInfrastructureRequest) GetFilterOk() (*string, bool) {
	if o == nil || o.Filter == nil {
		return nil, false
	}
...
func (o *HostMapWidgetInfrastructureRequest) HasFilter() bool {
	return o != nil && o.Filter != nil
}

// SetFilter gets a reference to the given string and assigns it to the Filter field.
func (o *HostMapWidgetInfrastructureRequest) SetFilter(v string) {
	o.Filter = &v
}

// GetGroupBy returns the GroupBy field value if set, zero value otherwise.
func (o *HostMapWidgetInfrastructureRequest) GetGroupBy() []HostMapWidgetGroupBy {
...
// and a boolean to check if the value has been set.
func (o *HostMapWidgetInfrastructureRequest) GetGroupByOk() (*[]HostMapWidgetGroupBy, bool) {
	if o == nil || o.GroupBy == nil {
		return nil, false
	}
...
func (o *HostMapWidgetInfrastructureRequest) HasGroupBy() bool {
	return o != nil && o.GroupBy != nil
}

// SetGroupBy gets a reference to the given []HostMapWidgetGroupBy and assigns it to the GroupBy field.
func (o *HostMapWidgetInfrastructureRequest) SetGroupBy(v []HostMapWidgetGroupBy) {
	o.GroupBy = v
}

// GetNoGroupHosts returns the NoGroupHosts field value if set, zero value otherwise.
func (o *HostMapWidgetInfrastructureRequest) GetNoGroupHosts() bool {
...
// and a boolean to check if the value has been set.
func (o *HostMapWidgetInfrastructureRequest) GetNoGroupHostsOk() (*bool, bool) {
	if o == nil || o.NoGroupHosts == nil {
		return nil, false
	}
...
func (o *HostMapWidgetInfrastructureRequest) HasNoGroupHosts() bool {
...
func (o *HostMapWidgetInfrastructureRequest) SetNoGroupHosts(v bool) {
	o.NoGroupHosts = &v
}

// GetNoMetricHosts returns the NoMetricHosts field value if set, zero value otherwise.
func (o *HostMapWidgetInfrastructureRequest) GetNoMetricHosts() bool {
...
// and a boolean to check if the value has been set.
func (o *HostMapWidgetInfrastructureRequest) GetNoMetricHostsOk() (*bool, bool) {
	if o == nil || o.NoMetricHosts == nil {
		return nil, false
	}
...
func (o *HostMapWidgetInfrastructureRequest) HasNoMetricHosts() bool {
...
func (o *HostMapWidgetInfrastructureRequest) SetNoMetricHosts(v bool) {
	o.NoMetricHosts = &v
}

// GetNodeType returns the NodeType field value.
func (o *HostMapWidgetInfrastructureRequest) GetNodeType() HostMapWidgetNodeType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *HostMapWidgetInfrastructureRequest) GetNodeTypeOk() (*HostMapWidgetNodeType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *HostMapWidgetInfrastructureRequest) SetNodeType(v HostMapWidgetNodeType) {
	o.NodeType = v
}

// GetRequestType returns the RequestType field value.
func (o *HostMapWidgetInfrastructureRequest) GetRequestType() HostMapWidgetInfrastructureRequestRequestType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *HostMapWidgetInfrastructureRequest) GetRequestTypeOk() (*HostMapWidgetInfrastructureRequestRequestType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *HostMapWidgetInfrastructureRequest) SetRequestType(v HostMapWidgetInfrastructureRequestRequestType) {
	o.RequestType = v
}

// GetStyle returns the Style field value if set, zero value otherwise.
func (o *HostMapWidgetInfrastructureRequest) GetStyle() HostMapWidgetInfrastructureStyle {
...
// and a boolean to check if the value has been set.
func (o *HostMapWidgetInfrastructureRequest) GetStyleOk() (*HostMapWidgetInfrastructureStyle, bool) {
	if o == nil || o.Style == nil {
		return nil, false
	}
	return o.Style, true
...
func (o *HostMapWidgetInfrastructureRequest) HasStyle() bool {
...
func (o *HostMapWidgetInfrastructureRequest) SetStyle(v HostMapWidgetInfrastructureStyle) {
	o.Style = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o HostMapWidgetInfrastructureRequest) MarshalJSON() ([]byte, error) {
...
func (o *HostMapWidgetInfrastructureRequest) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Child              *HostMapWidgetInfrastructureRequestLeaf        `json:"child,omitempty"`
		ConditionalFormats []WidgetConditionalFormat                      `json:"conditional_formats,omitempty"`
		Enrichments        *[]HostMapWidgetScalarRequest                  `json:"enrichments"`
	...
	if err = datadog.UnmarshalUseNumber(bytes, &additionalProperties); err == nil {
		datadog.DeleteKeys(additionalProperties, &[]string{"child", "conditional_formats", "enrichments", "filter", "group_by", "no_group_hosts", "no_metric_hosts", "node_type", "request_type", "style"})
	} else {
		return err
	}
