...
// MonitorFormulaAndFunctionAggregateFilterQuery - Filter query for aggregate filtered queries. Can be an events query or a reference table query.
type MonitorFormulaAndFunctionAggregateFilterQuery struct {
...
// MonitorFormulaAndFunctionEventQueryDefinitionAsMonitorFormulaAndFunctionAggregateFilterQuery is a convenience function that returns MonitorFormulaAndFunctionEventQueryDefinition wrapped in MonitorFormulaAndFunctionAggregateFilterQuery.
func MonitorFormulaAndFunctionEventQueryDefinitionAsMonitorFormulaAndFunctionAggregateFilterQuery(v *MonitorFormulaAndFunctionEventQueryDefinition) MonitorFormulaAndFunctionAggregateFilterQuery {
	return MonitorFormulaAndFunctionAggregateFilterQuery{MonitorFormulaAndFunctionEventQueryDefinition: v}
}

// MonitorFormulaAndFunctionReferenceTableQueryDefinitionAsMonitorFormulaAndFunctionAggregateFilterQuery is a convenience function that returns MonitorFormulaAndFunctionReferenceTableQueryDefinition wrapped in MonitorFormulaAndFunctionAggregateFilterQuery.
func MonitorFormulaAndFunctionReferenceTableQueryDefinitionAsMonitorFormulaAndFunctionAggregateFilterQuery(v *MonitorFormulaAndFunctionReferenceTableQueryDefinition) MonitorFormulaAndFunctionAggregateFilterQuery {
	return MonitorFormulaAndFunctionAggregateFilterQuery{MonitorFormulaAndFunctionReferenceTableQueryDefinition: v}
}

// UnmarshalJSON turns data into one of the pointers in the struct.
func (obj *MonitorFormulaAndFunctionAggregateFilterQuery) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
...
func (obj MonitorFormulaAndFunctionAggregateFilterQuery) MarshalJSON() ([]byte, error) {
...
func (obj *MonitorFormulaAndFunctionAggregateFilterQuery) GetActualInstance() interface{} {
	if obj.MonitorFormulaAndFunctionEventQueryDefinition != nil {
